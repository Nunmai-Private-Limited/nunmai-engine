...
COMPONENT_PREFIXES = {
    ...
    "cli": ("nunmai_cli", "cli"),
    "cron": ("cron",),
    "gui": ("nunmai_cli.web_server", "nunmai_cli.pty_bridge", "tui_gateway", "uvicorn"),
}
...
def _read_logging_config():
    ...
    try:
        ...
        # nunmai_cli.main's early parse (one config.yaml parse per process);
        # fall back to a direct parse for bare nunmai_logging consumers.
        try:
