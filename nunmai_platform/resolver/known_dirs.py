...
Every table in Nunmai lives here. A directory literal outside this module fails the ratchet in
...
def nunmai_vendored_dirs() -> tuple[str, ...]:
    return ("~/.nunmai/bin",) if _POSIX else ("%USERPROFILE%/.nunmai/bin",)
