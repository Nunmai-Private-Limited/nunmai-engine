...
from nunmai_platform.resolver.app import AppDef, AppResolver
from nunmai_platform.resolver.availability import Availability, availability
from nunmai_platform.resolver.base import Effort
from nunmai_platform.resolver.core import CheckState
...
def liveness_for(server_name: str) -> Liveness:
    ...
    try:
        from nunmai_cli.agent_plugins import liveness_for as registered_liveness
    except ImportError:
        return Liveness("static")
