...
_skills_dir = _path_resolver("SKILLS_DIR", "NUNMAI_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"NUNMAI_HOME": _nunmai_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'NUNMAI_INDEX_TTL': ('tools.skills_hub_search', 'NUNMAI_INDEX_TTL'),
    'NUNMAI_INDEX_URL': ('tools.skills_hub_search', 'NUNMAI_INDEX_URL'),
    'NunmaiIndexSource': ('tools.skills_hub_official', 'NunmaiIndexSource'),
