...
def iter_sync_files(container_base: str = "/root/.nunmai") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.nunmai to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``NUNMAI_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, nunmai_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.nunmai/`` directory as a tar archive,
    ...
    def _sync_back_transaction(self, nunmai_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .nunmai/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.nunmai/skills/a.md`` →
        ``~/.nunmai/skills/a.md``, a new remote file at
        ``/root/.nunmai/skills/b.md`` maps to ``~/.nunmai/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
