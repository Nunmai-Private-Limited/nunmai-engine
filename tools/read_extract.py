...
def _anydoc_missing_error(path: str) -> str:
    ...
    return (
        ...
        "firecrawl-anydoc` in Nunmai's environment, or convert the file "
...
def _hosted_ocr_config() -> tuple:
    ...
    (anydoc defaults api_url to https://api.firecrawl.dev). The Nunmai
...
def hosted_ocr_available() -> bool:
    ...
    (not the Nunmai gateway — Parse proxy live-probed broken 2026-08-28 —
