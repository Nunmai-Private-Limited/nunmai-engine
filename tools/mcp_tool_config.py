...
def _node_fallback(command: str) -> str:
    ...
    nunmai_home = os.path.expanduser(os.getenv("NUNMAI_HOME", os.path.join(home, ".nunmai")))
    ...
    candidates = (os.path.join(nunmai_home, "node", "bin", command), os.path.join(home, ".local", "bin", command),
