...
the get_anchored_view / get_messages_around primitives in nunmai_state.
...
from nunmai_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with NUNMAI_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past Nunmai sessions (FTS5 over the local session DB), or read/"
