...
from nunmai_state_common import _BOUNDARY_END_REASONS
from nunmai_time import safe_strftime

# Hidden from browsing/searching — integrations (NUNMAI_SESSION_SOURCE=tool), delegate
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past conversations: search or read old Nunmai sessions (FTS5), or "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Nunmai profile's database "
