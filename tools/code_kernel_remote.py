...
Closes the gap tracked in nunmai-engine#96873: local execute_code holds a
...
def _spawn_remote_kernel(env, env_type: str, owner: str, task_env_id: str,
    ...
    try:
        ...
        _ship_file_to_remote(env, f"{kernel_dir}/nunmai_tools.py", tools_src)

        env_prefix = (
            f"NUNMAI_KERNEL_DIR={q_dir} "
            f"NUNMAI_RPC_DIR={shlex.quote(kernel_dir + '/rpc')} "
