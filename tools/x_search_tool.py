...
Registers when either xAI credential path is available (``XAI_API_KEY`` or ``nunmai auth add
...
from tools.xai_http import DEFAULT_XAI_BASE_URL, nunmai_xai_user_agent, resolve_xai_http_credentials
