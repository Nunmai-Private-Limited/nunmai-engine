...
worktree per child under ``<repo>/.worktrees/subagent-<id>``, branch ``nunmai-subagent/<id>``;
...
from nunmai_cli._subprocess_compat import harden_git_argv, noninteractive_git_env
...
def create_subagent_worktree(parent_cwd: Optional[str], subagent_id: Optional[str] = None) -> Optional[Dict[str, str]]:
    ...
    branch = f"nunmai-subagent/{wt_name}"
