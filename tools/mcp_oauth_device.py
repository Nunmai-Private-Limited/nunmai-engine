...
started by `nunmai mcp login/reauth`, never a background reconnect.
"""
...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import NunmaiMCPOAuthProvider, get_manager
    ...
    provider = NunmaiMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
