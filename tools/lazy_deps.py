...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # on mere presence, so `nunmai update` re-asserts this pin everywhere hub exists. MUST stay
    ...
    # feature active from mere package presence, the `nunmai update` lazy-refresh pass re-asserts THIS pin
