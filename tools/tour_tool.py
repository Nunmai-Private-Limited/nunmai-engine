#!/usr/bin/env python3
"""Run a guided tour (highlight + narrate UI elements) in the Nunmai desktop GUI.
...
- ``surface="app"`` — the Nunmai desktop app's own DOM (tours of Nunmai itself).
...
def tour_tool(
    ...
    if callback is None:
        return tool_error("tour is only available in the Nunmai desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (Nunmai itself) "
