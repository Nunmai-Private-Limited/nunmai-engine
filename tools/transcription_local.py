...
def _transcribe_local_command(
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="nunmai-local-stt-") as output_dir:
            ...
            # Scrub Nunmai secrets from the child env (same policy as _run_command_stt).
            # Scrub Nunmai secrets from the child env (sibling path to #56332 / _run_command_stt — this
            ...
            _run_quiet(shlex.split(command), timeout=300, env=nunmai_subprocess_env(inherit_credentials=False))
