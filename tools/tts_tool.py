...
def _default_output_dir() -> str:
    ...
    NUNMAI_HOME and later scope requests to a different profile via
    ``nunmai_constants.set_nunmai_home_override()`` — a frozen module constant keeps writing synthesized
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'nunmai_xai_user_agent': ('tools.xai_http', 'nunmai_xai_user_agent'),
