"""Managed ("Nunmai Subscription") image generation: one picker row, one model catalog.
...
* ``portal`` — Nunmai Portal chat-completions image models (``plugins/image_gen/openrouter``'s
