...
def _memo(_bt, resolved_attr: str, cache_attr: str, compute: Callable[[], object]):
    ...
    Under a routed profile (NUNMAI_HOME override, multiplexed gateway) the slot is NOT consulted: every
    ...
    try:
        ...
        if isinstance(browser_cfg, dict) and "cloud_provider" in browser_cfg:
            ...
            if provider_key == "nous":
                # Managed "Nunmai Subscription" is serviced by the Browser Use provider.
