...
`hey_nunmai.onnx` / `hey_nunmai.tflite` — the on-device "Hey Nunmai" hotword
...
- **Label:** the model registers as `hey_nunmai` (matches the filename).
