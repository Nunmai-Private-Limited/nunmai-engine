    ...
    *,
    ...
    if action not in _CONNECTOR_ACTIONS:
        return tool_error(
            ...
            "Disconnecting an account is done by the user in the Nunmai Portal "
    ...
    try:
        ...
        return tool_error(
            ...
            "If this persists, the user can manage connections in the Nunmai Portal."
        )
...
MANAGE_CONNECTIONS_SCHEMA = {
    ...
    "description": (
        ...
        "the Nunmai Portal (their org's Connectors page) or the desktop app."
    ),
    "parameters": {
        "type": "object",
        "properties": {
