...
# containing `cat ~/.nunmai/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `nunmai-engine-dev` skill contains a security postmortem mentioning `cat ~/.nunmai/.env`, which tripped
