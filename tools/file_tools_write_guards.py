...
def _get_nunmai_config_resolved() -> str | None:
    ...
    return _cached_lookup("_nunmai_config_resolved", "_nunmai_config_resolved_loaded", _config_path_resolved,
                          lambda: str(Path(_expand_tilde("~/.nunmai/config.yaml")).resolve()))


def _get_real_nunmai_home() -> str | None:
    """Return the realpath of the authoritative Nunmai home (cached)."""
    return _cached_lookup("_real_nunmai_home_cached", "_real_nunmai_home_loaded", _nunmai_home_real,
                          lambda: os.path.realpath(_expand_tilde("~/.nunmai")))
