...
MISSING_SENTINEL = "__nunmai_missing__"

_READ_SENTINEL_PREFIX = "__NUNMAI_RF_"
_WRITE_SENTINEL_PREFIX = "__NUNMAI_WF_"
...
class ShellFileOperations(LintMixin, SearchMixin, FileOperations):
    ...
    def _escape_native_tool_arg(self, arg: str) -> str:
        ...
        understand the MSYS ``/c/...`` form and Nunmai disables MSYS argument
    ...
    def _native_read_enabled(self) -> bool:
        ...
        file_operations holds Git-Bash-style paths there). ``NUNMAI_NATIVE_FILE_READ=0``
        turns the fast path off."""
        flag = os.environ.get("NUNMAI_NATIVE_FILE_READ", "1").strip().lower()
