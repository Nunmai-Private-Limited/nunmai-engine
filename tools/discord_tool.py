...
Only included in the nunmai-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Nunmai-Agent (https://github.com/NousResearch/hermes-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_nunmai_home() / "cache" / "discord_capabilities.json"
