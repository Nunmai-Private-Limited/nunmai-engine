...
One Nunmai process may serve many profiles (multiplex gateway, Desktop/dashboard ``serve``), and
...
exits 0, because most patterns have legitimate sites (a standalone ``nunmai -p x`` process where
