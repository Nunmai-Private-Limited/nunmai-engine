#!/usr/bin/env python3
"""Build the Nunmai Model Catalog — a centralized JSON manifest of curated models.
...
Nunmai CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Nunmai release.
...
# Ensure NUNMAI_HOME is set for imports that touch it at module level.
os.environ.setdefault("NUNMAI_HOME", os.path.join(os.path.expanduser("~"), ".nunmai"))

from nunmai_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nunmai-engine repo",
            "docs": "https://nunmai.in/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Nunmai '
