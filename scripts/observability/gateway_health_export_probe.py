...
def main() -> None:
    ...
    nunmai_home = Path(tempfile.mkdtemp(prefix="nunmai-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "nunmai-gateway-smoke",
    ...
    print(json.dumps({"nunmai_home": str(nunmai_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
