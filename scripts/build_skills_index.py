#!/usr/bin/env python3
"""Build the Nunmai Skills Index — a centralized JSON catalog of all skills.
...
`nunmai skills search/install` can use it without hitting the GitHub API.
...
# Ensure NUNMAI_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Nunmai Skills Index...", flush=True)
