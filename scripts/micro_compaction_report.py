#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Nunmai logs.
...
With no LOGFILE, reads ``$NUNMAI_HOME/logs/agent.log`` (default ~/.nunmai).
...
def default_log() -> Path:
    home = os.environ.get("NUNMAI_HOME") or str(Path.home() / ".nunmai")
