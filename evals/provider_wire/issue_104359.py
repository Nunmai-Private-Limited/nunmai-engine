...
home = tempfile.mkdtemp(prefix="nunmai-104359-")
os.environ.clear()
os.environ.update(
    HOME=home,
...
Path(os.environ["NUNMAI_HOME"], "config.yaml").write_text(yaml.safe_dump(config), encoding="utf-8")
...
db = SessionDB(Path(os.environ["NUNMAI_HOME"]) / "state.db")
