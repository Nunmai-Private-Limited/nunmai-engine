...
def step(mode):
    from nunmai_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from nunmai_cli.main import _run_logged_subprocess
