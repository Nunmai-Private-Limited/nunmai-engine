...
The run gets a throwaway NUNMAI_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE NUNMAI_HOME is redirected to the
