...
Scratch HOME, NUNMAI_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && NUNMAI_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `nunmai`; PATH contains a different inert `nunmai` that exits 2
