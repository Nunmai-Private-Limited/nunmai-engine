...
benchmarked ten harnesses on hostile-file handling — and whose Nunmai column
...
Every task runs the full Nunmai agent (file + terminal + search toolsets)
...
Rules of engagement (from nunmaibench discipline):
