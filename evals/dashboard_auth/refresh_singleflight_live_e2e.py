...
os.environ["NUNMAI_HOME"] = tempfile.mkdtemp(prefix="nunmai-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("nunmai", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from nunmai_cli import web_server  # noqa: E402
from nunmai_cli.dashboard_auth import register_provider  # noqa: E402
from nunmai_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.nunmai_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "nunmai_session_at=expired-at; nunmai_session_rt=cookie-stale; nunmai_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
