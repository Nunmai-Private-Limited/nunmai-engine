...
os.environ['NUNMAI_NIX_BUILD'] = '1'
sys.path.insert(0, str(root))
commands = importlib.import_module("nunmai_cli.cli_commands_mixin")
GoalManager = importlib.import_module("nunmai_cli.goals").GoalManager
