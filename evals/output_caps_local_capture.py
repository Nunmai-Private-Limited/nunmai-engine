...
Run from a checkout with NUNMAI_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["NUNMAI_MAX_TOKENS"] = "13"
...
from nunmai_cli.moa_config import _normalize_preset
