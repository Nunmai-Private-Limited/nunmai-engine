...
from nunmai_cli import cli_commands_mixin, goals
...
server._nunmai_home = Path(home.name)
...
with patch('nunmai_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
