"""Live A/B of the Nunmai hourly-expiry stampede, no real network.
...
os.environ["NUNMAI_HOME"] = tempfile.mkdtemp(prefix="hh-")
os.environ["NUNMAI_STREAM_RETRIES"] = "0"
...
import nunmai_cli.nous_auth_keepalive as ka
