...
os.environ.setdefault("NUNMAI_HOME", os.path.expanduser("~/.nunmai"))  # LIVE: real auxiliary judge calls (cents)
from nunmai_cli import goals
goal = ("Simplify the nunmai-engine codebase by >=30% LOC with zero behavior change, decomposing every god file, "
