...
os.environ["NUNMAI_HOME"] = str(root / ".nunmai")
from nunmai_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".nunmai" / "profiles" / name
    ...
    d = root / ".nunmai/logs/update_receipts"
    ...
    home = root / ".nunmai/profiles/beta"
