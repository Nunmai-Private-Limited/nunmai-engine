...
sandbox = tempfile.TemporaryDirectory(prefix="nunmai-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    NUNMAI_HOME=sandbox.name + "/nunmai",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    NUNMAI_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Nunmai home is written.
