...
def auth_kind(provider: Optional[str]) -> str:
    ...
    try:
        from nunmai_cli.provider_catalog import provider_catalog_by_slug
...
def build_error_surface_from_result(result: Any, provider: str = "", model: str = "") -> Optional[dict]:
    ...
    try:
        ...
        # provider stack; nunmai_state owns the pattern list.
        ...
        # The Nunmai free tier refused or could not serve the turn (``agent/turn_recovery.py``
