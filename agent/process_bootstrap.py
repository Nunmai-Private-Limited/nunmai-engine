...
from nunmai_bootstrap import _happy_eyeballs_create_connection
...
NUNMAI_TRANSPORT_OWNER_EXT = "nunmai_transport_owner"
...
def _shared_transport_cls():
    ...
    class _SharedTransportImpl(httpx.BaseTransport):
        ...
        def handle_request(self, request: Any) -> Any:
            ...
            request.extensions[NUNMAI_TRANSPORT_OWNER_EXT] = id(self)
