...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Nunmai-Session-Id header), and an
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # that are canonicalized only after Nunmai sends the request. Honor its
...
def create_openai_client(agent, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
    ...
    # Delegate all rate-limit / 5xx retry to nunmai's outer conversation loop,
    ...
    # All primary construction and recovery paths must identify Nunmai to the
...
def sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    #
    # We do NOT drop the call: nunmai' own dispatch loop intentionally keeps an
...
def _iter_httpx_pool_objects(http_client: Any):
    ...
    Nunmai' keepalive client (#10324 / ``_build_keepalive_http_client``) and
