"""Render Nunmai' prior transcript as a one-shot seed for a FRESH codex app-server thread.
...
_HEADER = ("Prior conversation from this Nunmai session (the thread you are continuing was started fresh; "
