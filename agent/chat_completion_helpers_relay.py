...
as the provider stream ends — concurrently with Nunmai' consumer thread, which may not have
...
class RelayChatAccumulator:
    ...
    def observe(self, chunk: Any) -> None:
        ...
        choice = choices[0] if choices else None  # Nunmai never requests n>1
    ...
    def finalize(self) -> dict[str, Any]:
        ...
        # "stop" also covers Nunmai Portal ``lastOne`` usage frames, which carry no finish_reason.
