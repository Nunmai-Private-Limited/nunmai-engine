...
A host that runs a blocking command on a worker thread (Nunmai Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("nunmai_interrupt_scope", default=None)
