...
def _convert_assistant_message(m: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # See nunmai-engine#13848. Accept empty string "" — _copy_reasoning_content_for_api() injects "" as a
...
def _manage_thinking_signatures(result: List[Dict[str, Any]], base_url: str | None, model: str | None) -> None:
    ...
    Kimi replays as-is; DeepSeek needs unsigned blocks round-tripped but rejects signed ones. Nunmai
