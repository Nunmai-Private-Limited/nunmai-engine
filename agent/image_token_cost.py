...
The learned value is kept per ``model@host`` in ``~/.nunmai/cache/image_token_costs.json`` so a new
...
_image_cost_var: ContextVar[Optional[int]] = ContextVar("nunmai_image_token_cost", default=None)
