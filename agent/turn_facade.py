...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from nunmai_cli.observability.relay_shared_metrics import finish_task_run, start_task_run
        ...
        try:
            ...
            if getattr(relay_turn, "relay_enabled", True):
                ...
                task_started = True
            # Ambient Nunmai Portal tagging: every LLM call in this turn (loop, compression,
            ...
            # A host that owns this thread (Nunmai Console) may cancel the turn cross-thread.
