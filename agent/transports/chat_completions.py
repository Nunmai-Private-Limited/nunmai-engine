...
providers (OpenRouter, Nunmai, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _reasoning_config_for_model(model: str, reasoning_config: dict | None) -> dict | None:
    ...
    Nunmai' internal effort set extends the wire vocabulary with ``ultra``
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Nunmai/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Nunmai'
    ...
    # is stricter (low/high). Clamp Nunmai' wider effort set to what each
...
def _raise_gemini_thinking_max_tokens(
    ...
    global Nunmai cap of 4096 is enough for visible text, but Ultra/high
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Nunmai-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all Nunmai-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Nunmai max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Nunmai, OpenRouter,
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the Nunmai
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        if message_tool_calls:
            ...
            for tc in message_tool_calls:
                ...
                # preserve an explicit blank name for Nunmai's recovery path.
        ...
        # Bedrock (e.g. Nunmai Portal) surface a Claude refusal this way — or via
