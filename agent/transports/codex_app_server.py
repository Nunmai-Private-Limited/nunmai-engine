...
projection into Nunmai' display, approval bridging, transcript projection into
...
"codex_app_server"`. Nunmai' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 Nunmai secret — gateway
        ...
        if spawn_env.get("NUNMAI_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "NUNMAI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("NUNMAI_HOME", os.path.expanduser("~/.nunmai")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "nunmai",
        client_title: str = "Nunmai Engine",
