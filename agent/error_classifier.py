...
# ``data:`` field before Nunmai receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Nunmai persists a content-less
...
# Request parameters that Nunmai sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # nunmai_cli.plugins.VALID_HOOKS for the callback contract). Callback
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Nunmai) run before
    ...
    if status_code == 404:
        # Nunmai API currently surfaces HA/NAS credit depletion as a paid model
