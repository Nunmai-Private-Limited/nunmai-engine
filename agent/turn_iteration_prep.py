...
def prepare_iteration(
    ...
    # Nunmai agent keys live ~1 h and a single turn can run for hours: adopt the keepalive's fresh
    ...
    try:
        ...
        logger.debug("Nunmai key pre-expiry adoption failed", exc_info=True)
    ...
    if repaired_seq > 0:
        ...
        # (nunmai-webui) would write the current turn to the FRONT of the context. Re-anchor as
