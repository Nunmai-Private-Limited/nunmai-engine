...
headers, and request quirks (MiniMax, Kimi/Moonshot, DeepSeek, OpenCode, Azure AI Foundry, Nunmai
...
def _is_deepseek_anthropic_endpoint(base_url: str | None) -> bool:
    ...
    keep-unsigned policy used for Kimi's ``/coding`` endpoint. See nunmai-engine#16748.
    """
...
def _is_nous_portal_endpoint(base_url: str | None) -> bool:
    """Nunmai Portal's Anthropic Messages route (Bearer JWT, verbatim catalog ids, native
...
def _requires_bearer_auth(base_url: str | None) -> bool:
    ...
    Foundry, Palantir Foundry's LLM proxy, CommandCode, Nunmai Portal. Palantir/CommandCode use
