...
def build_subscription_state(*, timeout: float = 15.0) -> SubscriptionState:
    ...
    ``NUNMAI_DEV_SUBSCRIPTION_FIXTURE`` short-circuits to a fixture so every state is testable offline."""
...
def dev_fixture_subscription_state() -> Optional[SubscriptionState]:
    """``NUNMAI_DEV_SUBSCRIPTION_FIXTURE`` (``free | mid | top | not-admin | downgrade | cancel | team |
