...
def build_billing_state(*, timeout: float = 15.0) -> BillingState:
    """Fetch + parse ``/api/billing/state``; fail-open. ``NUNMAI_DEV_BILLING_FIXTURE`` short-circuits to a fixture."""
...
def _dev_fixture_billing_state() -> Optional[BillingState]:
    """``NUNMAI_DEV_BILLING_FIXTURE`` -> :class:`BillingState` for offline UX; None when unset.
