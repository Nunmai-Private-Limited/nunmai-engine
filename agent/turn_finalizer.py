...
decomposition campaign (``~/.nunmai/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("NUNMAI_KANBAN_TASK")
        if _kanban_task:
    ...
    result = {
        ...
        # billing audits by callers like `nunmai -z --usage-file`.
        "service_tier": (
