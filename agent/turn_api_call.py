...
the attempt while another session's Nunmai Portal rate limit is active), ``perform_api_call``
...
def nous_rate_limit_guard(
    ...
    """Skip the call if another session recorded a Nunmai Portal rate limit: every attempt (incl.
    ...
    if agent.provider == "nous":
        ...
        try:
            from nunmai_cli.anon_auth import apply_model_switch
        ...
        try:
            ...
            if _nous_remaining is not None and _nous_remaining > 0:
                ...
                if _anonymous:
                    ...
                    _nous_msg = f"Your Nunmai account has hit its rate limit; it resets in {reset}."
