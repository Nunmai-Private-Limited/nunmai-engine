...
def codex_cloudflare_headers(access_token: str, *, base_url: str = CODEX_AUX_BASE_URL) -> Dict[str, str]:
    ...
    endpoint gets Nunmai' originator and version, custom endpoints keep the
    ...
    if is_official_codex_base_url(base_url):
        ...
        headers = {"User-Agent": f"NunmaiAgent/{__version__}", "originator": "nunmai-engine"}
    else:
        headers = {"User-Agent": "codex_cli_rs/0.0.0 (Nunmai Engine)", "originator": "codex_cli_rs"}
