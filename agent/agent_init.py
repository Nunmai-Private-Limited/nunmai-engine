...
def _finalize_routing(agent, api_mode, credential_pool):
    ...
    from nunmai_cli.runtime_provider_backends import _is_external_process_provider
        ...
        try:
            ...
            if not is_core_memory_provider(_mem_provider_name):
                ...
                if _mp is None:
                    ...
                    from nunmai_cli.memory_provider_migration import recover_at_startup
...
def _enforce_minimum_context(agent):
    ...
    if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH and not _allow_lmstudio_explicit_below_floor:
        ...
        raise ValueError(
            ...
            f"by Nunmai Engine.  {remedy}"
        )


def _warn_nonagentic_nunmai_model(agent):
    # Hermes 3/4 are chat models, not tool-call-tuned. cli.py show_banner() already
    ...
    with suppress(Exception):
        ...
        if _nunmai_warn:
            _user_msg = (
                "⚠ Hermes 3 & 4 models are NOT agentic — they "
