...
same way as the other conversation-affinity hints Nunmai already sends
...
def opencode_session_headers(
    ...
    try:
        ...
        key = _cache_scope_from_session_id(
            ...
            # each routed independently of the conversation it belonged to (#70820). Mirrors the Nunmai Portal
