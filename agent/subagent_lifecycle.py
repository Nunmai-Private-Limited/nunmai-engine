"""Public, plugin-safe lifecycle API for delegated Nunmai subagents.
...
_ACTIVE_PARENT_AGENT: contextvars.ContextVar[Any] = contextvars.ContextVar(
    "nunmai_subagent_lifecycle_parent", default=None
)
    ...
    def launch(self, request: SubagentLaunchRequest) -> SubagentHandle:
        ...
        if parent is None:
            raise SubagentLifecycleError(
                "No active Nunmai parent session is available."
            )
