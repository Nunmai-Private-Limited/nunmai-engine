...
const config: Config = {
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-nunmai-plugin',
  ...
  themeConfig: {
    image: 'img/nunmai-engine-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Nunmai-Private-Limited/nunmai-engine',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/Nunmai-Private-Limited/nunmai-engine/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://nunmai.in/' },
            { label: 'GitHub', href: 'https://github.com/Nunmai-Private-Limited/nunmai-engine' },
            { label: 'Nunmai Research', href: 'https://nunmai.in' },
          ],
        },
      ],
      copyright: `Built by <a href="https://nunmai.in">Nunmai Research</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
