...
:::tip
If you're paying Portal for an xAI model anyway, Live Search calls bill against the same xAI key configured for chat. See [Nunmai Portal](/integrations/nous-portal).
:::
