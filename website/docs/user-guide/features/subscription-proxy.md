...
chat completions — use your Nunmai-managed provider subscription as their
...
| Use case | "Use Nunmai as a chat backend" | "Use my Portal sub from another app" |
...
`nunmai_cli/proxy/adapters/<provider>.py` and registering it in
