...
description: "Browse and install reviewed, SHA-pinned Nunmai plugins from the curated catalog"
---
...
enabled/disabled state is preserved. `nunmai plugins list` shows catalog
...
updating Nunmai. Offline, the copy shipped with your checkout is used. Removals
...
- [Build a Nunmai Plugin](/developer-guide/plugins) — write your own
