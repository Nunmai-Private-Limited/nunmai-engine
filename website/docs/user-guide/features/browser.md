...
stays locked, Nunmai stops the launch and asks you to close the browser and retry.
...
browser for you** when it's holding the profile. Even with this on, Nunmai never
