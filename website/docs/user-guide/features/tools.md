...
See [Toolsets Reference](/reference/toolsets-reference) for the full set, including platform presets such as `nunmai-cli`, `nunmai-telegram`, and dynamic MCP toolsets like `mcp-<server>`.
