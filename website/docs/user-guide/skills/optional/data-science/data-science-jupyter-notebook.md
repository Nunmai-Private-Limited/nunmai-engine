...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing nunmai tool access (web_search, file ops). Stateless. |
...
jupyter-lab --no-browser --port=8888 --notebook-dir=$HOME/notebooks \
  --IdentityProvider.token='' --ServerApp.password='' > ~/.nunmai/cache/scratch/jupyter.log 2>&1 &
sleep 3
```
