...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/software-development/pr-lens` |
| Path | `optional-skills/software-development/pr-lens` |
| Version | `1.0.0` |
| Author | Coldtea AI (adapted by Nunmai Research) |
| License | MIT |
...
```bash
cp references/example.graph.json ~/.nunmai/cache/scratch/prlens-smoke/ && cd ~/.nunmai/cache/scratch/prlens-smoke
