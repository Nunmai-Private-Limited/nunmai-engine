...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Nunmai Engine |
| License | MIT |
...
```
SCRIPT=~/.nunmai/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.nunmai/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
