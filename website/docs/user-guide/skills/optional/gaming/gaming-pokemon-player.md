...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/gaming/pokemon-player` |
...
GET /screenshot and save to ~/.nunmai/cache/scratch/pokemon.png, then use vision_analyze.
