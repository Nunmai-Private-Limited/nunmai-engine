...
python ~/.nunmai/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.nunmai/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.nunmai/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.nunmai/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.nunmai/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.nunmai/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
