...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Nunmai Engine |
| License | MIT |
...
Helper script path: `~/.nunmai/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.nunmai/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.nunmai/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.nunmai/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
