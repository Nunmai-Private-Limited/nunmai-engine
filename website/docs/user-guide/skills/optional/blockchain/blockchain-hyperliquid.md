...
```bash
python ~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
