...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Nunmai Engine |
| License | MIT |
...
The script reads `${NUNMAI_HOME:-~/.nunmai}/.env` for two optional defaults:
...
Helper script: `~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${NUNMAI_HOME:-~/.nunmai}/.env`.
...
```bash
python3 ~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nunmai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
