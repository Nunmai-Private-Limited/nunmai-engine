...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/creative/pixel-art` |
...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.nunmai/skills/creative/pixel-art/scripts"))
from pixel_art import pixel_art
from pixel_art_video import pixel_art_video

# 1. Convert to pixel art
out = os.path.expanduser("~/.nunmai/cache/scratch")
...
```bash
cd ~/.nunmai/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Nunmai installs package this)
