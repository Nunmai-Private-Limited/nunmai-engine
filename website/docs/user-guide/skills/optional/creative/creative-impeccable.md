...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/creative/impeccable` |
...
> ships and verifies a Nunmai-native skill bundle under `.nunmai/skills/`.
> `nunmai skills install impeccable` pulls the current bundle live from that
