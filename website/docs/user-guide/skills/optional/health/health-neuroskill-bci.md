...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/health/neuroskill-bci` |
...
Connect Nunmai to a running [NeuroSkill](https://neuroskill.com/) instance to read
