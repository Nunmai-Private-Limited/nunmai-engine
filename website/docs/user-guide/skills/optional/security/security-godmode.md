...
exec(open(os.path.expanduser(
    os.path.join(os.environ.get("NUNMAI_HOME", os.path.expanduser("~/.nunmai")), "skills/security/godmode/scripts/load_godmode.py")
)).read())
...
exec(open(os.path.join(os.environ.get("NUNMAI_HOME", os.path.expanduser("~/.nunmai")), "skills/security/godmode/scripts/parseltongue.py")).read())
...
```python
# Via execute_code
exec(open(os.path.join(os.environ.get("NUNMAI_HOME", os.path.expanduser("~/.nunmai")), "skills/security/godmode/scripts/godmode_race.py")).read())
