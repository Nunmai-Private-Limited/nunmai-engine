...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/research/blogwatcher` |
...
## Working with Nunmai tools (read this first)

`blogwatcher-cli` is the feed database; Nunmai tools do the automation around it:
