...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/research/rss-feeds` |
...
`python3 scripts/feed.py read https://github.com/Nunmai-Private-Limited/nunmai-engine/releases.atom
