...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Nunmai Engine (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $NUNMAI_OSINT_CACHE/icij/ (default: ~/.cache/nunmai-osint/icij/).
...
# Set NUNMAI_OSINT_UA=your-app/1.0 (your@email) to identify yourself
