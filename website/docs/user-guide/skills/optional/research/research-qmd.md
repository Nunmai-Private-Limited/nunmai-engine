...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`nunmai-engine`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nunmai-engine), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Nunmai Engine via the native MCP client. This is the preferred
...
Then configure Nunmai Engine to connect via HTTP:
