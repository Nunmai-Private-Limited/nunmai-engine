...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/research/gitnexus-explorer` |
...
| Related skills | [`nunmai-engine`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nunmai-engine), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  nunmai-engine users don't need.
