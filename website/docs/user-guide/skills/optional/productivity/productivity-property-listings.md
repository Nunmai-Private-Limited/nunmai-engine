...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Nunmai desktop transcript.
...
- A Nunmai desktop conversation for native cards; the backend may be local or remote.
...
```text
nunmai skills install official/productivity/property-listings
```
