...
| | |
|---|---|
| Source | Optional — install with `nunmai skills install official/web-development/page-agent` |
...
- User wants **Nunmai itself to drive a browser** → use Nunmai' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
