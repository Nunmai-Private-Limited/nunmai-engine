...
- "Nunmai" -> "Noose" (forces correct pronunciation)
...
- **heartmula** — full songs with vocals from lyrics + tags
  ...
  `nunmai skills install official/creative/heartmula`
- **audiocraft** — Meta's MusicGen (instrumental text-to-music) and
  AudioGen (sound effects):
  `nunmai skills install official/creative/audiocraft-audio-generation`
