...
- Want to change how the agent **talks**? Edit `~/.nunmai/SOUL.md` — [Personality & SOUL.md](./features/personality.md).
- Want the agent to **remember a fact**? Just tell it — it saves to memory itself. [Persistent Memory](./features/memory.md).
- Want to set **project rules**? Put an `AGENTS.md` (or `.nunmai.md`) in the project — [Context Files](./features/context-files.md).
...
- [Context Files](./features/context-files.md) — AGENTS.md, `.nunmai.md`, progressive discovery, security scanning
