...
- **Nunmai Engine installed** on a server or VPS (not your laptop — the bot needs to stay running). Follow the [installation guide](../getting-started/installation.md) if you haven't yet.
...
For a full guide, see [Use SOUL.md with Nunmai](./use-soul-with-nunmai.md).
