...
:::tip
This recipe hits web search, summarization, and optional TTS — all bundled in a Portal subscription. The fastest setup is `nunmai setup --portal`. See [Nous Portal](/integrations/nous-portal).
:::
