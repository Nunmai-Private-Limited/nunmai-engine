...
:::tip
This recipe hits web search, summarization, and optional TTS — all bundled in a Portal subscription. The fastest setup is `nunmai setup --portal`. See [Nunmai Portal](/integrations/nous-portal).
:::
...
Nunmai will create the cron job for you using the unified `cronjob` tool.
