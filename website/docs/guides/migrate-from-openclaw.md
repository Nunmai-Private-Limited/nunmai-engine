...
| OpenClaw config path | Nunmai config path | Notes |
|---------------------|-------------------|-------|
...
6. **Check session policies** — run `nunmai config show` and verify the `session_reset` value matches your expectations.
