...
After installing, run `nunmai setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nunmai Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Nunmai safely  |
| 🧭 **[Use MCP with Nunmai](/guides/use-mcp-with-nunmai)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Nunmai](/guides/use-voice-mode-with-nunmai)** | Hands-on setup and usage patterns for Nunmai voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Nunmai' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Nunmai                              |
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Nunmai Portal](/integrations/nous-portal) bundles all of them
