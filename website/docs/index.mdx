...
slug: /
sidebar_position: 0
title: "Nunmai Engine Documentation"
description: "The self-improving AI agent built by Nunmai Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Nunmai Research](https://nunmai.in). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `nunmai setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nunmai Portal](./integrations/nous-portal.md).
:::

## What is Nunmai Engine?
...
| 🔌 **[MCP Integration](./user-guide/features/mcp.md)**                      | Connect to MCP servers, filter their tools, and extend Nunmai safely  |
| 🧭 **[Use MCP with Nunmai](./guides/use-mcp-with-nunmai.md)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](./user-guide/features/voice-mode.md)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Nunmai](./guides/use-voice-mode-with-nunmai.md)** | Hands-on setup and usage patterns for Nunmai voice workflows          |
| 🎭 **[Personality & SOUL.md](./user-guide/features/personality.md)**        | Define Nunmai' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](./guides/tips.md)**                            | Quick wins to get the most out of Nunmai                              |
...
- **Built by model trainers** — Created by [Nunmai Research](https://nunmai.in), the lab behind Nunmai, Nomos, and Psyche. Works with [Nunmai Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Nunmai Portal](./integrations/nous-portal.md) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nunmai Research](https://nunmai.in) — the lab behind Nunmai, Nomos, and Psyche models
