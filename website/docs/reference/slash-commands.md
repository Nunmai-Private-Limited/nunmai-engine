...
| `/busy [queue\|steer\|interrupt\|status]` | CLI-only: control what pressing Enter does while Nunmai is working — queue the new message, steer mid-turn, or interrupt immediately. |
