...
| [`nunmai-engine`](../user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nunmai-engine.md) | Use, configure, theme, extend, and orchestrate Nunmai Engine. | `autonomous-ai-agents/nunmai-engine` |
...
| [`nunmai-engine-skill-authoring`](../user-guide/skills/bundled/software-development/software-development-nunmai-engine-skill-authoring.md) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/nunmai-engine-skill-authoring` |
| [`inspecting-nunmai-desktop-dom`](../user-guide/skills/bundled/software-development/software-development-inspecting-nunmai-desktop-dom.md) | Read the live Nunmai desktop DOM/CSS over CDP. | `software-development/inspecting-nunmai-desktop-dom` |
