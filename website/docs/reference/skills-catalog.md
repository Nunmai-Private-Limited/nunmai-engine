...
| [`nunmai-engine`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nunmai-engine) | Use, configure, theme, extend, and orchestrate Nunmai Engine. | `autonomous-ai-agents/nunmai-engine` |
...
| [`nunmai-engine-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-nunmai-engine-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/nunmai-engine-skill-authoring` |
| [`inspecting-nunmai-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-nunmai-desktop-dom) | Read the live Nunmai desktop DOM/CSS over CDP. | `software-development/inspecting-nunmai-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .nunmai/plans/; no execution. | `software-development/plan` |
