...
| [**honcho**](../user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-honcho.md) | Configure and troubleshoot Honcho memory for Nunmai. |
...
| Skill | Description |
|-------|-------------|
| [**actual-setup**](../user-guide/skills/optional/devops/devops-actual-setup.md) | Set up Actual Computer (actual.inc) inference in Nunmai. |
...
| [**nunmai-s6-container-supervision**](../user-guide/skills/optional/devops/devops-nunmai-s6-container-supervision.md) | Modify or debug s6 services in the Nunmai Docker image. |
...
| Skill | Description |
|-------|-------------|
| [**openclaw-migration**](../user-guide/skills/optional/migration/migration-openclaw-migration.md) | Import an OpenClaw setup (memories, skills) into Nunmai. |
