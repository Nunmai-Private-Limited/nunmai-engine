...
```bash
export NUNMAI_HOME=$HOME/.nunmai/cache/scratch/nunmai-imggen-test
...
- [Build a Nunmai Plugin](./plugins/index.md) — general tools/hooks/slash commands guide
