...
├── cli.py                    # NunmaiCLI — interactive terminal UI (large file)
├── model_tools.py            # Tool discovery, schema collection, dispatch
├── toolsets.py               # Tool groupings and platform presets
├── nunmai_state.py           # SQLite session/state database with FTS5
...
│   ├── main.py               # Entry point — all `nunmai` subcommands (large file)
