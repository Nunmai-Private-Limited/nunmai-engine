...
The native [Nunmai Desktop](/user-guide/desktop) app is contribution-driven: every
...
CLI/gateway plugins are documented at [Build a Nunmai Plugin](/developer-guide/plugins).
...
```javascript
import { Contribute, TITLEBAR_AREAS } from '@nunmai/plugin-sdk'
