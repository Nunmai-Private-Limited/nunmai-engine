...
python -m pytest tests/nunmai_cli/test_runtime_provider_resolution.py tests/cli/test_cli_provider_resolution.py tests/nunmai_cli/test_setup_model_provider.py tests/run_agent/test_provider_parity.py -q
```
