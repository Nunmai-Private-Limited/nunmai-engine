...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `nunmai_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `nunmai_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Nunmai Plugin](plugins/index.md) |
...
| Session storage | `nunmai_state.py`, `nunmai_state_*.py` | [Session Storage](session-storage.md) |
