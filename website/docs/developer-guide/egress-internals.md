...
nunmai_cli/main.py:_dispatch_egress   Top-level subparser dispatcher.
...
tests/test_iron_proxy_e2e.py          Live E2E (gated on NUNMAI_RUN_E2E=1).
...
NUNMAI_RUN_E2E=1 scripts/run_tests.sh tests/test_iron_proxy_e2e.py

# Live PTY smoke against `nunmai egress`
NUNMAI_HOME=/tmp/nunmai-egress-test python3 -m nunmai_cli.main egress --help
NUNMAI_HOME=/tmp/nunmai-egress-test python3 -m nunmai_cli.main egress setup --help
```
