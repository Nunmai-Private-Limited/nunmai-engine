...
- **由模型训练者构建** — 由 [Nunmai Research](https://nunmai.in) 创建，该实验室是 Nunmai、Nomos 和 Psyche 背后的团队。支持 [Nous Portal](https://portal.nousresearch.com)、[OpenRouter](https://openrouter.ai)、OpenAI 或任意端点
