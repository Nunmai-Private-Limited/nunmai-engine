...
- **Profile 安全路径**：不得硬编码 `~/.nunmai` — 代码路径使用 `nunmai_constants` 中的 `get_nunmai_home()`，面向用户的消息使用 `display_nunmai_home()`。完整规则参见 [AGENTS.md](https://github.com/NousResearch/hermes-agent/blob/main/AGENTS.md#profiles-multi-instance-support)。
