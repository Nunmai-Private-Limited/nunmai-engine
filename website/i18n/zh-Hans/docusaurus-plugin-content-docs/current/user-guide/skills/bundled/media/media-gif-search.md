...
在环境中设置 Tenor API 密钥（添加到 `~/.nunmai/.env`）：
...
- GIF URL 可直接用于 markdown：`![alt](https://github.com/Nunmai-Private-Limited/nunmai-engine/blob/main/skills/media/gif-search/url)`