...
:::tip 从这里开始
如果您尚未安装 Nunmai Engine，请先阅读[安装指南](./installation.md)，然后完成[快速入门](./quickstart.md)。以下内容均假设您已完成安装。
:::
...
7. [在 Nunmai 中使用语音模式](../guides/use-voice-mode-with-nunmai.md)
...
2. [构建 Nunmai 插件](../developer-guide/plugins/index.md)
...
:::tip
对于大多数自定义工具的创建，建议从插件开始。[添加工具](../developer-guide/adding-tools.md)页面面向 Nunmai 核心内置开发，而非常规用户/自定义工具路径。
:::
...
| **代码执行** | 运行以编程方式调用 Nunmai 工具的 Python 脚本 | [代码执行](../user-guide/features/code-execution.md) |
