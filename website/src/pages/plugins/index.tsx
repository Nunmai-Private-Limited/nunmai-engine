      ...
      <div className={styles.cardInner}>
        ...
        {onPick ? (
          ...
          <a
            ...
            title="Opens the Install Plugin dialog in Nunmai Desktop at the reviewed version. No app? Use the install command below."
            onClick={(e) => e.stopPropagation()}
          >
            Open in Nunmai Desktop
          </a>
        )}

        {
          <div className={styles.cardDetail}>
            ...
            {plugin.requiresNunmai && (
              <div className={styles.metaRow}>
                <span className={styles.metaLabel}>Requires</span>
                <span className={styles.metaValue}>
                  <code>nunmai {plugin.requiresNunmai}</code>
                </span>
              </div>
            )}
            <div className={styles.metaRow}>
...
export default function PluginCatalogPage() {
  ...
  // (Nunmai desktop's Capabilities > Plugins tab) as a one-click catalog
  // picker. Site chrome is hidden via CSS and every card gains an
  // "+ Add to this Agent" button that posts
  //   { type: 'nunmai-plugin-pick', name, repo, sha, subdir, tier,
  //     installCmd }
  ...
  const pickPlugin = useCallback((plugin: CatalogPlugin) => {
    ...
    window.parent.postMessage(
      {
        type: "nunmai-plugin-pick",
        name: plugin.name,
        repo: plugin.repo,
        sha: plugin.sha,
        subdir: plugin.subdir || "",
        tier: plugin.tier,
        installCmd: plugin.installCommand || `nunmai plugins install ${plugin.name}`,
      },
      "*"
    );
  }, []);
  ...
  return (
    <Layout
      ...
      description="Give Nunmai new powers: reviewed plugins you can install in one click"
    >
      <div className={`${styles.page} ${pickerMode ? styles.pickerMode : ""}`}>
        <header className={styles.hero}>
          <div className={styles.heroGlow} />
          <div className={styles.heroContent}>
            <p className={styles.heroEyebrow}>Nunmai Engine</p>
            ...
            <p className={styles.heroSub}>
              Give Nunmai new powers. Memory, voice, messaging, browsing, Desktop panes and more,
          ...
          {!data && !loadError ? (
            ...
            <div className={styles.empty}>
              ...
              <p className={styles.emptyDesc}>
                The plugin catalog is a curated, human-reviewed list of Nunmai
