...
export default function PluginPage({ data }: { data: PluginPageData }) {
  ...
  const metaDescription = (prose || plugin.description || `${plugin.name} — a Nunmai Engine plugin`).slice(0, 160);
          ...
          <div className={styles.heroBody}>
            ...
            <div className={styles.actions}>
              <a
                ...
                title="Opens the Install Plugin dialog in Nunmai Desktop at the reviewed version. No app? Use the install command."
              >
          ...
          <div className={styles.columns}>
            ...
            <aside className={styles.side}>
              <dl className={styles.facts}>
                ...
                <Fact label="Requires">
                  <code>nunmai {plugin.requiresNunmai || "(any version)"}</code>
                </Fact>
