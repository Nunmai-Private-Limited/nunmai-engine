 ...
 * across theme x background scenes to <tmpdir>/nunmai-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@nunmai/ink'
...
// The regenerated slate light_colors block from nunmai_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/nunmai-engine',
...
const setup = (bgHex: string) => {
  process.env.NUNMAI_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
