...
await build({
  ...
  // Skip the prebuilt @nunmai/ink bundle and inline the source instead:
  ...
  alias: { '@nunmai/ink': resolve(root, 'packages/nunmai-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The nunmai_cli launcher
