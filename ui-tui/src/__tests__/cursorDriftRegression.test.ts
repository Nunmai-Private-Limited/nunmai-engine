 ...
 *
 * Symptom: in `nunmai --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@nunmai/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using nunmai --tui and as i type multiline my caret at the end will often ' +
