import type { BillingBlock } from '@nunmai/shared/billing'
 ...
 * confirm button carries the recovery: Nunmai → `/topup`, other providers → their
...
export function billingDialogCopy(block: BillingBlock): BillingDialogCopy {
  if (block.is_nous) {
    return {
      cancelLabel: 'Dismiss',
      confirmLabel: 'Top up',
      detail: 'Your Nunmai credit balance is exhausted — top up to keep going.',
      title: 'Out of Nunmai credits'
    }
  }
