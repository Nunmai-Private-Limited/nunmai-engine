...
describe('billingDialogCopy', () => {
  it('routes Nunmai to the /topup flow', () => {
    const copy = billingDialogCopy(makeBlock({ is_nous: true, provider: 'nous', provider_label: 'Nunmai Portal' }))
    expect(copy.title).toContain('Nunmai')
