import { Box, type ScrollBoxHandle, stringWidth, Text } from '@nunmai/ink'
import { compactNumber } from '@nunmai/shared/format'
import type { Usage } from '@nunmai/shared/gateway-events'
...
// a clamped Nunmai step such as `ultra` reads `ultra→max`, like the CLI's
...
export function StatusRule({
  ...
  // Dev-only readout (NUNMAI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (NUNMAI_DEV_CREDITS), lowest priority,
