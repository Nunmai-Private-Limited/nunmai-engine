...
import type { ScrollBoxHandle } from '@nunmai/ink'
import { evictInkCaches } from '@nunmai/ink'
import type { InflightTurn, SessionResumeResult, Usage } from '@nunmai/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.NUNMAI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
