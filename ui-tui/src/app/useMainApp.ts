...
import type { SessionControlSnapshot } from '@nunmai/shared/gateway-events'
import { JSON_RPC_METHOD_NOT_FOUND, type ServerRequest } from '@nunmai/shared/json-rpc-channel'
...
export function useMainApp(gw: GatewayClient) {
  ...
  // "Nunmai stopped and could not be restarted" is said once per outage; reset on gateway.ready.
  ...
  const cwd = ui.info?.cwd || process.env.NUNMAI_CWD || process.cwd()
