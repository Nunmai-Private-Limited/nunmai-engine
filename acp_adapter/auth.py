...
def build_auth_methods() -> list[Any]:
    ...
    not have Nunmai provider credentials configured yet, so Nunmai always
    ...
    if provider:
        methods.append(
            AuthMethodAgent(
                ...
                description=(
                    "Authenticate Nunmai using the currently configured "
    ...
    methods.append(
        TerminalAuthMethod(
            ...
            name="Configure Nunmai provider",
            description=(
                "Open Nunmai' interactive model/provider setup in a terminal. "
