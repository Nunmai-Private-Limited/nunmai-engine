#!/usr/bin/env python3
"""
SWE Runner with Nunmai Trajectory Format

A runner that uses Nunmai-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Nunmai-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Nunmai-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Nunmai format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Nunmai-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Nunmai-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Nunmai Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Nunmai-Agent's built-in execution environments
    and outputs trajectories in Nunmai-Agent format.
    """
    ...
    def _convert_to_nunmai_format(
        ...
        """
        Convert internal message format to Nunmai trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Nunmai trajectory format
        trajectory = self._convert_to_nunmai_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Nunmai trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Nunmai Trajectory Format")
    print("=" * 60)
