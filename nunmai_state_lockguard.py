...
a plugin, a tool reading ``~/.nunmai`` — cancels both (sqlite.org/howtocorrupt.html §2.2) and the
...
# nunmai_state dies before supported() can say "no" (#118026) — so tolerate a missing attribute
