      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via NUNMAI_BUNDLED_SKILLS /
            # NUNMAI_OPTIONAL_SKILLS (see nunmai-engine.nix), not via the
            ...
            # __init__.py) shipped via symlinks + NUNMAI_BUNDLED_LOCALES
            # / NUNMAI_OPTIONAL_MCPS, not via the wheel. Excluding them
