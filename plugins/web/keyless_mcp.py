...
two endpoints so a fresh Nunmai install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``nunmai tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `nunmai tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `nunmai tools` for reliable service."
            ),
        }
