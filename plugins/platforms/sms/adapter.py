...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Nunmai gateway adapter.

    Each inbound phone number gets its own Nunmai session (multi-tenant).
...
# static dict in nunmai_cli/gateway.py, and the _send_sms dispatch in
