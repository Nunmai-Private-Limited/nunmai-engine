...
required — uses aiohttp which is already a Nunmai dependency.
...
def interactive_setup() -> None:
    ...
    ``nunmai_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Nunmai delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # nunmai_cli/setup.py::_setup_mattermost function.
