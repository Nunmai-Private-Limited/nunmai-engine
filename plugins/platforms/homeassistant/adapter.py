...
class HomeAssistantAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {"title": "Nunmai Engine", "message": content[:self.MAX_MESSAGE_LENGTH]}
...
# nunmai_cli/gateway.py, and the _send_email dispatch in tools/send_message_tool.py. EMAIL_*
...
def _is_connected(config) -> bool:
    """Connected when ``HASS_TOKEN`` is set; read via ``nunmai_cli.gateway.get_env_value`` at call
