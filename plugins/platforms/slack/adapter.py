...
class SlackAdapter(BasePlatformAdapter):
    ...
    _EA_ACTION_IDS = {"once": "nunmai_approve_once", "session": "nunmai_approve_session",
                      "always": "nunmai_approve_always", "deny": "nunmai_deny"}
...
def interactive_setup() -> None:
    ...
    from nunmai_cli.config import remove_env_value, save_env_value
    from nunmai_cli.cli_output import (
        prompt, prompt_yes_no, print_header, print_info, print_success, print_warning)
    from nunmai_cli.setup_platforms import declines_reconfigure
