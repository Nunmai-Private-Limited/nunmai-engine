...
class DingTalkAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {
            "msgtype": "markdown",
            "markdown": {"title": "Nunmai", "text": normalized},
        }
    ...
    async def _create_and_stream_card(
        ...
        *,
        ...
        try:
            ...
            out_track_id = f"nunmai_{uuid.uuid4().hex[:12]}"
...
# dict in nunmai_cli/gateway.py, and the _send_dingtalk dispatch in
...
def interactive_setup() -> None:
    ...
    Replaces nunmai_cli/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in nunmai_cli/gateway.py. CLI helpers are
