"""
A2A (Agent-to-Agent) plugin for Nunmai Engine.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Nunmai as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`nunmai gateway setup` flow for A2A."""
    ...
    print_info("Expose Nunmai as an A2A-discoverable agent and call other A2A agents.")
