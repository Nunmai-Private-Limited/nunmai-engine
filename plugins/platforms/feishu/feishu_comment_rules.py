...
Config: ~/.nunmai/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.nunmai/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_nunmai_home()`` helper (NUNMAI_HOME-aware and
