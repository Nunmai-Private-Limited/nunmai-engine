...
Configuration
-------------
Secret (lives in $NUNMAI_HOME/.env or the environment):
...
Behavioral settings (live in $NUNMAI_HOME/mem0.json, set via `nunmai memory
setup`):
  ...
  agent_id           — Agent identifier (default: nunmai)
...
def _load_config() -> dict:
    """Load config from env vars, with $NUNMAI_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "nunmai"),
        "oss": {},
    }
    ...
    config_path = get_nunmai_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, nunmai_home):
        """Write config to $NUNMAI_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $NUNMAI_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "nunmai")
