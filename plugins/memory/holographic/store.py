...
Single-user Nunmai memory store plugin.
"""
...
class MemoryStore:
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted NUNMAI_HOME (same issue as
        # state.db / kanban.db — see nunmai_state._WAL_INCOMPAT_MARKERS).
