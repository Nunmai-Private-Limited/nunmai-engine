...
from nunmai_state_common import TITLE_SOURCE_DERIVED, TITLE_SOURCE_LLM
...
def resolve_active_host() -> str:
    """Honcho host key: NUNMAI_HONCHO_HOST (profile-scoped .env), else the active profile. The config's
    ...
    explicit = (get_secret("NUNMAI_HONCHO_HOST", "") or "").strip()
    if explicit:
        return explicit
    try:
