(function () {
  "use strict";
  // nunmai-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/hermes-achievements (MIT).
  // Bundled into nunmai-engine. Upstream repo remains the staging ground for new
  ...
  if (!SDK || !window.__NUNMAI_PLUGINS__) return;
  ...
  function api(path, options) {
    ...
    // BOTH dashboard modes: loopback (X-Nunmai-Session-Token header) and
    // gated OAuth (nunmai_session_at cookie via credentials:'include').
    // Hand-rolling fetch + reading window.__NUNMAI_SESSION_TOKEN__ directly
    ...
    const url = "/api/plugins/nunmai-achievements" + path;
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.href = url;
      a.download = "nunmai-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Nunmai Engine ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NousResearch · https://nunmai.in";
    }
    ...
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      React.createElement("section", { className: "ha-hero ha-loading-hero" },
        React.createElement("div", null,
          ...
          React.createElement("h1", null, tx(t, "hero.title", "Nunmai Achievements")),
          React.createElement("p", null, tx(t, "hero.scan_subtitle", "Scanning Nunmai session history. First scan can take 5–10 seconds on large histories."))
        ),
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.scan_status_body", "Nunmai is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds."))
        ),
        React.createElement("div", null,
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          React.createElement("div", { className: "ha-kicker" }, tx(t, "hero.kicker", "Agentic Gamerscore")),
          React.createElement("h1", null, tx(t, "hero.title", "Nunmai Achievements")),
          React.createElement("p", null, tx(t, "hero.subtitle", "Collectible Nunmai badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears."))
        ),
      ...
      React.createElement("div", { className: "ha-stats" },
        ...
        React.createElement(StatCard, { label: tx(t, "stats.latest", "Latest"), value: latest[0] ? latest[0].name : tx(t, "stats.none_yet", "None yet"), hint: latest[0] ? latest[0].category : tx(t, "stats.latest_hint_empty", "run Nunmai more") })
      ),
      React.createElement("section", { className: "ha-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.secret_body", "Secrets hide their exact trigger. Once Nunmai sees a related signal, the card becomes Discovered and shows its requirement."))
        )
      ),
  ...
  window.__NUNMAI_PLUGINS__.register("nunmai-achievements", AchievementsPage);
})();
