...
request omits ``thinking``.  Nunmai' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Nunmai reasoning
...
(per Z.AI / BigModel docs).  Nunmai' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Nunmai reasoning effort onto GLM's native vocabulary.
