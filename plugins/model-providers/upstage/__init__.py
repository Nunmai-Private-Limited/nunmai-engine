...
# When the user hasn't picked a reasoning effort, Nunmai passes
...
# ON at this effort — matching the "medium (default)" that Nunmai' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Nunmai' effort vocabulary onto Solar's accepted set via the
