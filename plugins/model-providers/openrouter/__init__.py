...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by nunmai_cli/models.py
    ...
    def build_extra_body(
        ...
        #
        # Mirrors the Nunmai Portal profile, which resolves the same way
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See nunmai-engine#42991 (disable case)
            ...
            # live token-spend probe in nunmai-engine#43432). Route the existing
