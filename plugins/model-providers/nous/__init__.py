...
class NousProfile(ProviderProfile):
    ...
    def build_extra_body(self, *, session_id: str | None = None, **context) -> dict[str, Any]:
        ...
        # Nunmai Portal inference rejects caller-supplied provider routing prefs
    ...
    def _cannot_disable_reasoning(model: str | None) -> bool:
        ...
        try:
            from nunmai_cli.models_reasoning_caps import nous_model_reasoning_capabilities, warm_nous_reasoning_caps_async
...
nous = NousProfile(
    ...
    display_name="Nunmai Research", description="Nunmai Research — Nunmai model family",
    signup_url="https://nunmai.in/", fallback_models=("hermes-3-405b", "hermes-3-70b"),
