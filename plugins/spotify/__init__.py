...
``_check_spotify_available()`` — when the user has not run ``nunmai auth
spotify``, the tools remain registered (so they appear in ``nunmai
...
The Spotify auth flow (``nunmai auth spotify``), CLI plumbing, and docs
