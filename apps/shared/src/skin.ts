/**
 * Canonical Nunmai skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$NUNMAI_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`nunmai_cli/skin_engine.py`),
 ...
 *   • CLI     → `nunmai_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
