...
export function registerFsIpc({
  ...
  async function localPluginsRoot(dirName: string): Promise<string> {
    ...
    // profiles/<name>/, matching the profile-scoped nunmai_home the backend
  ...
  ipcMain.handle('nunmai:fs:desktopPluginsRoot', async () => localPluginsRoot('desktop-plugins'))
  ...
  // The LOCAL agent-plugin root (`<NUNMAI_HOME>/plugins`), same Electron-local
  ...
  ipcMain.handle('nunmai:fs:agentPluginsRoot', async () => localPluginsRoot('plugins'))
