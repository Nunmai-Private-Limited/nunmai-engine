 ...
 * Apps) login to a gated Nunmai gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (Nunmai Portal) issues a per-gateway-instance client_id and only
...
// nunmai_cli/web_server.py status handler.
