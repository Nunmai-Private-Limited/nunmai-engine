...
// even though a fresh shell — and the Nunmai CLI — sees it immediately. The
// desktop's NUNMAI_HOME resolution relies on process.env, so that stale-snapshot
...
//       NUNMAI_HOME    REG_SZ    F:\Nunmai\data
//
