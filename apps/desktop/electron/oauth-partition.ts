 ...
 * (`persist:nunmai-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `nunmai_session*`
...
export const LEGACY_OAUTH_PARTITION = 'persist:nunmai-remote-oauth'
...
// `Partitions/nunmai-remote-oauth%3Aconn%3A<id>` folder is left on disk,
