 ...
 *
 * A public install can end up with `origin=git@github.com:Nunmai-Private-Limited/nunmai-engine.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Nunmai-Private-Limited/nunmai-engine.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nunmai-private-limited/nunmai-engine'
