 ...
 *     it via `nunmai:profile:remember` without re-homing the primary.
 ...
 * the same NUNMAI_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startNunmai() with the profile the primary is launching as. */
