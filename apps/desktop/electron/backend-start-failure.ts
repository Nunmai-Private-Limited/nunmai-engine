 ...
 * startNunmai() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startNunmai() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startNunmai`, re-emits
