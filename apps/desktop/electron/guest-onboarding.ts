// The Nunmai free tier is gated by ONE launch-time decision. The Python backend
// reads NUNMAI_GUEST_ONBOARDING and treats exactly "1" as on; the desktop
...
export const GUEST_ONBOARDING_ENV = 'NUNMAI_GUEST_ONBOARDING'
...
// on every fresh NUNMAI_HOME. The guide still runs — only the film is
// skipped. Renderer-only; the backend never sees it.
export const SKIP_INTRO_ENV = 'NUNMAI_SKIP_INTRO'
