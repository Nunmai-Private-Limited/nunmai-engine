...
// by main.ts (`setBackgroundThrottling` driven by the merged `nunmai:active-work`
...
// (the "Nunmai idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Nunmai" wake word has NO preceding click,
