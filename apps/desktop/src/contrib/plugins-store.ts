 ...
 * `<nunmai home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'nunmai.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'nunmai.desktop.disabledPlugins.v1'
