...
//  - `<nunmai home>/desktop-plugins/<name>/plugin.js` — the standalone door
//    (agent- or user-written desktop-only plugins);
//  - `<nunmai home>/plugins/<name>/desktop/plugin.js` — the desktop HALF of a
 ...
 *  backend's nunmai_home — #66899). `agentPluginsRoot` is optional: older
...
async function diskRoots(): Promise<DiskRoot[]> {
  ...
  if (unified) {
    // Opt-in by default: `~/.nunmai/plugins` is installed-but-inert until the
