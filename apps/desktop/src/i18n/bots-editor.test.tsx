import type * as NunmaiSdk from '@nunmai/plugin-sdk'
...
import { $imagenAvailable } from '@/plugins/nunmai-bots/avatar-image'
import { CreateAgentDialog } from '@/plugins/nunmai-bots/create-dialog'
import { EditProfileDialog } from '@/plugins/nunmai-bots/edit-profile-dialog'
import { BOTS_LOCALES } from '@/plugins/nunmai-bots/i18n'
import { translateBotsIn } from '@/plugins/nunmai-bots/i18n-test-helper'
...
vi.mock('@nunmai/plugin-sdk', async importOriginal => {
  const sdk = await importOriginal<typeof NunmaiSdk>()
...
function mount(children: React.ReactNode) {
  dispose = registerPluginLocales('nunmai-bots', BOTS_LOCALES)
