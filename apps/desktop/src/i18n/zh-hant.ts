...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsTitle: '應用程式內提示',
      tipsDesc: '指向應用程式某處的小氣泡：閒置時偶爾出現，需要時 Nunmai 也會給你一則。每則提示只出現一次。',
      tipsReset: (count: number) => `再次顯示 ${count} 則提示`,
      toursTitle: '導覽',
      toursDesc: '讓 Nunmai 帶你認識應用程式：調暗畫面並逐步標示每個位置。',
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `正在執行 llama.cpp ${tag}（${backend}）——Nunmai 提供的最新組建。`,
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'Nunmai 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
