...
export const en: Translations = {
  ...
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Nunmai to use.',
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'In the Nunmai catalog',
    ...
    page: {
      ...
      noMatchBody: 'Nothing here matches. Point Nunmai at your own MCP server to add it.',
      ...
      signInLine: 'Sign in to Nunmai to use managed apps.',
      signIn: 'Sign in',
      ...
      disconnectNoAccount: 'Nunmai has no account to disconnect here. Refresh the page and try again.',
      disconnectRefused:
        'Nunmai could not remove this sign-in right now. Turn the app off with the switch instead, or try again later.'
    },
    ...
    dialog: {
      ...
      disconnectBody: 'Nunmai stops acting as this account. You can connect again at any time.',
      ...
      nousLine: 'Nunmai apps follow your account, not the profile.',
      rulesReadOnly: 'Rules cannot be changed right now.',
      rulesAppOff: (name: string) => `Turn ${name} on to change its tools.`,
      rulesSignIn: 'Sign in to change what Nunmai may do here.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `What Nunmai may do with ${name}`,
      summaryPreviewTitle: (name: string) => `What Nunmai could do with ${name} once you connect`,
      ...
      goneBody: 'Nunmai cannot call it any more. The row stays until you remove it, so nothing vanishes.',
      remove: 'Remove',
      offTitle: (name: string) => `${name} is off.`,
      offBody: 'Turn it on with the switch above to read the tools it brings.',
      signedOutTitle: 'Sign in to Nunmai to read the tool list.',
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Nunmai and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Nunmai.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Nunmai. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Nunmai',
    continue: 'Continue in Nunmai',
  ...
  boot: {
    ready: 'Nunmai Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Nunmai settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Nunmai backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingNunmaiDesktop: 'Starting Nunmai Desktop…'
    },
    errors: {
      backgroundExited:
        'The service that runs your chats closed unexpectedly. Restart it to keep going — your chats and settings are safe.',
      backgroundExitedDuringStartup: 'Nunmai stopped right after it started.',
      backendStopped: 'Nunmai stopped working in the background',
      restartNunmai: 'Restart Nunmai',
      openLogs: 'Open logs',
      desktopBootFailed: "Nunmai couldn't start",
      gatewayConnectionLost: 'Nunmai lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Nunmai signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Nunmai Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Nunmai' background service stopped right after starting.",
      timedOut: "Nunmai' background service didn't answer in time.",
      permission: "Nunmai couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Nunmai could not start.',
      portInUse: 'Another program is using the network port Nunmai needs.',
      installMissing: "Part of Nunmai' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Nunmai couldn't start",
      description:
        "Nunmai' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Nunmai backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateNunmai: 'Update Nunmai',
    ...
    errors: {
      ...
      storageFailure: "Nunmai couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Nunmai no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed:
        "Nunmai' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired:
        'Nunmai was updated but is still running the old version. Restart it to finish the update.',
      rpcOutOfSync: 'The app and the backend are on different versions. Update both.',
      restartNunmaiFailed: "Couldn't restart Nunmai"
    },
    actions: {
      restartNunmai: 'Restart Nunmai',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Nunmai',
    ...
    native: {
      ...
      inputBody: 'Nunmai is waiting for your response.',
      turnDoneTitle: 'Nunmai finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `nunmai debug share --nous` from a terminal, or `nunmai debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Nunmai defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Nunmai catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Nunmai generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Nunmai picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Nunmai.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Nunmai closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Nunmai is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Nunmai asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Nunmai was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Nunmai was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Nunmai follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Nunmai can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Nunmai. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Nunmai spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Nunmai is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Nunmai, then come back here.',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallNunmai: 'Uninstall Nunmai',
      chooseHowMuch:
      ...
      options: {
        ...
        lite: {
          ...
          description:
            'Remove the app and the Nunmai agent, but keep config, chats, and secrets for a future reinstall.',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Nunmai runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Nunmai only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Nunmai',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Nunmai checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Minimize windows or close the main window to hide them in the system tray (menu bar on macOS) and keep Nunmai running. Use Quit Nunmai from the tray menu or Cmd+Q to exit. Off by default; applies only to this device.',
      ...
      loading: 'Loading Nunmai configuration...',
    ...
    hudModifier: {
      ...
      permission:
        'Allow Nunmai in System Settings → Privacy & Security → Input Monitoring, then retry. This gesture does not record keystrokes or capture your screen.',
      unavailable:
        'The HUD gesture helper could not start or stopped unexpectedly. Retry, or restart Nunmai. The existing HUD shortcut still works inside Nunmai.',
      missingHelper:
        'This Nunmai installation is missing the HUD gesture helper. Update or reinstall Nunmai, then retry.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Nunmai draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Nunmai detect both Command keys while another app is active. Allow Nunmai in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Nunmai capture the frontmost app window when you use this shortcut. Allow Nunmai in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Nunmai if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Nunmai.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Nunmai gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Nunmai Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Nunmai Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Nunmai runtime managed by this app.',
      kindRemoteDesc: 'A Nunmai gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Nunmai Cloud account.',
      kindSshDesc: 'A Nunmai install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Nunmai manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Nunmai Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Connection settings can only be changed from the Nunmai Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Nunmai backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Nunmai was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Nunmai without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Nunmai backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Nunmai backend.',
      ...
      cloudDesc: 'Sign in once to Nunmai Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Nunmai Cloud',
      cloudSignIn: 'Sign in to Nunmai Cloud',
      cloudSignedIn: 'Signed in to Nunmai Cloud',
      cloudNeedsSignIn: 'Sign in to Nunmai Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Nunmai Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Nunmai Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Nunmai Cloud',
      cloudSignedOutMessage: 'Cleared the Nunmai Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /nunmai.',
      probing: 'Checking how this gateway authenticates…',
      probeError:
        "Nunmai can't reach that address. Check the URL and that the other computer is running Nunmai — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'Nunmai Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Nunmai ${version}` : ''}`,
      ...
      sshDesc:
        'Nunmai is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshNunmaiPathTitle: 'Nunmai path (optional)',
      sshNunmaiPathDesc: 'Full path to the remote nunmai binary. Blank = auto-detect.',
      sshNunmaiPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Nunmai found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Nunmai runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Nunmai is not installed on the remote host. Install it there (curl -fsSL https://nunmai-engine.nunmai.in/install.sh | sh) or set the Nunmai path.',
      sshErrPlatform:
        'Unsupported remote platform. Nunmai Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Nunmai on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Nunmai. Review the exact configuration below — it comes from the link, not from Nunmai.',
    ...
    model: {
      ...
      moaPreset: 'Preset',
      moaDescription:
        'Configure named presets that appear as models under the Nunmai Agent provider. The aggregator is the acting model — it runs every step of the tool loop, and almost all of the run’s cost is billed to its provider. References only advise once per user turn by default.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Nunmai starts and manages the server for you.`,
      ...
      state: {
        notice: {
          loggedOut: {
            ...
            message: 'Sign in with your Nunmai account to see your balance, plan and usage here.',
            action: 'Sign in'
          },
          openPortal: 'Open portal ↗',
          noCard: {
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Nunmai runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Nunmai at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Nunmai subscription — sign in with your Nunmai account to activate.',
      nousAuthNeededTitle: 'Sign in with your Nunmai account',
      nousAuthNeededMessage: provider =>
        `${provider} is saved but will only work once you sign in with your Nunmai account.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Nunmai account connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Nunmai sign-in did not complete',
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Nunmai can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Nunmai browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via nunmai curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Nunmai to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Nunmai catalog${sha ? ` at pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the Nunmai plugin catalog. Nothing was installed.`,
      deepLinkCatalogUnavailable:
        'Could not load the Nunmai plugin catalog. Check your connection and open the link again.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Nunmai builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Nunmai to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Nunmai to generate pets.',
      backgroundHint: 'You can close this — Nunmai will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Nunmai desktop' },
    ...
    nunmaiActiveSessions: (version, count) => `Nunmai ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "Nunmai couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Nunmai installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Nunmai creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@nunmai:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Nunmai you point it at, instead of this computer.',
    ...
    defaultDescription: 'Used when Nunmai opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Nunmai environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'Nunmai did not save that model change.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Nunmai will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Nunmai can't read all of the session history for ${profiles}. Chats missing from this list were not deleted; the file they are stored in is damaged.`,
      action: 'Quit Nunmai on this profile, then inspect the file without changing it, or restore a snapshot:',
    ...
    projects: {
      ...
      staleBackend:
        'Update the Nunmai backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Nunmai. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Nunmai backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Nunmai...',
    placeholderReconnecting: 'Reconnecting to Nunmai…',
    ...
    voiceEngineChained: 'Speech-to-text + Nunmai voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Nunmai)',
    ...
    commandDescs: {
      ...
      '/goal': 'Set a standing goal Nunmai works on across turns until achieved',
      ...
      '/plan': 'Write a markdown implementation plan to .nunmai/plans/ without executing anything',
      '/moa': 'Run one prompt through the default Nunmai Agent preset, then restore your model',
      ...
      '/profile': 'Switch the active Nunmai profile',
    ...
    attachUrlDesc: 'Nunmai will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Nunmai to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Nunmai…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Nunmai…',
    ...
    unsupportedMessage: 'This version of Nunmai can’t update itself from inside the app.',
    connectionRetry:
      "Nunmai couldn't reach the update server. Check your internet connection and try again. If you use a remote Nunmai, make sure it is online.",
    gitUnusable: 'Nunmai could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed Nunmai from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nunmai will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nunmai desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Nunmai updater takes over in its own window and reopens Nunmai automatically when it’s done. Please don’t reopen Nunmai yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nunmai reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Nunmai reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Nunmai?',
    blockerBody:
      'Nunmai needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Nunmai',
    foreignBlockerBody:
      'Nunmai can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Nunmai can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Nunmai is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Nunmai whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Nunmai. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Nunmai needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Nunmai Desktop',
    setupChoiceDesc:
      'Connect this app to a Nunmai gateway you already run, or install Nunmai locally on this computer.',
    connectExistingTitle: 'Connect to existing Nunmai',
    ...
    installLocalTitle: 'Install Nunmai locally',
    installLocalDesc: 'Download Nunmai, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Nunmai Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Nunmai',
    ...
    settingUpTitle: 'Setting up Nunmai Engine',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Nunmai is running, the internet connection dropped, or antivirus blocked the installer. Close other Nunmai windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Nunmai Engine",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Nunmai is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nunmai…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nunmai',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Nunmai at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Nunmai connects automatically',
    ...
    authorizeThere: 'Authorize Nunmai there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Nunmai there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    providerRowTitle: 'Nunmai · free tier',
    providerRowPitch: 'Sign in with a Nunmai account to unlock more models and tools.',
    readyTitle: 'Nunmai is ready.',
    readyCaption: 'Free · connectors included',
    begin: 'Begin',
    signInInstead: 'Sign in with a Nunmai account instead',
    otherProviders: 'Other providers',
    stripTitle: 'Free Nunmai inference and connectors are now available.',
    stripBody: 'Open the model picker to try them, or sign in with a Nunmai account.',
    openModelPicker: 'Open model picker',
    dismiss: 'Dismiss',
    providerName: 'Nunmai',
    statusLabel: model => `Nunmai · ${model}`,
    signIn: 'Sign in',
    signInHeading: 'Sign in with a Nunmai account to unlock more models and tools.',
    ...
    rejectedBody: "No problem, you're still on the free Nunmai service. Sign in whenever you're ready.",
    ...
    timedOutBody: "Start again whenever you're ready. You're still on the free Nunmai service.",
    retiredBody:
      "Your session ended before the sign-in finished. Nunmai will start a new one; then sign in again whenever you're ready.",
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `Nunmai couldn't finish signing you in because the Nunmai service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "Nunmai couldn't reach the Nunmai service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This Nunmai is already signed in to a Nunmai account.',
    setupFailed: {
      gateClosed:
        "This version of Nunmai can't start without a Nunmai account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using Nunmai without signing in is paused for a moment. Nunmai will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so Nunmai will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "Nunmai couldn't reach the Nunmai service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      serverError: 'The Nunmai service had a hiccup. Tap Try again in a moment, or connect another provider for now.',
      powRequired:
        "The Nunmai server asked for a proof of work, but that isn't implemented in your Agent yet. Sign in or create a free Nunmai account to continue.",
      locked: "This session can't continue without signing in. Sign in or create a free Nunmai account to keep going.",
      generic:
        "Nunmai couldn't set up free access without signing in. Signing in is free, or connect another provider.",
      signInBelow: 'Signing in is free. Pick Nunmai below.',
      tryAgain: 'Try again',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Nunmai will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Nunmai is restarting...',
      askRestart: 'Ask Nunmai to restart the server',
      lookingRestart: taskId => `Nunmai is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Nunmai is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Nunmai to open a page.',
      finishedRestarting: message => `Nunmai finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nunmai could not restart the server.',
      stillWorking:
        'Nunmai is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  interfaceMode: {
    ...
    hint: 'Changes what is shown, not what Nunmai can do.',
    sessionNote: 'Set by Simple mode. A change here lasts for this session; switch to Advanced to make it yours.',
    simple: {
      label: 'Simple',
      description: 'For talking to Nunmai. Sidebar and chat; no terminal, file or diff panes.'
    },
    advanced: {
      label: 'Advanced',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nunmai is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'Nunmai hit a problem',
        generic: "Nunmai couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Nunmai hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Nunmai could not save this conversation. Free some space, then retry.',
        endpoint:
          "Nunmai can't reach your custom model server. Check that it is running, then send your message again.",
        gateway:
          'Nunmai hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Nunmai was replying. Retry, or copy the details if it keeps happening.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Nunmai could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Nunmai could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Nunmai got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Nunmai stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Nunmai window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Nunmai could not save this conversation. Free some space, then retry.'
        },
        // Nunmai free tier. The body is normally the backend's own sentence (it names the wait
        // and the way forward); these bodies stand in for an older backend that sent none.
        free_tier_disabled: {
          title: 'Using Nunmai without signing in is switched off right now',
          body: "Sign in with a Nunmai account to keep chatting, it's free."
        },
        free_tier_rate_limited: {
          title: "You've used up the allowance for chatting without signing in",
          body: "It refreshes shortly. Sign in with a Nunmai account for a bigger allowance, it's free."
        },
        ...
        free_tier_model_not_free: {
          ...
          body: "Nunmai uses the free model for now. Sign in with a Nunmai account for more models, it's free."
        },
        free_tier_route: {
          title: "Nunmai couldn't reach the free model on this route",
          body: "Sign in with a Nunmai account, it's free, or check the NOUS_INFERENCE_BASE_URL setting."
        },
        free_tier_outage: {
        ...
        free_tier_refused: {
          title: "Nunmai couldn't send that without signing in",
          body: 'Signing in with a Nunmai account is free.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: "Nunmai couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenNunmaiFolder: 'Open Nunmai folder',
      errorOpenNunmaiFolderFailed: 'Could not open the Nunmai folder',
      errorUpdateApiKey: 'Update API key',
      errorSignInAgain: provider => `Sign in to ${provider} again`,
      errorSignInFreeTier: 'Sign in with a Nunmai account',
    ...
    approval: {
      gatewayDisconnected:
        'Nunmai is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Nunmai to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.nunmai/config.yaml). Nunmai won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'Nunmai is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    sudoInstallDesc:
      'Nunmai needs your sudo password to install the Bot Screen packages (TigerVNC + Xfce) on the gateway host. It is sent only to that host.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Nunmai needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Nunmai reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Nunmai types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Nunmai enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Nunmai Desktop to use Save Image.',
    restartToSaveImages: 'Restart Nunmai Desktop to save images',
    ...
    handoff: {
      ...
      timedOut:
        "Nunmai couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Nunmai loads when the work calls for them.'
      },
      messaging: {
        title: 'Nunmai away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Nunmai made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Nunmai — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
