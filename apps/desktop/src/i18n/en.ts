  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Nunmai backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Nunmai backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.nunmai/plugins/)`,
    ...
    appearance: {
      ...
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Nunmai when it helps. Closing one retires it for good.',
