...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      backgroundExited: 'Nunmai background process exited.',
      backgroundExitedDuringStartup: 'Nunmai background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nunmai Desktop.',
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Nunmai when it helps. Each tip appears once.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Nunmai walk you through the app, dimming the screen and spotlighting each step.',
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset NUNMAI_DESKTOP_REMOTE_URL and NUNMAI_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Nunmai ships.`,
  ...
  install: {
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nunmai CLI or desktop instance is running. Stop any running Nunmai instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'Nunmai gateway is not connected',
  ...
  prompts: {
    ...
    sudoDesc: 'Nunmai needs your sudo password to run a privileged command. It is sent only to your local agent.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `nunmai gateway` running?'
    }
  },
