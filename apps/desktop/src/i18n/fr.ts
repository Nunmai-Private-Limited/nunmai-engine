...
export const fr = defineLocale({
  ...
  connectors: {
    ...
    disclaimer: "La connexion est facultative. N'autorisez que les applications que vous voulez confier à Nunmai.",
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'Dans le catalogue Nunmai',
    ...
    page: {
      ...
      noMatchBody: 'Aucun résultat. Indiquez à Nunmai votre propre serveur MCP pour l’ajouter.',
      ...
      signInLine: 'Connectez-vous à Nunmai pour utiliser les applications gérées.',
      signIn: 'Se connecter',
      ...
      disconnectNoAccount: 'Nunmai n’a aucun compte à déconnecter ici. Actualisez la page et réessayez.',
      disconnectRefused:
        'Nunmai ne peut pas supprimer cette connexion pour le moment. Désactivez plutôt l’application avec l’interrupteur, ou réessayez plus tard.'
    },
    add: {
    ...
    dialog: {
      ...
      disconnectBody: "Nunmai cesse d'agir avec ce compte. Vous pouvez vous reconnecter à tout moment.",
      ...
      appSwitch: (name: string) => `Nunmai peut utiliser ${name}`,
      ...
      wayHosted: 'Géré',
      bothOn: (name: string) => `Les deux sont activés : Nunmai voit donc chaque outil ${name} en double.`,
      ...
      nousLine: 'Les applications Nunmai suivent votre compte, pas le profil.',
      ...
      rulesSignIn: 'Connectez-vous pour modifier ce que Nunmai peut faire ici.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Ce que Nunmai peut faire avec ${name}`,
      summaryPreviewTitle: (name: string) => `Ce que Nunmai pourra faire avec ${name} une fois connecté`,
      ...
      goneBody: "Nunmai ne peut plus l'appeler. La ligne reste jusqu'à ce que vous la supprimiez : rien ne disparaît.",
      remove: 'Supprimer',
      ...
      signedOutTitle: 'Connectez-vous à Nunmai pour lire la liste des outils.',
  ...
  sessionImport: {
    ...
    subtitle: 'Importez une conversation dans Nunmai et reprenez là où vous en étiez.',
    ...
    chooseHelp: "Choisissez une session pour lire son historique avant de l'importer dans Nunmai.",
    ...
    you: 'Vous',
    snapshot: 'Cette conversation est déjà dans Nunmai. Ouvrez votre copie existante pour continuer.',
    copyNotice:
    ...
    open: 'Ouvrir dans Nunmai',
    continue: 'Continuer dans Nunmai',
  ...
  boot: {
    ready: 'Nunmai Desktop est prêt',
    desktopBootFailedWithMessage: message => `Échec du démarrage : ${message}`,
    steps: {
      connectingGateway: 'Connexion au gateway desktop',
      loadingSettings: 'Chargement des paramètres Nunmai',
      loadingSessions: 'Chargement des sessions récentes',
      retryingRemoteBackend: 'Reconnexion au backend Nunmai distant…',
      startingDesktopConnection: 'Démarrage de la connexion desktop',
      startingNunmaiDesktop: 'Démarrage de Nunmai Desktop…'
    },
    errors: {
      backgroundExited: "Le processus en arrière-plan de Nunmai s'est arrêté.",
      backgroundExitedDuringStartup: "Le processus en arrière-plan de Nunmai s'est arrêté pendant le démarrage.",
      backendStopped: 'Backend arrêté',
      restartNunmai: 'Redémarrer Nunmai',
      openLogs: 'Ouvrir les journaux',
    ...
    causes: {
      exitedEarly: "Le service en arrière-plan de Nunmai s'est arrêté juste après son démarrage.",
      timedOut: "Le service en arrière-plan de Nunmai n'a pas répondu à temps.",
      permission: "Nunmai n'a pas pu écrire dans son dossier de données (problème d'autorisation).",
      diskFull: "Le disque est plein ; Nunmai n'a donc pas pu démarrer.",
      portInUse: 'Un autre programme utilise le port réseau nécessaire à Nunmai.',
      installMissing:
        "Une partie de l'installation de Nunmai est manquante. Choisissez Réparer l'installation pour la restaurer."
    },
    failure: {
      title: "Nunmai n'a pas pu démarrer",
      description:
      ...
      cloudDownTitle: "L'agent Nunmai Cloud est indisponible",
      cloudDownDescription:
        "L'agent cloud géré par Nunmai auquel ce gateway se connecte renvoie une erreur serveur. Il ne peut pas être redémarré depuis ici — vérifiez son état, passez au gateway local ou contactez l'assistance.",
      cloudDownHint:
        "Les boutons ci-dessous ouvrent le portail Nunmai, pour consulter et contrôler l'instance, ainsi que notre Discord pour obtenir de l'aide.",
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Votre backend Nunmai est plus ancien que cette version du desktop et peut ne pas fonctionner correctement. Mettez-le à jour pour les aligner.',
    installMethodUnsupportedTitle: "Méthode d'installation non prise en charge",
    updateNunmai: 'Mettre à jour Nunmai',
    ...
    errors: {
      ...
      storageFailure:
        "Nunmai n'a pas pu enregistrer dans son dossier de données. Ouvrez Maintenance pour le vérifier et le réparer.",
      gatewayAuthFailed: "Échec de l'authentification du gateway — vérifiez API_SERVER_KEY.",
      methodNotAllowed:
        'Le backend du desktop a rejeté cette requête (405 Method Not Allowed). Essayez de redémarrer Nunmai Desktop.',
      ...
      restartNunmaiFailed: 'Impossible de redémarrer Nunmai'
    },
    actions: {
      restartNunmai: 'Redémarrer Nunmai',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Impossible de transmettre la demande à Nunmai',
    ...
    native: {
      ...
      inputBody: 'Nunmai attend votre réponse.',
      turnDoneTitle: 'Nunmai a terminé',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleNous: 'Plus de crédits Nunmai',
  ...
  sendDiagnostics: {
    title: 'Envoyer les diagnostics à Nunmai',
    privacyNotice:
      "Cela téléverse un paquet de débogage vers un stockage interne de Nunmai, et non vers un service de partage public. Il contient des informations système (système d'exploitation, versions, fournisseur et clés API configurées — jamais les clés elles-mêmes) ainsi que les journaux complets de l'agent, du gateway et du Desktop (jusqu'à 512 Ko chacun), susceptibles de contenir des conversations, des résultats d'outils et des chemins de fichiers. Les secrets sont expurgés avant l'envoi. Seuls le personnel de Nunmai et les modérateurs Discord autorisés peuvent consulter le paquet, qui est automatiquement supprimé après 14 jours.",
    upload: 'Envoyer',
    ...
    failedHint:
      'Vous pouvez également exécuter `nunmai debug share --nous` dans un terminal, ou `nunmai debug share --local` pour afficher le rapport sans le téléverser.',
    handoffLead: 'Poursuivez la discussion sur :',
    links: {
      github: 'Issues GitHub',
      portal: 'Assistance du portail Nunmai',
      discord: 'Discord'
    }
  },
  titlebar: {
  ...
  settings: {
    ...
    resetConfirm: 'Réinitialiser tous les paramètres aux valeurs par défaut de Nunmai ?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Entrée « ${name} » du catalogue Nunmai — le composant agent sera installé depuis le commit vérifié${sha ? ` ${sha}` : ''}, et non depuis la tête de branche.`,
    ...
    vault: {
      ...
      otpHint:
        "La « clé d'installation » que le site affiche lorsque vous activez 2FA. Avec elle enregistrée, Nunmai génère lui-même les codes.",
      ...
      sources: {
        ...
        notInstalled: name =>
          `Non détecté. Installez l’outil en ligne de commande ${name} et connectez-vous ; Nunmai le repère automatiquement.`,
        disabledDesc: 'Détecté mais désactivé pour Nunmai.',
        lockedDesc:
          "Détecté. L'agent vous demandera de le déverrouiller lorsqu'il en a besoin, ou déverrouillez maintenant.",
        unlockedDesc:
          "Déverrouillé pour cette session. Se verrouille automatiquement après 30 minutes d'inactivité ou lorsque Nunmai se ferme.",
    ...
    notifications: {
      ...
      focusedHint: 'Les alertes de fin ne se déclenchent que quand Nunmai est en arrière-plan.',
      kinds: {
        approval: {
        ...
        input: {
          ...
          description: "Nunmai a posé une question ou a besoin d'un mot de passe ou d'un secret."
        },
        turnDone: {
          label: 'Réponse prête',
          description: "Un tour s'est terminé pendant que Nunmai était en arrière-plan."
        },
        turnError: {
          label: 'Échec du tour',
        ...
        plugin: {
          ...
          description: 'Un plugin desktop a envoyé une notification pendant que Nunmai était en arrière-plan.'
        }
      },
    ...
    searchPlaceholder: {
      about: 'À propos de Nunmai Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Choisissez un mode fixe ou laissez Nunmai suivre le paramètre système.',
      ...
      reactionsDesc: 'Réactions emoji façon iMessage — réagissez aux messages, et Nunmai peut réagir aux vôtres.',
      tipsTitle: "Astuces dans l'application",
      tipsDesc:
        "Une petite bulle désigne occasionnellement une partie de l'application lorsque vous êtes inactif ou lorsque Nunmai peut vous aider. Fermer une astuce la masque définitivement.",
      tipsReset: (count: number) =>
        `Réafficher ${count} astuce${count === 1 ? '' : 's'} fermée${count === 1 ? '' : 's'}`,
      toursTitle: 'Visites guidées',
      toursDesc:
        "Laissez Nunmai vous guider dans l'application en assombrissant l'écran et en mettant chaque étape en évidence.",
      ...
      pet: {
        ...
        intro:
          "Adoptez une mascotte petdex animée qui flotte au-dessus de l'application et réagit aux actions de Nunmai — court pendant l'exécution des outils, fête les réussites, boude les erreurs.",
        restartHint:
          "Les animaux de compagnie nécessitent un redémarrage rapide — l'application en cours a démarré avant l'ajout de cette fonctionnalité. Fermez et rouvrez Nunmai, puis revenez ici.",
        scaleTitle: 'Taille',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Nombre maximal de caractères que Nunmai peut lire dans une demande de fichier.',
      approvals: {
        mode: 'Comment Nunmai gère les commandes nécessitant une approbation explicite.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained : reconnaissance vocale → Nunmai → synthèse vocale avec les fournisseurs ci-dessous. gpt-live : un modèle vocal OpenAI full-duplex (gpt-live-1) écoute et parle, et confie chaque vraie demande à Nunmai — le modèle que vous avez sélectionné répond avec l’ensemble des outils. Nécessite une clé API OpenAI ; la couche vocale est facturée 0,05 $ par minute.',
        gptLive: {
          voice: 'Voix du mode GPT-Live. Les identifiants de voix personnalisés sont acceptés.',
          instructions:
            'Phrases supplémentaires pour la personnalité vocale en direct (ton, rythme, langue). Nunmai conserve son propre prompt système.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          "Quand Nunmai se met à jour depuis l'application (sans invite de terminal), conserve les modifications locales (stash) ou les abandonne (discard). Les mises à jour via le terminal demandent toujours confirmation."
      }
    }),
    uninstallSection: {
      dangerZone: 'Zone dangereuse',
      checkingInstalled: 'Vérification des éléments installés…',
      uninstallNunmai: 'Désinstaller Nunmai',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description:
            'Supprime cette application de bureau. L’agent Nunmai, votre configuration et vos conversations sont conservés.',
        ...
        lite: {
          ...
          description:
            'Supprime l’application et l’agent Nunmai, mais conserve la configuration, les conversations et les secrets pour une future réinstallation.',
          consequence:
            'l’interface de chat et l’agent Nunmai (la configuration, les conversations et les secrets sont conservés)'
        },
        full: {
          ...
          consequence:
            'TOUT — l’interface de chat, l’agent Nunmai et l’ensemble de votre configuration, de vos conversations, secrets et journaux'
        }
      }
    },
    poolLimits: {
    ...
    about: {
      ...
      automaticUpdatesDesc:
        "Nunmai vérifie automatiquement les mises à jour en arrière-plan et vous informe quand l'une est prête.",
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Réduire les fenêtres ou fermer la fenêtre principale les masque dans la zone de notification (barre des menus sur macOS) et Nunmai continue de s’exécuter. Utilisez Quitter Nunmai dans le menu de la zone de notification ou Cmd+Q pour quitter. Désactivé par défaut ; s’applique uniquement à cet appareil.',
      ...
      loading: 'Chargement de la configuration Nunmai...',
    ...
    hudModifier: {
      ...
      permission:
        'Autorisez Nunmai dans Réglages Système → Confidentialité et sécurité → Surveillance de l’entrée, puis réessayez. Ce geste n’enregistre pas les frappes et ne capture pas votre écran.',
      unavailable:
        'L’assistant du geste HUD n’a pas pu démarrer ou s’est arrêté de manière inattendue. Réessayez ou redémarrez Nunmai. Le raccourci HUD existant fonctionne toujours dans Nunmai.',
      missingHelper:
        'Il manque l’assistant du geste HUD dans cette installation de Nunmai. Mettez à jour ou réinstallez Nunmai, puis réessayez.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        "Appuyez simultanément sur les deux touches Commande depuis n'importe quelle application pour capturer sa fenêtre au premier plan et la joindre au brouillon Nunmai actuel. Rien n'est envoyé automatiquement. Désactivé par défaut et limité à ce Mac. Le contenu peut être sensible : vérifiez la pièce jointe avant l'envoi.",
      ...
      inputPermission:
        "L'autorisation Surveillance de l'entrée permet à Nunmai de détecter les deux touches Commande lorsqu'une autre application est active. Autorisez Nunmai dans Réglages Système → Confidentialité et sécurité → Surveillance de l'entrée, puis réessayez.",
      screenPermission:
        "L'autorisation Enregistrement de l'écran permet à Nunmai de capturer la fenêtre au premier plan. Autorisez Nunmai dans Réglages Système → Confidentialité et sécurité → Enregistrement de l'écran, puis réessayez. Redémarrez Nunmai si macOS le demande.",
    ...
    quickEntry: {
      ...
      enabledDesc:
        "Faites apparaître un petit compositeur depuis n'importe où avec un raccourci global et envoyez une invite sans ouvrir Nunmai.",
    ...
    connections: {
      title: 'Connexions',
      intro:
        'Enregistrez tous les emplacements où vivent vos agents : cet appareil, les gateways distantes de votre réseau et les instances Nunmai Cloud. Ils sont tous conservés ici.',
      stagedNote:
      ...
      updateSkippedCloud: 'Gérée par Nunmai Cloud',
      kindLocal: 'Locale',
      kindRemote: 'Gateway distante',
      kindCloud: 'Nunmai Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: "L'environnement Nunmai géré par cette application.",
      kindRemoteDesc: 'Une gateway Nunmai accessible en HTTP(S), par le LAN, Tailscale ou Internet.',
      kindCloudDesc: 'Une instance hébergée découverte via votre compte Nunmai Cloud.',
      kindSshDesc: 'Une installation Nunmai accessible en SSH.',
      labelTitle: 'Nom',
      labelDesc:
      ...
      headersDesc:
        "Envoyés avec chaque requête HTTP et WebSocket vers ce gateway, notamment pour les proxys d'accès comme Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Les valeurs sont stockées chiffrées. Les en-têtes gérés par Nunmai (Authorization, Cookie, Host…) sont ignorés.",
      ...
      cloudAddHint:
        "Astuce : connectez-vous à Nunmai Cloud ci-dessus pour découvrir automatiquement vos agents — utilisez ce formulaire uniquement pour enregistrer manuellement l'URL d'une instance connue.",
    ...
    gateway: {
      ...
      intro:
        'Local par défaut. Utilisez distant quand cette application doit piloter un backend Nunmai ailleurs. Remplacements par profil ci-dessous.',
      envOverrideTitle: "Des variables d'environnement contrôlent cette session desktop.",
      envOverrideDesc:
        'Supprimez les variables NUNMAI_DESKTOP_REMOTE_URL et NUNMAI_DESKTOP_REMOTE_TOKEN pour utiliser le paramètre enregistré ci-dessous.',
      modeTitle: 'Mode de connexion',
      localTitle: 'Gateway local',
      localDesc:
        "Démarrer un backend Nunmai privé sur localhost. C'est la valeur par défaut et cela fonctionne hors ligne.",
      remoteTitle: 'Gateway distant',
      remoteDesc: 'Connecter ce shell desktop à un backend Nunmai distant.',
      remoteAuthHint:
      ...
      cloudDesc:
        "Connectez-vous une fois à Nunmai Cloud et choisissez parmi les agents de votre compte — pas d'URL à coller.",
      cloudSignInTitle: 'Nunmai Cloud',
      cloudSignIn: 'Se connecter à Nunmai Cloud',
      cloudSignedIn: 'Connecté à Nunmai Cloud',
      cloudNeedsSignIn: 'Connectez-vous à Nunmai Cloud pour découvrir les agents de votre compte.',
      cloudSignedInDesc:
      ...
      cloudDiscoverFailed: 'Impossible de charger vos agents Nunmai Cloud',
      cloudConnectFailed: 'Impossible de se connecter à cet agent',
      cloudSignInFailed: 'Échec de la connexion à Nunmai Cloud',
      cloudSignedOutTitle: 'Déconnecté de Nunmai Cloud',
      cloudSignedOutMessage: 'Session Nunmai Cloud effacée.',
      ...
      remoteUrlDesc:
        'URL de base du backend de tableau de bord distant. Les préfixes de chemin sont pris en charge, par exemple /nunmai.',
      ...
      restartingMessage: 'Nunmai Desktop va se reconnecter avec les paramètres enregistrés — le shell reste ouvert.',
      savedMessage: 'Enregistré pour le prochain redémarrage.',
      connectedTo: (baseUrl, version) => `Connecté à ${baseUrl}${version ? ` · Nunmai ${version}` : ''}`,
      ...
      sshDesc:
        "Nunmai est lancé sur la machine distante via SSH et acheminé vers cette application — rien à démarrer ou exposer soi-même. Nécessite un accès SSH par clé fonctionnel vers l'hôte.",
      sshTrustHint:
      ...
      sshNunmaiPathTitle: 'Chemin Nunmai (facultatif)',
      sshNunmaiPathDesc: 'Chemin complet vers le binaire nunmai distant. Vide = détection automatique.',
      sshNunmaiPathPlaceholder: 'détection automatique',
      ...
      sshReachable: (host, platform) => `Accessible : ${host} (${platform}) — Nunmai trouvé`,
      ...
      sshErrAuth:
        "Échec de l'authentification SSH. Chargez votre clé dans ssh-agent (ssh-add) ou définissez un IdentityFile dans ~/.ssh/config — Nunmai exécute ssh de manière non interactive.",
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        "Nunmai n'est pas installé sur l'hôte distant. Installez-le là-bas (curl -fsSL https://nunmai-engine.nunmai.in/install.sh | sh) ou définissez le chemin Nunmai.",
      sshErrPlatform:
        'Plateforme distante non prise en charge. Le mode SSH de Nunmai Desktop supporte les hôtes distants Linux, macOS et Windows.',
      sshErrTimeout: "Expiration de la connexion SSH. L'hôte peut être inaccessible ou en veille.",
      sshErrUpdateRequired: "Mettez à jour Nunmai sur l'hôte distant avant de vous connecter avec Desktop SSH.",
    ...
    mcp: {
      ...
      deepLinkDescription:
        "Un lien demande d'ajouter ce serveur MCP à Nunmai. Vérifiez attentivement la configuration ci-dessous : elle provient du lien, pas de Nunmai.",
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, backend ${backend}. Nunmai démarre et gère le serveur pour vous.`,
      ...
      upToDateDetail: (tag, backend) =>
        `llama.cpp ${tag} (${backend}) est en cours d'exécution : il s'agit de la dernière build fournie par Nunmai.`,
      activeDetail:
    ...
    billing: {
      ...
      freeTier: {
        signIn: 'Se connecter',
        title: 'Vous utilisez l’offre gratuite Nunmai',
        message: 'Connectez-vous avec un compte Nunmai pour débloquer davantage de modèles et d’outils.',
        caption:
      ...
      state: {
        notice: {
          loggedOut: {
            title: 'Connectez votre compte Nunmai',
            message:
              'Connectez-vous avec votre compte Nunmai pour voir ici votre solde, votre offre et votre utilisation.',
            action: 'Se connecter'
          },
          openPortal: 'Ouvrir le portail ↗',
          noCard: {
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'Les dépenses à distance sont désactivées pour ce compte — un administrateur de facturation peut les activer depuis la page Nunmai Engine du portail.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        "Connectez-vous avec un abonnement — pas de clé API à copier. Nunmai lance la connexion navigateur pour vous, directement dans l'application.",
      connected: 'Connecté',
      collapse: 'Réduire',
      ...
      localEndpoint: {
        ...
        description:
          "Pointez Nunmai vers n'importe quel point de terminaison compatible OpenAI (Zyphra, vLLM, llama.cpp, Ollama, etc)."
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Inclus avec un abonnement Nunmai — connectez-vous au portail Nunmai pour activer.',
      nousAuthNeededTitle: 'Se connecter au portail Nunmai',
      ...
      nousAuthDoneTitle: 'Portail Nunmai connecté',
      nousAuthDoneMessage: "Vos backends d'abonnement sont maintenant actifs.",
      nousAuthFailed: "La connexion au portail Nunmai n'a pas été terminée",
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Nunmai ne peut pas exécuter de commandes shell pour le moment : ${backend} n'est pas prêt. Passez en Local ou terminez la configuration de ${backend}, puis réessayez.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: "Autorisez Nunmai à naviguer avec un instantané de votre profil de navigateur par défaut afin que les sites s'ouvrent avec vos sessions déjà connectées.",
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restaurable via nunmai curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Nunmai (par défaut)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'Ce backend est trop ancien pour gérer les plugins depuis cet écran ; mettez Nunmai à jour.',
      ...
      catalogProvenance: (sha: string) =>
        `Installé depuis le catalogue Nunmai${sha ? ` au commit épinglé ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u00AB\u00A0${name}\u00A0\u00BB ne figure pas dans le catalogue de plugins Nunmai. Rien n’a été installé.`,
      deepLinkCatalogUnavailable:
        'Impossible de charger le catalogue de plugins Nunmai. Vérifiez votre connexion et rouvrez le lien.',
  ...
  starmap: {
    ...
    emptyDesc:
      'Au fur et à mesure que Nunmai construit des skills et des mémoires pour votre travail, ils apparaissent ici.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Redémarrez Nunmai pour utiliser les animaux — le backend précède cette fonctionnalité.',
    ...
    generatePet: {
      ...
      staleBackend: 'Mettez à jour Nunmai pour générer des animaux…',
      backgroundHint: "Vous pouvez fermer — Nunmai vous notifiera quand c'est terminé.",
    ...
    nav: {
      ...
      settings: {
        title: 'Paramètres',
        detail: 'Configurer Nunmai Desktop'
      },
      capabilities: {
        title: 'Capacités',
    ...
    nunmaiActiveSessions: (version, count) => `Nunmai ${version} · Sessions actives ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle:
        "Les deux méthodes connectent un bot que vous contrôlez et enregistrent ses identifiants uniquement dans cette installation d'Nunmai.",
      quickSetup: 'Configuration rapide',
      recommended: 'Recommandé',
      quickHelp:
        "Scannez un code QR et confirmez dans Telegram. Nunmai crée le bot et détecte automatiquement votre identifiant d'utilisateur Telegram.",
  ...
  profiles: {
    ...
    connectGateway: 'Connecter un autre gateway Nunmai…',
    fleet: {
    ...
    remoteOverride: {
      ...
      description:
        "Les sessions de ce profil s'exécuteront sur le système Nunmai distant indiqué, plutôt que sur cet ordinateur.",
      urlLabel: 'Adresse distante',
      urlPlaceholder: 'https://nunmai.exemple.fr',
    ...
    defaultDescription:
      "Utilisé à l'ouverture de Nunmai et pour les nouvelles conversations. Les sessions existantes restent dans leur profil.",
    ...
    deleting: 'Suppression...',
    createDesc: 'Les profils sont des environnements Nunmai indépendants : configuration, skills et SOUL.md séparés.',
    nameLabel: 'Nom',
  ...
  modelAssignment: {
    saveFailed: 'Nunmai n’a pas enregistré ce changement de modèle.',
  ...
  cron: {
    ...
    emptyDescNew:
      "Planifiez une invite à exécuter selon une expression cron. Nunmai l'exécutera et livrera les résultats vers la destination de votre choix.",
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Nunmai ne peut pas lire tout l’historique des sessions de ${profiles}. Les conversations absentes de cette liste n’ont pas été supprimées ; le fichier qui les contient est endommagé.`,
      action: 'Quittez Nunmai sur ce profil, puis inspectez le fichier sans le modifier, ou restaurez un instantané :',
    ...
    projects: {
      ...
      staleBackend:
        'Mettez à jour le backend Nunmai pour créer des projets — votre backend est plus ancien que cette application de bureau (Paramètres → Mises à jour → Backend).',
      deleteConfirm:
        'Cela supprime le projet enregistré de Nunmai. Les fichiers, dépôts git et worktrees restent inchangés.',
      ...
      worktreeStaleBackend:
        'Mettez à jour le backend Nunmai pour créer des worktrees depuis Desktop — votre backend est plus ancien que cette application (Paramètres → Mises à jour → Backend).',
  ...
  composer: {
    ...
    placeholderStarting: 'Démarrage de Nunmai…',
    placeholderReconnecting: 'Reconnexion à Nunmai…',
    placeholderFollowUp: 'Envoyer un suivi',
    newSessionPlaceholders: [
      'Sur quoi travaillons-nous ?',
      'Donnez une tâche à Nunmai',
    ...
    voiceEngineChained: 'Reconnaissance vocale + voix Nunmai',
    voiceEngineLive: 'GPT-Live (duplex intégral, délègue à Nunmai)',
    ...
    commandDescs: {
      ...
      '/goal':
        'Définir un objectif permanent sur lequel Nunmai travaille au fil des tours jusqu’à ce qu’il soit atteint',
      ...
      '/plan': 'Écrire un plan d’implémentation markdown dans .nunmai/plans/ sans rien exécuter',
      '/moa': 'Exécuter un prompt avec le préréglage Nunmai Agent par défaut, puis restaurer votre modèle',
      ...
      '/profile': 'Changer de profil Nunmai actif',
      ...
      '/subscription': 'Voir votre forfait Nunmai et le modifier dans le navigateur',
      '/topup': 'Afficher votre solde Nunmai et gérer la facturation sur le portail',
      '/platform': 'Suspendre, reprendre ou lister une plateforme de gateway en échec',
      '/version': 'Afficher la version de Nunmai Engine',
    ...
    attachUrlDesc: "Nunmai récupérera la page et l'inclura comme contexte pour ce tour.",
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: "Demander à Nunmai d'ouvrir une PR",
  ...
  updates: {
    stages: {
      ...
      pull: 'Presque prêt…',
      pydeps: 'Finalisation…',
      update: 'Mise à jour de Nunmai…',
      rebuild: "Reconstruction de l'application de bureau…",
      restart: 'Redémarrage de Nunmai…',
    ...
    unsupportedMessage: "Cette version de Nunmai ne peut pas se mettre à jour depuis l'application.",
    connectionRetry: 'Vérifiez votre connexion et réessayez.',
    gitUnusable: 'Nunmai n’a pas pu exécuter Git sur cet ordinateur et n’a donc pas pu rechercher de mises à jour.',
    connectionSettings: 'Paramètres de connexion',
    ...
    availableBody: 'Une nouvelle version de Nunmai est prête à être installée.',
    availableTitleBackend: 'Mise à jour du backend disponible',
    availableBodyBackend: 'Une version plus récente du backend Nunmai connecté est prête à être installée.',
    ...
    manualBody:
      "Vous avez installé Nunmai depuis la ligne de commande, les mises à jour s'y effectuent donc aussi. Collez ceci dans votre terminal :",
    manualPickedUp: 'Nunmai prendra en compte la nouvelle version au prochain lancement.',
    guiSkewTitle: "Mettre à jour l'application de bureau",
    guiSkewBody:
      "Le backend a été mis à jour, mais ce package d'application de bureau ne l'a pas été. Mettez à jour ou réinstallez l'application de bureau Nunmai (votre AppImage / .deb / .rpm) pour qu'elle corresponde.",
    copy: 'Copier',
    copied: 'Copié',
    done: 'Terminé',
    applyingBody:
      'Le programme de mise à jour de Nunmai prend le relais dans sa propre fenêtre et rouvre Nunmai automatiquement une fois terminé. Ne rouvrez pas Nunmai vous-même pendant la mise à jour.',
    applyingBodyBackend:
      'Le backend distant applique la mise à jour et va redémarrer. Nunmai se reconnecte automatiquement à son retour.',
    applyingClose: 'Cette fenêtre se fermera pendant la mise à jour, puis Nunmai se rouvre seul.',
    errorTitle: 'Mise à jour non terminée',
    errorBody: "Pas de souci — rien n'a été perdu. Vous pouvez réessayer maintenant.",
    blockerTitle: 'Fermer les aperçus locaux pour mettre à jour Nunmai ?',
    blockerBody:
      'Nunmai doit arrêter ces aperçus locaux avant la mise à jour. Aucun de vos fichiers ne sera modifié ni supprimé.',
    foreignBlockerTitle: 'Fermez les autres processus pour mettre à jour Nunmai',
    foreignBlockerBody:
      "Nunmai ne peut pas fermer automatiquement ces processus en toute sécurité. Fermez l'application, le terminal ou le service qui possède chacun d'eux, puis relancez la mise à jour.",
    mixedBlockerBody:
      'Nunmai peut fermer les aperçus locaux ci-dessous. Les autres processus doivent être fermés manuellement avant de poursuivre la mise à jour.',
  ...
  handoffTour: {
    ...
    stayTitle: "Nunmai reste à portée d'un clic",
    stayText:
      'Passez au profil de configuration et ouvrez Bienvenue dans Nunmai lorsque vous avez besoin d’aide. La conversation y reste disponible.'
  },
  guidedGreeting: {
    line: "Salut, entrez ! Je suis Nunmai. Donnez-moi deux minutes pour préparer les lieux à votre façon, puis nous nous attaquerons à quelque chose que vous voulez vraiment accomplir.\n\nMais d'abord, comment dois-je vous appeler ?",
  ...
  install: {
    ...
    oneTimeTitle: 'Nunmai nécessite une installation unique',
    ...
    setupChoiceTitle: 'Configurer Nunmai Desktop',
    setupChoiceDesc:
      'Connectez cette application à un gateway Nunmai que vous exécutez déjà, ou installez Nunmai localement sur cet ordinateur.',
    connectExistingTitle: 'Se connecter à un Nunmai existant',
    ...
    installLocalTitle: 'Installer Nunmai localement',
    installLocalDesc: 'Téléchargez Nunmai, créez son environnement Python et exécutez le backend sur cet ordinateur.',
    localStartUnavailable: "L'installation locale n'a pas pu démarrer. Redémarrez Nunmai Desktop et réessayez.",
    remoteSetupTitle: 'Se connecter à un Nunmai existant',
    remoteSetupDesc:
      "Entrez l'URL du gateway. Nunmai Desktop détectera s'il a besoin d'un jeton ou d'une connexion par navigateur.",
    remoteUrlTitle: 'URL du gateway',
    remoteUrlDesc: "Utilisez l'URL de base du gateway Nunmai, y compris https:// pour les connexions distantes.",
    remoteUrlPlaceholder: 'https://gateway.example.com/nunmai',
    probing: "Détection de l'authentification du gateway...",
    probeError: "Impossible d'atteindre ce gateway Nunmai.",
    ...
    settingUpTitle: 'Configuration de Nunmai Engine',
    finishingTitle: 'Finalisation',
    failedDesc:
      "L'une des étapes d'installation a échoué. Sous Windows, cela peut arriver si une autre instance Nunmai CLI ou desktop est en cours d'exécution. Arrêtez toutes les instances Nunmai en cours, puis réessayez. Consultez les détails ci-dessous ou le journal du bureau pour la transcription complète.",
    activeDesc:
      "Il s'agit d'une configuration unique. Le programme d'installation de Nunmai télécharge les dépendances et configure votre machine. Les lancements suivants ignoreront cette étape.",
  ...
  onboarding: {
    headerTitle: 'Configurons Nunmai Engine pour vous',
    headerDesc:
      'Connectez un fournisseur de modèles pour commencer à discuter. La plupart des options nécessitent un clic.',
    preparingInstall:
      "Nunmai finalise l'installation. Cela prend généralement moins d'une minute au premier lancement.",
    starting: 'Démarrage de Nunmai…',
    ...
    recommended: 'Recommandé',
    connected: 'Connecté',
    featuredPitch: 'Un abonnement, 300+ modèles de pointe — la méthode recommandée pour exécuter Nunmai',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'auto-hébergé',
        description:
          'Pointez Nunmai vers un point de terminaison local ou auto-hébergé compatible OpenAI (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Ouvre une page de vérification dans votre navigateur — Nunmai se connecte automatiquement',
    ...
    signInWith: provider => `Se connecter avec ${provider}`,
    openedBrowser: provider => `Nunmai avons ouvert ${provider} dans votre navigateur.`,
    authorizeThere: 'Autorisez Nunmai là-bas.',
    ...
    autoBrowser: provider =>
      `Nunmai avons ouvert ${provider} dans votre navigateur. Autorisez Nunmai là-bas et vous serez connecté automatiquement — rien à copier ou coller.`,
    ...
    deviceCodeOpened: provider => `Nunmai avons ouvert ${provider} dans votre navigateur. Entrez ce code là-bas :`,
  ...
  freeTier: {
    providerRowTitle: 'Nunmai · offre gratuite',
    providerRowPitch: 'Connectez-vous avec un compte Nunmai pour débloquer davantage de modèles et outils.',
    readyTitle: 'Nunmai est prêt.',
    readyCaption: 'Gratuit · connecteurs inclus',
    begin: 'Commencer',
    signInInstead: 'Se connecter plutôt avec un compte Nunmai',
    otherProviders: 'Autres fournisseurs',
    stripTitle: "L'inférence Nunmai gratuite et les connecteurs sont maintenant disponibles.",
    ...
    dismiss: 'Fermer',
    providerName: 'Nunmai',
    statusLabel: model => `Nunmai · ${model}`,
    signIn: 'Se connecter',
    signInHeading: 'Connectez-vous avec un compte Nunmai pour débloquer davantage de modèles et outils.',
    ...
    busyBody: wait =>
      `Nunmai n'a pas pu terminer votre connexion car le service Nunmai est occupé. Réessayez dans ${wait}. Votre session reste disponible entre-temps.`,
    unreachableBody:
      "Nunmai n'a pas pu joindre le service Nunmai pour terminer votre connexion. Vérifiez votre connexion Internet et réessayez. Votre session reste disponible.",
    alreadySignedInHeading: 'Déjà connecté.',
    alreadySignedInBody: 'Cette installation Nunmai est déjà connectée à un compte Nous.',
    setupFailed: {
      gateClosed:
        'Cette version de Nunmai ne peut pas démarrer sans compte Nunmai. Connectez-vous ou créez-en un gratuitement en une minute.',
      paused:
        "L'utilisation de Nunmai sans connexion est momentanément suspendue. Nunmai continuera à vérifier. La connexion est gratuite et vous permet de continuer immédiatement.",
      rateLimited: wait =>
        `Beaucoup de personnes démarrent en ce moment ; Nunmai réessaiera dans ${wait}. La connexion est gratuite et évite l'attente.`,
      unreachable:
        "Nunmai n'a pas pu joindre le service Nunmai. Vérifiez votre connexion Internet, puis appuyez sur Réessayer. Vous pouvez aussi connecter un autre fournisseur.",
      serverError:
        'Le service Nunmai a rencontré un problème. Réessayez dans un instant ou connectez un autre fournisseur.',
      powRequired:
        "Le serveur Nunmai a demandé une preuve de travail qui n'est pas encore gérée par votre Agent. Connectez-vous ou créez un compte Nunmai gratuit pour continuer.",
      locked:
        'Cette session ne peut pas continuer sans connexion. Connectez-vous ou créez un compte Nunmai gratuit pour poursuivre.',
      generic:
        "Nunmai n'a pas pu configurer l'accès gratuit sans connexion. Connectez-vous gratuitement ou choisissez un autre fournisseur.",
      signInBelow: 'La connexion est gratuite. Choisissez Nunmai ci-dessous.',
      tryAgain: 'Réessayer',
      retrying: 'Nouvelle tentative…'
    }
  },
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} fait ${size}. Nunmai n'affichera que les 512 Ko premiers.`,
    ...
    web: {
      ...
      tryAgain: 'Réessayer',
      restarting: 'Nunmai redémarre...',
      askRestart: 'Demander à Nunmai de redémarrer le serveur',
      lookingRestart: taskId => `Nunmai recherche un serveur d'aperçu à redémarrer (${taskId})`,
      restartingTitle: "Redémarrage du serveur d'aperçu",
      restartingMessage: "Nunmai travaille en arrière-plan. Surveillez la console d'aperçu pour suivre la progression.",
      ...
      blankPageBody: "Saisissez une adresse ci-dessus pour naviguer, ou demandez à Nunmai d'ouvrir une page.",
      finishedRestarting: message =>
        `Nunmai a terminé le redémarrage du serveur d'aperçu${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: "Nunmai n'a pas pu redémarrer le serveur.",
      stillWorking:
        "Nunmai travaille toujours, mais aucun résultat de redémarrage n'est arrivé. La commande du serveur peut être en cours d'exécution au premier plan.",
  ...
  interfaceMode: {
    ...
    hint: 'Modifie ce qui est affiché, pas ce que Nunmai peut faire.',
    sessionNote:
      'Défini par le mode Simple. Une modification ici dure le temps de cette session ; passez en mode Avancé pour la conserver.',
    simple: {
      label: 'Simple',
      description:
        'Pour discuter avec Nunmai. Barre latérale et conversation ; pas de panneaux terminal, fichiers ou diff.'
    },
    advanced: {
      label: 'Avancé',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nunmai charge une réponse',
      ...
      errorLayerBodies: {
        ...
        disk: "Votre disque est plein ; Nunmai n'a pas pu enregistrer cette conversation. Libérez de l'espace, puis réessayez.",
        endpoint:
          "Nunmai ne parvient pas à joindre votre serveur de modèle personnalisé. Vérifiez qu'il fonctionne, puis renvoyez votre message.",
        gateway:
          'Nunmai a rencontré un problème interne au démarrage de cette réponse. Renvoyez votre message ; si cela persiste, envoyez les diagnostics.',
        generic:
          "Une erreur s'est produite pendant la réponse de Nunmai. Réessayez ou copiez les détails si cela persiste.",
        provider:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Nunmai n'a pas pu vérifier la connexion sécurisée à ${provider}. Vérifiez votre réseau ou votre proxy, ou changez de fournisseur.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} a renvoyé une réponse que Nunmai n'a pas pu lire. Réessayez dans un instant.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Nunmai est resté bloqué dans une boucle',
          body: 'La réponse répétait les mêmes étapes ; Nunmai l’a donc arrêtée. Réessayez ou démarrez une nouvelle conversation.'
        },
        SESSION_NOT_OWNED: {
          title: 'Cette conversation est ouverte ailleurs',
          body: 'Cette conversation est déjà ouverte dans une autre fenêtre Nunmai ou un terminal. Fermez-la là-bas puis réessayez, ou démarrez-en une nouvelle ici.'
        },
        disk_full: {
          title: 'Disque plein',
          body: "Votre disque est plein ; Nunmai n'a pas pu enregistrer cette conversation. Libérez de l'espace puis réessayez."
        },
        free_tier_disabled: {
          title: "L'utilisation de Nunmai sans connexion est désactivée pour le moment",
          body: 'Connectez-vous avec un compte Nunmai gratuit pour continuer.'
        },
        free_tier_rate_limited: {
          title: 'Vous avez épuisé le quota sans connexion',
          body: 'Il sera bientôt renouvelé. Connectez-vous avec un compte Nunmai gratuit pour obtenir un quota plus élevé.'
        },
        ...
        free_tier_model_not_free: {
          ...
          body: 'Nunmai utilise le modèle gratuit pour le moment. Connectez-vous avec un compte Nunmai gratuit pour accéder à plus de modèles.'
        },
        free_tier_route: {
          title: "Nunmai n'a pas pu joindre le modèle gratuit par cette route",
          body: 'Connectez-vous avec un compte Nunmai gratuit ou vérifiez le paramètre NOUS_INFERENCE_BASE_URL.'
        },
        free_tier_outage: {
        ...
        free_tier_refused: {
          title: "Nunmai n'a pas pu envoyer ce message sans connexion",
          body: 'La connexion avec un compte Nunmai est gratuite.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: "Nunmai n'a pas pu terminer la réponse",
      ...
      errorOpenNunmaiFolder: 'Ouvrir le dossier Nunmai',
      errorOpenNunmaiFolderFailed: "Impossible d'ouvrir le dossier Nunmai",
      errorUpdateApiKey: 'Mettre à jour la clé API',
      errorSignInAgain: provider => `Se reconnecter à ${provider}`,
      errorSignInFreeTier: 'Se connecter avec un compte Nunmai',
    ...
    approval: {
      gatewayDisconnected: "La Gateway Nunmai n'est pas connectée",
      sendFailed: "Impossible d'envoyer la réponse d'approbation",
      reconnect: 'Se reconnecter',
      timedOutSystemLine:
        "Le délai d'approbation a expiré — la commande n'a pas été exécutée. Demandez à Nunmai de réessayer ou augmentez la limite dans Paramètres → Sécurité → Délai d'approbation.",
      ...
      alwaysDescription: pattern =>
        `Cela ajoute le motif « ${pattern} » à votre liste d'autorisation permanente (~/.nunmai/config.yaml). Nunmai ne redemandera plus pour ce type de commande — que ce soit dans cette session ou dans une session future.`,
  ...
  prompts: {
    ...
    sudoDesc:
      "Nunmai a besoin de votre mot de passe sudo pour exécuter une commande privilégiée. Il n'est envoyé qu'à votre agent local.",
    ...
    sudoInstallDesc:
      'Nunmai a besoin de votre mot de passe sudo pour installer les paquets de Bot Screen (TigerVNC + Xfce) sur l’hôte du gateway. Il n’est envoyé qu’à cet hôte.',
    sudoPlaceholder: 'mot de passe sudo',
    secretTitle: 'Secret requis',
    secretDesc: "Nunmai a besoin d'un identifiant pour continuer.",
    ...
    vaultSaveDesc: origin =>
      `Nunmai a atteint une page de connexion sur ${origin} et ne possède aucun identifiant pour celle-ci. Saisissez-le une fois ici : il sera chiffré sur cet ordinateur et rempli dans la page sans que le modèle voie le mot de passe.`,
    ...
    vaultCodeDesc: site =>
      `${site} demande un code à usage unique reçu par SMS, e-mail ou application d'authentification. Saisissez-le ici : Nunmai le remplira dans la page sans que le modèle le voie.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      "Astuce : enregistrez la clé d'authentification avec cet identifiant dans Paramètres → Mots de passe et identifiants ; Nunmai saisira alors les codes pour vous.",
  ...
  desktop: {
    ...
    restartToUseSaveImage: "Redémarrez Nunmai Desktop pour utiliser Enregistrer l'image.",
    restartToSaveImages: 'Redémarrez Nunmai Desktop pour enregistrer les images',
    ...
    handoff: {
      ...
      timedOut: "Délai d'expiration en attendant la Gateway. `nunmai gateway` est-il en cours d'exécution ?",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: "Les compétences sont des dossiers d'instructions que Nunmai charge lorsque le travail le nécessite."
      },
      messaging: {
        title: 'Nunmai loin de votre bureau',
        text: 'Connectez Telegram, Discord, Slack et plus encore : même agent, même mémoire.'
      },
      artifacts: {
        title: 'Tout ce que Nunmai a créé',
      ...
      profiles: {
        ...
        text: 'Chacun possède son propre Nunmai, avec ses clés, sa mémoire et ses sessions.'
      },
      'composer-mentions': {
