...
export const ja = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsTitle: 'アプリ内ヒント',
      tipsDesc:
        'アプリの一部を指す小さな吹き出し。待機中にときどき、また役に立つときは Nunmai からも表示します。各ヒントは一度だけ表示されます。',
      tipsReset: (count: number) => `${count}件のヒントをもう一度表示`,
      toursTitle: 'ガイドツアー',
      toursDesc: '画面を暗くして各ステップを強調しながら、Nunmai がアプリを案内します。',
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `llama.cpp ${tag}（${backend}）で動作中——Nunmai が提供する最新ビルドです。`,
      updateToast: next =>
  ...
  prompts: {
    ...
    sudoTitle: '管理者パスワード',
    sudoDesc:
      'Nunmai は特権コマンドを実行するために sudo パスワードが必要です。ローカルエージェントにのみ送信されます。',
