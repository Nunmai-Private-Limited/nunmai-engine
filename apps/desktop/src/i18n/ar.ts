...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsDesc:
        'فقاعة صغيرة تشير إلى جزء من التطبيق، تظهر أحيانًا أثناء الخمول ومن Nunmai عند الحاجة. تظهر كل نصيحة مرة واحدة.',
      tipsReset: count => `إظهار ${count} نصيحة مرة أخرى`,
      toursTitle: 'جولات إرشادية',
      toursDesc: 'دع Nunmai يرشدك في التطبيق، مع تعتيم الشاشة وإبراز كل خطوة.',
