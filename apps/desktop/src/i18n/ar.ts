...
export const ar = defineLocale({
  sessionImport: {
    ...
    subtitle: 'انقل محادثة إلى Nunmai وتابع من حيث توقفت.',
    action: 'استيراد جلسة',
    ...
    chooseHelp: 'اختر جلسة لقراءة سجلها قبل نقلها إلى Nunmai.',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'يمكنك أيضاً تشغيل `nunmai debug share --nous` من الطرفية، أو `nunmai debug share --local` لعرض التقرير دون رفعه.',
    handoffLead: 'تابع النقاش في:',
    links: {
      github: 'GitHub Issues',
      portal: 'دعم بوابة Nunmai',
      discord: 'Discord'
    }
  },
  common: {
  ...
  boot: {
    ready: 'Nunmai Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات Nunmai',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Nunmai البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingNunmaiDesktop: 'جار تشغيل Nunmai Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Nunmai الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Nunmai الخلفية أثناء بدء التشغيل.',
    ...
    failure: {
      ...
      cloudDownTitle: 'عامل Nunmai Cloud معطّل',
      cloudDownDescription:
        'يعيد عامل السحابة المُدار من Nunmai الذي يتصل به هذا البوابة خطأً من الخادم. لا يمكن إعادة تشغيله من هنا — تحقق من حالته، أو بدّل إلى البوابة المحلية، أو احصل على الدعم.',
      cloudDownHint: 'تفتح الأزرار أدناه بوابة Nunmai (حالة المثيل وعناصر التحكم) أو Discord للحصول على الدعم.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Nunmai أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateNunmai: 'تحديث Nunmai',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Nunmai Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Nunmai ردّك.',
      turnDoneTitle: 'أنهى Nunmai',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Nunmai؟',
    ...
    vault: {
      ...
      otpHint: '«مفتاح الإعداد» الذي يعرضه الموقع عند تفعيل المصادقة الثنائية. بحفظه يولّد Nunmai الرموز بنفسه.',
      ...
      sources: {
        ...
        notInstalled: name => `غير مكتشف. ثبّت أداة سطر الأوامر ${name} وسجّل الدخول إليها؛ سيكتشفها Nunmai تلقائيًا.`,
        disabledDesc: 'مكتشف لكنه معطّل لـ Nunmai.',
        lockedDesc: 'مكتشف. سيطلب منك الوكيل فتحه عند الحاجة إلى بيانات دخول، أو افتحه الآن.',
        unlockedDesc: 'مفتوح لهذه الجلسة. يُقفل تلقائيًا بعد 30 دقيقة من الخمول أو عند إغلاق Nunmai.',
        statusLocked: 'مقفل',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Nunmai). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون Nunmai في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح Nunmai سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان Nunmai في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح Nunmai.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ Nunmai التفاعل مع رسائلك.',
      tipsTitle: 'نصائح داخل التطبيق',
      tipsDesc:
        'نصائح تظهر أحيانًا من التطبيق وNunmai. تظهر كل نصيحة مرة واحدة. تُعطّل تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      tipsReset: count => `إظهار ${count} نصيحة مرة أخرى`,
      toursTitle: 'جولات إرشادية',
      toursDesc:
        'دع Nunmai يرشدك في التطبيق مع إبراز كل خطوة. تُعطّل الجولات تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Nunmai — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Nunmai وأعد فتحه، ثم ارجع إلى هنا.',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج Nunmai إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Nunmai التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع Nunmai قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل Nunmai مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث Nunmai نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول Nunmai',
      ...
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Nunmai، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      bundleOutOfSyncAction: 'الحصول على المثبّت',
      bundleSwapPending: 'أعد التشغيل لإكمال التحديث',
      bundleSwapPendingDesc:
        'تم تثبيت التطبيق المحدَّث بالفعل — يكفي إعادة تشغيل Nunmai لتحميله. لن تتأثر المحادثات أو الإعدادات.',
      bundleSwapPendingAction: 'إعادة تشغيل Nunmai',
      updates: 'التحديثات',
      ...
      automaticUpdatesDesc: 'اسمح لـ Nunmai بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'تصغير النوافذ أو إغلاق النافذة الرئيسية يخفيها في علبة النظام (شريط القوائم على macOS) مع استمرار Nunmai في العمل. استخدم إنهاء Nunmai من قائمة العلبة أو Cmd+Q للخروج. معطّل افتراضيًا ويُطبّق على هذا الجهاز فقط.',
      ...
      loading: 'جار تحميل إعدادات Nunmai...',
    ...
    hudModifier: {
      ...
      permission:
        'اسمح لـ Nunmai في إعدادات النظام ← الخصوصية والأمان ← مراقبة الإدخال، ثم أعد المحاولة. لا تسجّل هذه الإيماءة ضغطات المفاتيح ولا تلتقط الشاشة.',
      unavailable:
        'تعذّر تشغيل مساعد إيماءة HUD أو توقف بشكل غير متوقع. أعد المحاولة أو أعد تشغيل Nunmai. يظل اختصار HUD الحالي يعمل داخل Nunmai.',
      missingHelper: 'مساعد إيماءة HUD غير موجود في تثبيت Nunmai هذا. حدّث Nunmai أو أعد تثبيته، ثم أعد المحاولة.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'اضغط مفتاحَي Command معًا من أي تطبيق لالتقاط النافذة الأمامية وإرفاقها بمسودة Nunmai الحالية. لا يُرسل أي شيء تلقائيًا. معطّل افتراضيًا ويُطبَّق على جهاز Mac هذا فقط. قد تتضمن النافذة محتوى حساسًا، لذا راجع المرفق قبل الإرسال.',
      ...
      inputPermission:
        'يتيح إذن مراقبة الإدخال لـ Nunmai رصد مفتاحَي Command أثناء استخدام تطبيق آخر. اسمح لـ Nunmai في إعدادات النظام ← الخصوصية والأمان ← مراقبة الإدخال، ثم عُد إلى هنا وأعد المحاولة.',
      screenPermission:
        'يتيح إذن تسجيل الشاشة لـ Nunmai التقاط نافذة التطبيق الأمامية عند استخدام هذا الاختصار. اسمح لـ Nunmai في إعدادات النظام ← الخصوصية والأمان ← تسجيل الشاشة، ثم عُد إلى هنا وأعد المحاولة. أعد تشغيل Nunmai إذا طلب macOS ذلك.',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح Nunmai.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل Nunmai Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Nunmai تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      envOverrideTitle: 'متغيرات البيئة تتحكم في جلسة سطح المكتب هذه.',
      envOverrideDesc: 'أزل NUNMAI_DESKTOP_REMOTE_URL و NUNMAI_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية Nunmai خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية Nunmai بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      remoteUrlTitle: 'رابط البوابة البعيدة',
      remoteUrlDesc: 'الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /nunmai.',
      ...
      restartingMessage: 'سيعيد Nunmai Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · Nunmai ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى Nunmai. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من Nunmai.',
    ...
    model: {
      moaTitle: 'مزيج الوكلاء (Nunmai Agent)',
      moaPreset: 'إعداد مسبق',
      moaDescription:
        'اضبط إعدادات مسبقة مسماة تظهر كنماذج ضمن موفّر Nunmai Agent. نموذج التجميع هو المنفّذ؛ ينفّذ كل خطوة في حلقة الأدوات وتُحتسب غالبية تكلفة التشغيل على موفّره. تقدّم النماذج المرجعية المشورة مرة واحدة لكل رسالة مستخدم افتراضياً.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Nunmai تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
    ...
    toolsets: {
      ...
      ready: 'جاهز',
      nousIncluded: 'مُضمّن مع اشتراك Nunmai — سجّل الدخول إلى Nunmai Portal للتفعيل.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Nunmai لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Nunmai لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Nunmai عند الانتهاء.',
    ...
    nunmaiActiveSessions: (version, count) => `Nunmai ${version} لديه ${count} جلسة نشطة`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'كلا الخيارين يربط بوتًا تتحكم به ويحفظ بياناته في هذا التثبيت من Nunmai فقط.',
      quickSetup: 'إعداد سريع',
      recommended: 'موصى به',
      quickHelp: 'امسح رمز QR وأكّد في Telegram. سينشئ Nunmai البوت ويكتشف معرّف مستخدم Telegram الخاص بك تلقائيًا.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'ستعمل جلسات هذا الملف الشخصي على خادم Nunmai البعيد الذي تحدده، بدلاً من هذا الجهاز.',
    ...
    defaultDescription: 'يُستخدم عند فتح Nunmai وللمحادثات الجديدة. تبقى الجلسات الحالية في ملفاتها الشخصية.',
  ...
  modelAssignment: {
    saveFailed: 'لم يحفظ Nunmai تغيير النموذج هذا.',
  ...
  cron: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل Nunmai تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها Nunmai تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Nunmai أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Nunmai. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم Nunmai لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء Nunmai...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل Nunmai عن شيء...', 'اطلب من Nunmai تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    commandDescs: {
      ...
      '/goal': 'تحديد هدف مستمر يعمل عليه Nunmai حتى إنجازه',
      ...
      '/plan': 'كتابة خطة تنفيذ بتنسيق Markdown في .nunmai/plans/ دون تنفيذها',
      '/moa': 'تشغيل طلب باستخدام Nunmai Agent ثم استعادة النموذج',
      ...
      '/profile': 'تبديل ملف Nunmai الشخصي النشط',
      ...
      '/subscription': 'عرض خطة Nunmai وتغييرها في المتصفح',
      '/topup': 'عرض رصيد Nunmai وإدارة الفواتير',
      '/platform': 'إيقاف منصة بوابة متعثرة مؤقتًا أو استئنافها أو عرضها',
      '/version': 'عرض إصدار Nunmai Engine',
    ...
    urlHintPre: 'سيقرأ Nunmai الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من Nunmai فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Nunmai...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Nunmai...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Nunmai تحديث نفسه من داخل التطبيق.',
    connectionRetry: 'تحقق من اتصالك وأعد المحاولة.',
    gitUnusable: 'لم يتمكن Nunmai من تشغيل Git على هذا الجهاز، لذا لم يتمكن من التحقق من التحديثات.',
    ...
    availableBody: 'إصدار جديد من Nunmai جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة Nunmai الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت Nunmai من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Nunmai الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Nunmai لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث Nunmai المهمة في نافذته الخاصة ويعيد فتح Nunmai تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح Nunmai بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد Nunmai الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد Nunmai فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث Nunmai؟',
    blockerBody: 'يحتاج Nunmai إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث Nunmai',
    foreignBlockerBody:
      'لا يمكن لـ Nunmai إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ Nunmai إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  guidedGreeting: {
    line: 'أهلا، تفضل بالدخول. أنا Nunmai. امنحني دقيقتين لأرتب المكان حولك، ثم نبدأ بشيء تريد إنجازه فعلا.\n\nبداية، بماذا أناديك؟',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Nunmai إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Nunmai',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Nunmai CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Nunmai قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Nunmai بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك Nunmai Engine',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل Nunmai التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء Nunmai...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Nunmai',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Nunmai إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Nunmai تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل Nunmai تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Nunmai هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ Nunmai هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Nunmai أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Nunmai...',
      askRestart: 'اطلب من Nunmai إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Nunmai عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Nunmai في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من Nunmai فتح صفحة.',
      finishedRestarting: message => `أنهى Nunmai إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على Nunmai إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال Nunmai يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  interfaceMode: {
    title: 'وضع الواجهة',
    hint: 'يغيّر ما يظهر، وليس ما يستطيع Nunmai فعله.',
    sessionNote: 'يحدده الوضع البسيط. التغيير هنا يستمر لهذه الجلسة فقط؛ بدّل إلى المتقدم لجعله خيارك.',
    simple: {
      label: 'بسيط',
      description: 'للتحدث مع Nunmai. الشريط الجانبي والدردشة؛ بلا طرفية أو لوحات ملفات أو فروقات.'
    },
    advanced: {
      label: 'متقدم',
  ...
  prompts: {
    ...
    sudoInstallDesc:
      'يحتاج Nunmai إلى كلمة مرور sudo لتثبيت حزم Bot Screen (TigerVNC + Xfce) على مضيف البوابة. تُرسل إلى ذلك المضيف فقط.',
    ...
    vaultSaveDesc: origin =>
      `وصل Nunmai إلى صفحة تسجيل الدخول في ${origin} ولا توجد بيانات دخول محفوظة لها. أدخلها هنا مرة واحدة؛ تُشفَّر على هذا الجهاز وتُملأ في الصفحة مباشرة، ولا يرى النموذج كلمة المرور أبدًا.`,
    ...
    vaultCodeDesc: site =>
      `يطلب ${site} رمزًا لمرة واحدة (رسالة نصية أو بريد إلكتروني أو تطبيق مصادقة). أدخله هنا وسيكتبه Nunmai في الصفحة؛ لا يراه النموذج أبدًا.`,
    vaultCodeLabel: 'الرمز',
    vaultCodeFootnote:
      'تلميح: احفظ مفتاح المصادقة مع بيانات الدخول هذه في الإعدادات ← كلمات المرور وتسجيلات الدخول وسيُدخل Nunmai الرموز نيابةً عنك.',
    vaultCodeSkip: 'تخطٍ',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `nunmai gateway` قيد التشغيل؟'
    }
  },
  errors: {
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'المهارات مجلدات من التعليمات يحمّلها Nunmai عندما يقتضي العمل ذلك.'
      },
      messaging: {
        title: 'Nunmai بعيدًا عن مكتبك',
        text: 'اربطه بـ Telegram وDiscord وSlack وغيرها — الوكيل نفسه والذاكرة نفسها.'
      },
      artifacts: {
        title: 'كل ما صنعه Nunmai',
      ...
      profiles: {
        ...
        text: 'كل واحد منها Nunmai مستقل — مفاتيحه وذاكرته وجلساته الخاصة.'
      },
      'composer-mentions': {
