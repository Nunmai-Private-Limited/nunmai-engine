...
export const de = defineLocale({
  ...
  connectors: {
    ...
    disclaimer: 'Das Verbinden ist freiwillig. Geben Sie nur den Apps Zugriff, die Nunmai verwenden soll.',
  ...
  connectorsPage: {
    ...
    page: {
      ...
      noMatchBody: 'Keine Treffer. Verweisen Sie Nunmai auf Ihren eigenen MCP-Server, um ihn hinzuzufügen.',
      ...
      signInLine: 'Melden Sie sich bei Nunmai an, um verwaltete Apps zu nutzen.',
      signIn: 'Anmelden',
      ...
      disconnectNoAccount:
        'Nunmai hat hier kein Konto zum Trennen. Aktualisieren Sie die Seite und versuchen Sie es erneut.',
      disconnectRefused:
        'Nunmai kann diese Anmeldung gerade nicht entfernen. Schalten Sie die App stattdessen mit dem Schalter aus oder versuchen Sie es später erneut.'
    },
    add: {
    ...
    dialog: {
      ...
      disconnectBody: 'Nunmai handelt nicht mehr über dieses Konto. Sie können sich jederzeit wieder verbinden.',
      ...
      appSwitch: (name: string) => `Nunmai darf ${name} verwenden`,
      ...
      wayHosted: 'Verwaltet',
      bothOn: (name: string) => `Beide sind an, daher sieht Nunmai jedes ${name}-Tool doppelt.`,
      ...
      rulesSignIn: 'Melden Sie sich an, um festzulegen, was Nunmai hier darf.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Was Nunmai mit ${name} tun darf`,
      summaryPreviewTitle: (name: string) => `Was Nunmai mit ${name} tun könnte, sobald Sie verbunden sind`,
      ...
      goneBody:
        'Nunmai kann ihn nicht mehr aufrufen. Die Zeile bleibt, bis Sie sie entfernen, damit nichts verschwindet.',
      remove: 'Entfernen',
      offTitle: (name: string) => `${name} ist aus.`,
      offBody: 'Schalten Sie ihn mit dem Schalter oben ein, um seine Tools zu laden.',
      signedOutTitle: 'Melden Sie sich bei Nunmai an, um die Tool-Liste zu laden.',
  ...
  sessionImport: {
    ...
    subtitle: 'Holen Sie eine Konversation in Nunmai und machen Sie dort weiter, wo Sie aufgehört haben.',
    ...
    chooseHelp: 'Wählen Sie eine Session, um ihren Verlauf zu lesen, bevor Sie sie in Nunmai übernehmen.',
    ...
    you: 'Sie',
    snapshot: 'Diese Konversation ist bereits in Nunmai. Öffnen Sie Ihre vorhandene Kopie, um weiterzumachen.',
    copyNotice:
    ...
    open: 'In Nunmai öffnen',
    continue: 'In Nunmai fortfahren',
  ...
  boot: {
    ready: 'Nunmai Desktop ist bereit',
    ...
    steps: {
      ...
      loadingSettings: 'Nunmai-Einstellungen werden geladen',
      loadingSessions: 'Letzte Sessions werden geladen',
      retryingRemoteBackend: 'Wird mit dem Remote-Nunmai-Backend neu verbunden…',
      startingDesktopConnection: 'Desktop-Verbindung wird gestartet',
      startingNunmaiDesktop: 'Nunmai Desktop wird gestartet…'
    },
    errors: {
      backgroundExited: 'Der Nunmai-Hintergrundprozess wurde beendet.',
      backgroundExitedDuringStartup: 'Der Nunmai-Hintergrundprozess wurde während des Starts beendet.',
      backendStopped: 'Backend gestoppt',
      restartNunmai: 'Nunmai neu starten',
      openLogs: 'Logs öffnen',
    ...
    causes: {
      exitedEarly: 'Der Hintergrunddienst von Nunmai hat direkt nach dem Start aufgehört.',
      timedOut: 'Der Hintergrunddienst von Nunmai hat nicht rechtzeitig geantwortet.',
      permission: 'Nunmai konnte nicht in seinen Datenordner schreiben (Berechtigungsproblem).',
      diskFull: 'Die Festplatte ist voll, deshalb konnte Nunmai nicht starten.',
      portInUse: 'Ein anderes Programm verwendet den Netzwerkport, den Nunmai braucht.',
      installMissing:
        'Ein Teil der Nunmai-Installation fehlt. Wählen Sie „Installation reparieren“, um sie wiederherzustellen.'
    },
    failure: {
      title: 'Nunmai konnte nicht gestartet werden',
      description:
      ...
      cloudDownTitle: 'Nunmai Cloud Agent ist down',
      cloudDownDescription:
        'Der von Nunmai verwaltete Cloud-Agent, mit dem sich dieses Gateway verbindet, meldet einen Serverfehler. Er kann von hier aus nicht neu gestartet werden – prüfen Sie seinen Status, wechseln Sie zum lokalen Gateway oder wenden Sie sich an den Support.',
      cloudDownHint:
        'Die Schaltflächen unten öffnen das Nunmai Portal (Instanzstatus und Steuerung) und unseren Discord für Support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Ihr Nunmai-Backend ist älter als dieser Desktop-Build und funktioniert möglicherweise nicht richtig. Aktualisieren Sie, um beide abzugleichen.',
    installMethodUnsupportedTitle: 'Nicht unterstützte Installationsmethode',
    updateNunmai: 'Nunmai aktualisieren',
    ...
    errors: {
      ...
      storageFailure:
        'Nunmai konnte nicht in seinen Datenordner speichern. Öffnen Sie die Wartung, um das Problem zu prüfen und zu beheben.',
      gatewayAuthFailed: 'Gateway-Authentifizierung fehlgeschlagen – überprüfen Sie Ihren API_SERVER_KEY.',
      methodNotAllowed:
        'Das Desktop-Backend hat diese Anfrage abgelehnt (405 Method Not Allowed). Starten Sie Nunmai Desktop neu.',
      ...
      restartNunmaiFailed: 'Nunmai konnte nicht neu gestartet werden'
    },
    actions: {
      restartNunmai: 'Nunmai neu starten',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Anfrage konnte nicht an Nunmai übergeben werden',
    ...
    native: {
      ...
      inputBody: 'Nunmai wartet auf Ihre Antwort.',
      turnDoneTitle: 'Nunmai fertig',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    title: 'Diagnosedaten an Nunmai senden',
    privacyNotice:
    ...
    failedHint:
      'Sie können auch `nunmai debug share --nous` im Terminal ausführen oder `nunmai debug share --local`, um den Bericht ohne Hochladen auszugeben.',
  ...
  settings: {
    ...
    resetConfirm: 'Alle Einstellungen auf Nunmai-Standard zurücksetzen?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Nunmai-Katalog-Eintrag „${name}" — die Agent-Komponente wird am geprüften Pin installiert${sha ? ` ${sha}` : ''}, nicht an der Spitze des Branches.`,
    ...
    vault: {
      ...
      otpHint:
        'Der „Einrichtungsschlüssel", den die Seite beim Aktivieren von 2FA anzeigt. Ist er gespeichert, erzeugt Nunmai die Codes selbst.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Nicht erkannt. Installieren Sie das ${name}-Kommandozeilenwerkzeug und melden Sie sich dort an; Nunmai erkennt es automatisch.`,
        disabledDesc: 'Erkannt, aber für Nunmai ausgeschaltet.',
        lockedDesc:
          'Erkannt. Der Agent bittet Sie, ihn zu entsperren, wenn er einen Login braucht – oder entsperren Sie ihn jetzt.',
        unlockedDesc:
          'Für diese Session entsperrt. Sperrt automatisch nach 30 Minuten Inaktivität oder wenn Nunmai geschlossen wird.',
    ...
    notifications: {
      ...
      focusedHint: 'Abschluss-Alerts feuern nur, während Nunmai im Hintergrund ist.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Eingabe nötig',
          description: 'Nunmai hat eine Frage gestellt oder braucht ein Passwort oder Geheimnis.'
        },
        turnDone: {
          label: 'Antwort bereit',
          description: 'Ein Turn wurde beendet, während Nunmai im Hintergrund war.'
        },
        turnError: {
        ...
        plugin: {
          ...
          description: 'Ein Desktop-Plugin hat eine Benachrichtigung gesendet, während Nunmai im Hintergrund war.'
        }
      },
    ...
    appearance: {
      ...
      colorMode: 'Farbmodus',
      colorModeDesc: 'Wählen Sie einen festen Modus oder lassen Sie Nunmai Ihrer Systemeinstellung folgen.',
      ...
      reactionsDesc:
        'Emoji-Tapbacks im iMessage-Stil – reagieren Sie auf Nachrichten, und Nunmai kann auf Ihre reagieren.',
      tipsTitle: 'In-App-Tipps',
      tipsDesc:
        'Eine kleine Blase, die auf einen Teil der App zeigt und gelegentlich im Leerlauf sowie von Nunmai erscheint, wenn es hilft. Beim Schließen wird sie für immer ausgeblendet.',
      tipsReset: (count: number) => `${count} geschlossene ${count === 1 ? 'Blase' : 'Blasen'} zurückholen`,
      toursTitle: 'Geführte Touren',
      toursDesc:
        'Lassen Sie sich von Nunmai durch die App führen – der Bildschirm wird abgedunkelt und jeder Schritt hervorgehoben.',
      ...
      pet: {
        title: 'Haustier',
        intro:
          'Adoptieren Sie ein animiertes Petdex-Maskottchen, das über der App schwebt und darauf reagiert, was Nunmai gerade tut – es rennt, während Tools laufen, feiert bei Erfolg und schmollt bei Fehlern.',
        restartHint:
          'Haustiere erfordern einen kurzen Neustart – die laufende App wurde gestartet, bevor diese Funktion hinzugefügt wurde. Schließen Sie Nunmai, öffnen Sie es erneut und kehren Sie dann hierher zurück.',
        scaleTitle: 'Größe',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Maximale Zeichenzahl, die Nunmai aus einer Dateianfrage lesen kann.',
      approvals: {
        mode: 'Wie Nunmai Befehle behandelt, die eine explizite Genehmigung benötigen.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained: Sprache zu Text → Nunmai → Text zu Sprache mit den Anbietern unten. gpt-live: Ein Vollduplex-Sprachmodell von OpenAI (gpt-live-1) hört zu und spricht und übergibt jede echte Anfrage an Nunmai – das von Ihnen gewählte Modell antwortet mit allen Tools. Erfordert einen OpenAI-API-Schlüssel; die Sprachschicht kostet 0,05 $ pro Minute.',
        gptLive: {
          voice: 'Stimme für den GPT-Live-Modus. Eigene Stimm-IDs werden akzeptiert.',
          instructions:
            'Zusätzliche Sätze für die Live-Sprachpersona (Ton, Tempo, Sprache). Nunmai behält seinen eigenen System-Prompt.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Wenn Nunmai sich aus der App selbst aktualisiert (ohne Terminal-Aufforderung), lokale Quellcode-Änderungen behalten (stash) oder verwerfen (discard). Terminal-Updates fragen immer nach.'
      }
    }),
    uninstallSection: {
      dangerZone: 'Gefahrenzone',
      checkingInstalled: 'Installierte Komponenten werden geprüft…',
      uninstallNunmai: 'Nunmai deinstallieren',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description:
            'Entfernt diese Desktop-App. Der Nunmai-Agent, Ihre Konfiguration und Ihre Chats bleiben erhalten.',
          consequence: 'die Desktop-Chat-Oberfläche (diese App und ihre Daten)'
        },
        lite: {
          title: 'Oberfläche + Agent deinstallieren, Daten behalten',
          description:
            'Entfernt die App und den Nunmai-Agent, behält aber Konfiguration, Chats und Geheimnisse für eine spätere Neuinstallation.',
          consequence:
            'die Chat-Oberfläche und den Nunmai-Agent (Konfiguration, Chats und Geheimnisse bleiben erhalten)'
        },
        full: {
          ...
          consequence:
            'ALLES – die Chat-Oberfläche, den Nunmai-Agent sowie Ihre gesamte Konfiguration, Chats, Geheimnisse und Logs'
        }
      }
    },
    poolLimits: {
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Nunmai sucht im Hintergrund automatisch nach Updates und meldet sich, wenn eines bereit ist.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Beim Minimieren von Fenstern oder Schließen des Hauptfensters werden diese im Infobereich (Menüleiste unter macOS) ausgeblendet und Nunmai läuft weiter. Beenden Sie über „Nunmai beenden“ im Infobereich-Menü oder mit Cmd+Q. Standardmäßig aus; gilt nur für dieses Gerät.',
      ...
      loading: 'Nunmai-Konfiguration wird geladen...',
    ...
    hudModifier: {
      ...
      permission:
        'Erlauben Sie Nunmai unter Systemeinstellungen → Datenschutz & Sicherheit → Eingabeüberwachung und versuchen Sie es erneut. Diese Geste zeichnet keine Tastenanschläge auf und nimmt Ihren Bildschirm nicht auf.',
      unavailable:
        'Das Hilfsprogramm für die HUD-Geste konnte nicht starten oder wurde unerwartet beendet. Versuchen Sie es erneut oder starten Sie Nunmai neu. Das bestehende HUD-Tastenkürzel funktioniert innerhalb von Nunmai weiterhin.',
      missingHelper:
        'In dieser Nunmai-Installation fehlt das Hilfsprogramm für die HUD-Geste. Aktualisieren oder installieren Sie Nunmai neu und versuchen Sie es erneut.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      inputPermission:
        'Mit der Berechtigung „Eingabeüberwachung“ kann Nunmai beide Befehlstasten erkennen, während eine andere App aktiv ist. Erlauben Sie Nunmai unter Systemeinstellungen → Datenschutz & Sicherheit → Eingabeüberwachung, kehren Sie dann hierher zurück und versuchen Sie es erneut.',
      screenPermission:
        'Mit der Berechtigung „Bildschirmaufnahme“ kann Nunmai das vorderste App-Fenster aufnehmen, wenn Sie diesen Kurzbefehl verwenden. Erlauben Sie Nunmai unter Systemeinstellungen → Datenschutz & Sicherheit → Bildschirmaufnahme, kehren Sie dann hierher zurück und versuchen Sie es erneut. Starten Sie Nunmai neu, wenn macOS dazu auffordert.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Öffnen Sie mit einem globalen Tastaturkürzel von überall einen kleinen Eingabebereich und senden Sie einen Prompt, ohne Nunmai zu öffnen.',
    ...
    connections: {
      ...
      intro:
        'Verwalten Sie dieses Gerät und jedes Nunmai Gateway, das es über Remote-, SSH- oder Cloud-Verbindungen erreichen kann.',
      stagedNote:
      ...
      updateSkippedCloud: 'Wird von Nunmai Cloud verwaltet',
      kindLocal: 'Lokal',
      kindRemote: 'Remote-Gateway',
      kindCloud: 'Nunmai Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'Die Nunmai-Laufzeitumgebung, die von dieser App verwaltet wird.',
      kindRemoteDesc: 'Ein Nunmai Gateway, das über HTTP(S) erreichbar ist – LAN, Tailscale oder das Internet.',
      kindCloudDesc: 'Eine gehostete Instanz, die über Ihr Nunmai-Cloud-Konto gefunden wurde.',
      kindSshDesc: 'Eine Nunmai-Installation, die über SSH erreicht wird.',
      labelTitle: 'Name',
      labelDesc:
      ...
      headersDesc:
        'Wird mit jeder HTTP- und WebSocket-Anfrage an dieses Gateway gesendet – für Zugriffs-Proxys wie Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Werte werden verschlüsselt gespeichert. Header, die Nunmai verwaltet (Authorization, Cookie, Host…), werden ignoriert.',
      ...
      cloudAddHint:
        'Tipp: Die Anmeldung unter Nunmai Cloud oben erkennt Ihre Agents automatisch – verwenden Sie dieses Formular nur, um eine bekannte Instanz-URL manuell zu registrieren.',
    ...
    gateway: {
      ...
      intro:
        'Standardmäßig lokal. Verwenden Sie Remote, wenn diese App ein Nunmai-Backend an einem anderen Ort steuern soll. Gateway-Verbindungen gelten pro Gerät; Profile werden von den Gateways ermittelt, mit denen Sie sich verbinden.',
      envOverrideTitle: 'Umgebungsvariablen steuern diese Desktop-Session.',
      envOverrideDesc:
        'Entfernen Sie NUNMAI_DESKTOP_REMOTE_URL und NUNMAI_DESKTOP_REMOTE_TOKEN, um die unten gespeicherte Einstellung zu verwenden.',
      modeTitle: 'Verbindungsmodus',
      localTitle: 'Lokales Gateway',
      localDesc: 'Startet ein privates Nunmai-Backend auf localhost. Das ist der Standard und funktioniert offline.',
      remoteTitle: 'Remote-Gateway',
      remoteDesc: 'Verbindet diese Desktop-Shell mit einem entfernten Nunmai-Backend.',
      remoteAuthHint:
      ...
      cloudDesc:
        'Melden Sie sich einmal bei Nunmai Cloud an und wählen Sie aus den Agents in Ihrem Konto – ohne eine URL einzufügen.',
      cloudSignInTitle: 'Nunmai Cloud',
      cloudSignIn: 'Bei Nunmai Cloud anmelden',
      cloudSignedIn: 'Bei Nunmai Cloud angemeldet',
      cloudNeedsSignIn: 'Melden Sie sich bei Nunmai Cloud an, um die Agents in Ihrem Konto zu finden.',
      cloudSignedInDesc:
      ...
      cloudDiscoverFailed: 'Ihre Nunmai-Cloud-Agents konnten nicht geladen werden',
      cloudConnectFailed: 'Keine Verbindung zu diesem Agent möglich',
      cloudSignInFailed: 'Anmeldung bei Nunmai Cloud fehlgeschlagen',
      cloudSignedOutTitle: 'Von Nunmai Cloud abgemeldet',
      cloudSignedOutMessage: 'Die Nunmai-Cloud-Session wurde geleert.',
      ...
      remoteUrlDesc: 'Basis-URL für das Remote-Dashboard-Backend. Pfad-Präfixe werden unterstützt, z. B. /nunmai.',
      ...
      restartingMessage:
        'Nunmai Desktop stellt mit den gespeicherten Einstellungen die Verbindung wieder her — die Shell bleibt offen.',
      savedMessage: 'Für den nächsten Neustart gespeichert.',
      connectedTo: (baseUrl, version) => `Verbunden mit ${baseUrl}${version ? ` · Nunmai ${version}` : ''}`,
      ...
      sshDesc:
        'Nunmai wird per SSH auf dem Remote-Gerät gestartet und in diese App getunnelt – Sie müssen nichts selbst starten oder freigeben. Erfordert funktionierenden, schlüsselbasierten SSH-Zugriff auf den Host.',
      ...
      sshNunmaiPathTitle: 'Nunmai-Pfad (optional)',
      sshNunmaiPathDesc: 'Vollständiger Pfad zum Remote-Nunmai-Binary. Leer = automatisch erkennen.',
      sshNunmaiPathPlaceholder: 'automatisch erkennen',
      ...
      sshReachable: (host, platform) => `Erreichbar: ${host} (${platform}) — Nunmai gefunden`,
      ...
      sshErrAuth:
        'SSH-Authentifizierung fehlgeschlagen. Laden Sie Ihren Schlüssel in den ssh-agent (ssh-add) oder setzen Sie eine IdentityFile in ~/.ssh/config – Nunmai führt ssh nicht interaktiv aus.',
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        'Nunmai ist auf dem Remote-Host nicht installiert. Installieren Sie es dort (curl -fsSL https://nunmai-engine.nunmai.in/install.sh | sh) oder legen Sie den Nunmai-Pfad fest.',
      sshErrPlatform:
        'Nicht unterstützte Remote-Plattform. Der Desktop-SSH-Modus von Nunmai unterstützt Linux-, macOS- und Windows-Remote-Hosts.',
      sshErrTimeout: 'SSH-Verbindung ist ausgelaufen. Der Host ist möglicherweise nicht erreichbar oder schläft.',
      sshErrUpdateRequired: 'Aktualisieren Sie Nunmai auf dem Remote-Host, bevor Sie sich mit Desktop-SSH verbinden.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'Ein Link möchte diesen MCP-Server zu Nunmai hinzufügen. Prüfen Sie die genaue Konfiguration unten – sie stammt vom Link, nicht von Nunmai.',
    ...
    model: {
      ...
      moaDescription:
        'Konfigurieren Sie benannte Vorlagen, die als Modelle unter dem Anbieter „Nunmai Agent“ erscheinen. Der Aggregator ist das handelnde Modell – er führt jeden Schritt der Tool-Schleife aus, und fast alle Kosten des Laufs werden seinem Anbieter berechnet. Referenzen beraten standardmäßig nur einmal pro Benutzer-Turn.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend}-Backend. Nunmai startet und verwaltet den Server für Sie.`,
      ...
      upToDateDetail: (tag, backend) =>
        `llama.cpp ${tag} (${backend}) wird ausgeführt — der neueste Build, den Nunmai mitliefert.`,
    ...
    billing: {
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'Remote-Ausgaben sind für dieses Konto deaktiviert – ein Abrechnungsadministrator kann sie auf der Nunmai-Agent-Seite des Portals aktivieren.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        'Melden Sie sich mit einem Abo an – kein API-Key zum Kopieren. Nunmai übernimmt die Browser-Anmeldung für Sie, direkt hier in der App.',
      connected: 'Verbunden',
      collapse: 'Einklappen',
      ...
      localEndpoint: {
        ...
        description:
          'Verbinden Sie Nunmai mit einem beliebigen OpenAI-kompatiblen Endpunkt (Zyphra, vLLM, llama.cpp, Ollama usw.).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'In einem Nous-Abo enthalten – melden Sie sich im Nunmai Portal an, um es zu aktivieren.',
      nousAuthNeededTitle: 'Im Nunmai Portal anmelden',
      nousAuthNeededMessage: provider =>
        `${provider} ist gespeichert, wird aber erst aktiviert, wenn Sie sich im Nunmai Portal anmelden.`,
      nousAuthSignIn: 'Anmelden',
      nousAuthDoneTitle: 'Nunmai Portal verbunden',
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Nunmai kann gerade keine Shell-Befehle ausführen: ${backend} ist nicht bereit. Wechseln Sie zu Lokal oder schließen Sie die Einrichtung von ${backend} ab und versuchen Sie es erneut.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Lassen Sie Nunmai mit einem Schnappschuss Ihres Standard-Browserprofils browsen, damit Websites bereits angemeldet öffnen.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Wiederherstellbar über „nunmai curator restore“.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Nunmai (Standard)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend:
        'Dieses Backend ist älter als schlüsseladressierte Plugin-Schalter — aktualisieren Sie Nunmai, um es hier zu verwalten.',
      ...
      catalogProvenance: sha => `Aus dem Nunmai-Katalog installiert${sha ? ` am Pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201E${name}\u201C ist nicht im Nunmai-Plugin-Katalog. Es wurde nichts installiert.`,
      deepLinkCatalogUnavailable:
        'Der Nunmai-Plugin-Katalog konnte nicht geladen werden. Prüfen Sie Ihre Verbindung und öffnen Sie den Link erneut.',
  ...
  starmap: {
    ...
    emptyDesc: 'Sobald Nunmai Skills und Erinnerungen zu Ihrer Arbeit aufbaut, erscheinen sie hier.',
    share: 'Map teilen',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Starten Sie Nunmai neu, um Pets zu verwenden – das Backend ist älter als diese Funktion.',
    ...
    generatePet: {
      ...
      staleBackend: 'Aktualisieren Sie Nunmai, um Pets zu generieren.',
      backgroundHint: 'Sie können dieses Fenster schließen – Nunmai benachrichtigt Sie, wenn es fertig ist.',
    ...
    nav: {
      ...
      settings: {
        title: 'Einstellungen',
        detail: 'Nunmai Desktop konfigurieren'
      },
      capabilities: {
        title: 'Fähigkeiten',
    ...
    nunmaiActiveSessions: (version, count) => `Nunmai ${version} · Aktive Sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle:
        'Beide Optionen verbinden einen Bot, den Sie kontrollieren, und speichern seine Zugangsdaten nur in dieser Nunmai-Installation.',
      quickSetup: 'Schnelleinrichtung',
      recommended: 'Empfohlen',
      quickHelp:
        'Scannen Sie einen QR-Code und bestätigen Sie in Telegram. Nunmai legt den Bot an und erkennt Ihre Telegram-Benutzer-ID automatisch.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description:
        'Sessions in diesem Profil laufen auf dem von Ihnen festgelegten Remote-Nunmai statt auf diesem Computer.',
    ...
    defaultDescription:
      'Wird beim Öffnen von Nunmai und für neue Chats verwendet. Bestehende Sessions bleiben in ihren Profilen.',
    ...
    deleting: 'Wird gelöscht...',
    createDesc: 'Profile sind unabhängige Nunmai-Umgebungen: eigene Config, eigene Skills und eigene SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'Nunmai hat diese Modelländerung nicht gespeichert.',
  ...
  cron: {
    ...
    newCron: 'Neuer Cron',
    emptyDescNew:
      'Planen Sie einen Prompt, der nach einem Cron-Ausdruck ausgeführt wird. Nunmai führt ihn aus und liefert die Ergebnisse an das von Ihnen gewählte Ziel.',
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Nunmai kann nicht den gesamten Session-Verlauf für ${profiles} lesen. Chats, die in dieser Liste fehlen, wurden nicht gelöscht; die Datei, in der sie gespeichert sind, ist beschädigt.`,
      action:
        'Beenden Sie Nunmai für dieses Profil und prüfen Sie die Datei dann, ohne sie zu ändern, oder stellen Sie einen Snapshot wieder her:',
    ...
    projects: {
      ...
      staleBackend:
        'Aktualisieren Sie das Nunmai-Backend, um Projekte zu erstellen – Ihr Backend ist älter als diese Desktop-App (Einstellungen → Updates → Backend).',
      deleteConfirm:
        'Das entfernt das gespeicherte Projekt aus Nunmai. Dateien, Git-Repos und Worktrees bleiben unberührt.',
      ...
      worktreeStaleBackend:
        'Aktualisieren Sie das Nunmai-Backend, um Worktrees über diese Remote-Verbindung zu erstellen – es ist älter als die Git-Worktree-API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Nunmai wird gestartet…',
    placeholderReconnecting: 'Verbindung zu Nunmai wird wiederhergestellt…',
    placeholderFollowUp: 'Folge senden',
    newSessionPlaceholders: [
      'Was bauen wir?',
      'Geben Sie Nunmai eine Aufgabe',
    ...
    voiceEngineChained: 'Sprache-zu-Text + Nunmai-Stimme',
    voiceEngineLive: 'GPT-Live (Vollduplex, delegiert an Nunmai)',
    ...
    commandDescs: {
      ...
      '/goal': 'Ein dauerhaftes Ziel festlegen, an dem Nunmai über mehrere Turns arbeitet, bis es erreicht ist',
      ...
      '/plan': 'Einen Markdown-Umsetzungsplan in .nunmai/plans/ schreiben, ohne etwas auszuführen',
      ...
      '/profile': 'Aktives Nunmai-Profil wechseln',
      ...
      '/version': 'Nunmai-Agent-Version anzeigen',
    ...
    attachUrlDesc: 'Nunmai ruft die Seite ab und fügt sie als Kontext für diesen Turn hinzu.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Nunmai bitten, einen PR zu öffnen',
  ...
  updates: {
    stages: {
      ...
      update: 'Aktualisiert Nunmai…',
      rebuild: 'Baut die Desktop-App neu…',
      restart: 'Startet Nunmai neu…',
    ...
    unsupportedMessage: 'Diese Nunmai-Version kann sich nicht aus der App heraus aktualisieren.',
    connectionRetry: 'Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.',
    gitUnusable: 'Nunmai konnte Git auf diesem Computer nicht ausführen und daher nicht nach Updates suchen.',
    connectionSettings: 'Verbindungseinstellungen',
    ...
    availableBody: 'Eine neue Nunmai-Version ist bereit zur Installation.',
    availableTitleBackend: 'Backend-Update verfügbar',
    availableBodyBackend: 'Eine neuere Version des verbundenen Nunmai-Backends ist bereit zur Installation.',
    ...
    manualBody:
      'Sie haben Nunmai über die Befehlszeile installiert, daher laufen Updates auch dort. Fügen Sie dies in Ihr Terminal ein:',
    manualPickedUp: 'Nunmai übernimmt die neue Version beim nächsten Start.',
    guiSkewTitle: 'Desktop-App aktualisieren',
    guiSkewBody:
      'Das Backend wurde aktualisiert, aber dieses Desktop-App-Paket nicht. Aktualisieren oder installieren Sie die Nunmai-Desktop-App neu (Ihr AppImage / .deb / .rpm), um beide abzugleichen.',
    copy: 'Kopieren',
    copied: 'Kopiert',
    done: 'Fertig',
    applyingBody:
      'Der Nunmai-Updater übernimmt in einem eigenen Fenster und öffnet Nunmai automatisch wieder, wenn er fertig ist. Bitte öffnen Sie Nunmai während des Updates nicht selbst erneut.',
    applyingBodyBackend:
      'Das Remote-Backend wendet das Update an und startet neu. Nunmai verbindet sich automatisch wieder, wenn es zurück ist.',
    applyingClose: 'Dieses Fenster schließt sich während des Updates, dann öffnet sich Nunmai von selbst wieder.',
    errorTitle: 'Update nicht abgeschlossen',
    errorBody: 'Keine Sorge – es ging nichts verloren. Sie können es jetzt erneut versuchen.',
    blockerTitle: 'Lokale Vorschauen schließen, um Nunmai zu aktualisieren?',
    blockerBody:
      'Nunmai muss diese lokalen Vorschauen vor dem Update stoppen. Ihre Dateien werden dabei weder geändert noch gelöscht.',
    foreignBlockerTitle: 'Andere Prozesse schließen, um Nunmai zu aktualisieren',
    foreignBlockerBody:
      'Nunmai kann diese Prozesse nicht sicher automatisch beenden. Schließen Sie die App, das Terminal oder den Dienst, zu dem sie gehören, und versuchen Sie das Update erneut.',
    mixedBlockerBody:
      'Nunmai kann die unten aufgeführten lokalen Vorschauen schließen. Andere Prozesse müssen manuell geschlossen werden, bevor das Update fortgesetzt werden kann.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Nunmai ist einen Klick entfernt',
    stayText:
      'Wechseln Sie ins Einrichtungsprofil und öffnen Sie „Willkommen bei Nunmai“, wenn Sie Hilfe brauchen. Es bleibt dort.'
  },
  guidedGreeting: {
    line: 'Hallo und willkommen. Ich bin Nunmai. Geben Sie mir zwei Minuten, um alles für Sie einzurichten, dann setzen wir mich auf etwas an, das Sie wirklich erledigt haben möchten.\\n\\nAber zuerst: Wie soll ich Sie nennen?',
  ...
  install: {
    ...
    oneTimeTitle: 'Nunmai braucht eine einmalige Installation',
    ...
    setupChoiceTitle: 'Nunmai Desktop einrichten',
    setupChoiceDesc:
      'Verbinden Sie diese App mit einem Nunmai Gateway, das Sie bereits betreiben, oder installieren Sie Nunmai lokal auf diesem Computer.',
    connectExistingTitle: 'Mit bestehendem Nunmai verbinden',
    ...
    installLocalTitle: 'Nunmai lokal installieren',
    installLocalDesc:
      'Nunmai herunterladen, seine Python-Umgebung erstellen und das Backend auf diesem Computer ausführen.',
    localStartUnavailable:
      'Die lokale Installation konnte nicht gestartet werden. Starten Sie Nunmai Desktop neu und versuchen Sie es erneut.',
    remoteSetupTitle: 'Mit bestehendem Nunmai verbinden',
    remoteSetupDesc:
      'Geben Sie die URL Ihres Gateways ein. Nunmai Desktop erkennt, ob ein Token oder eine Browser-Anmeldung nötig ist.',
    remoteUrlTitle: 'Gateway-URL',
    remoteUrlDesc: 'Verwenden Sie die Basis-URL des Nunmai Gateways, bei Remote-Gateways einschließlich https://.',
    remoteUrlPlaceholder: 'https://gateway.example.com/nunmai',
    probing: 'Gateway-Authentifizierung wird erkannt...',
    probeError: 'Dieses Nunmai Gateway konnte nicht erreicht werden.',
    ...
    settingUpTitle: 'Nunmai Engine wird eingerichtet',
    finishingTitle: 'Wird abgeschlossen',
    failedDesc:
      'Einer der Installationsschritte ist fehlgeschlagen. Unter Windows kann das passieren, wenn eine andere Nunmai-CLI- oder Desktop-Instanz läuft. Beenden Sie alle laufenden Nunmai-Instanzen und versuchen Sie es dann erneut. Das vollständige Protokoll finden Sie in den Details unten oder im Desktop-Log.',
    activeDesc:
      'Das ist eine einmalige Einrichtung. Der Nunmai-Installer lädt Abhängigkeiten herunter und konfiguriert Ihren Computer. Bei späteren Starts wird dieser Schritt übersprungen.',
  ...
  onboarding: {
    headerTitle: 'Nunmai Engine für Sie einrichten',
    headerDesc:
      'Verbinden Sie einen Modell-Anbieter, um mit dem Chatten zu beginnen. Die meisten Optionen brauchen nur einen Klick.',
    preparingInstall:
      'Nunmai schließt die Installation ab. Das dauert beim ersten Start normalerweise unter einer Minute.',
    starting: 'Nunmai wird gestartet…',
    ...
    recommended: 'Empfohlen',
    connected: 'Verbunden',
    featuredPitch: 'Ein Abo, 300+ Frontier-Modelle – die empfohlene Art, Nunmai zu nutzen',
    ...
    apiKeyOptions: {
      ...
      local: {
        ...
        description:
          'Verbinden Sie Nunmai mit einem lokalen oder selbst gehosteten OpenAI-kompatiblen Endpunkt (vLLM, llama.cpp, Ollama usw.).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Öffnet eine Verifizierungsseite in Ihrem Browser – Nunmai verbindet sich automatisch',
    ...
    authorizeThere: 'Autorisieren Sie Nunmai dort.',
    ...
    autoBrowser: provider =>
      `Wir haben ${provider} in Ihrem Browser geöffnet. Autorisieren Sie Nunmai dort, und Sie werden automatisch verbunden – nichts zu kopieren oder einzufügen.`,
  ...
  freeTier: {
    ...
    busyBody: wait =>
      `Nunmai konnte Ihre Anmeldung nicht abschließen, weil der Nous-Dienst ausgelastet ist. Versuchen Sie es in ${wait} erneut. Ihre Session bleibt so lange erhalten.`,
    unreachableBody:
      'Nunmai konnte den Nous-Dienst nicht erreichen, um Ihre Anmeldung abzuschließen. Prüfen Sie Ihre Internetverbindung und versuchen Sie es erneut. Ihre Session bleibt erhalten.',
    alreadySignedInHeading: 'Bereits angemeldet.',
    alreadySignedInBody: 'Dieses Nunmai ist bereits mit einem Nous-Konto angemeldet.',
    setupFailed: {
      gateClosed:
        'Diese Nunmai-Version kann ohne Nous-Konto nicht starten. Melden Sie sich an oder legen Sie eines an – kostenlos und in einer Minute erledigt.',
      paused:
        'Chatten ohne Anmeldung ist vorübergehend pausiert. Nunmai prüft weiter. Die Anmeldung ist kostenlos, und Sie können sofort weitermachen.',
      rateLimited: wait =>
        `Gerade starten sehr viele Leute, deshalb versucht Nunmai es in ${wait} erneut. Die Anmeldung ist kostenlos und überspringt das Warten.`,
      unreachable:
        'Nunmai konnte den Nous-Dienst nicht erreichen. Prüfen Sie Ihre Internetverbindung und tippen Sie dann auf „Erneut versuchen“. Oder verbinden Sie vorerst einen anderen Anbieter.',
      serverError:
      ...
      generic:
        'Nunmai konnte den kostenlosen Zugang ohne Anmeldung nicht einrichten. Die Anmeldung ist kostenlos — oder verbinden Sie einen anderen Anbieter.',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} ist ${size}. Nunmai zeigt nur die ersten 512 KB an.`,
    ...
    web: {
      ...
      restarting: 'Nunmai wird neu gestartet …',
      askRestart: 'Nunmai bitten, den Server neu zu starten',
      lookingRestart: taskId => `Nunmai sucht nach einem Vorschau-Server zum Neustarten (${taskId})`,
      restartingTitle: 'Vorschau-Server wird neu gestartet',
      restartingMessage: 'Nunmai arbeitet im Hintergrund. Beobachte im Fortschritt die Vorschau-Konsole.',
      ...
      blankPageBody: 'Geben Sie oben eine Adresse ein, um zu browsen, oder bitten Sie Nunmai, eine Seite zu öffnen.',
      finishedRestarting: message => `Nunmai hat den Vorschau-Server neu gestartet${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nunmai konnte den Server nicht neu starten.',
      stillWorking:
        'Nunmai arbeitet noch, aber es ist noch kein Ergebnis des Neustarts eingetroffen. Der Server-Befehl läuft möglicherweise im Vordergrund.',
  ...
  interfaceMode: {
    ...
    hint: 'Ändert, was angezeigt wird, nicht was Nunmai kann.',
    sessionNote:
    ...
    simple: {
      label: 'Einfach',
      description: 'Zum Chatten mit Nunmai. Seitenleiste und Chat; keine Terminal-, Datei- oder Diff-Bereiche.'
    },
    advanced: {
      label: 'Erweitert',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nunmai lädt eine Antwort',
      ...
      errorLayerBodies: {
        ...
        disk: 'Ihre Festplatte ist voll, daher konnte Nunmai dieses Gespräch nicht speichern. Geben Sie Speicherplatz frei und versuchen Sie es erneut.',
        endpoint:
          'Nunmai erreicht Ihren eigenen Modellserver nicht. Prüfen Sie, ob er läuft, und senden Sie Ihre Nachricht erneut.',
        gateway:
          'Beim Starten dieser Antwort ist in Nunmai ein internes Problem aufgetreten. Senden Sie Ihre Nachricht erneut; wenn es bestehen bleibt, senden Sie Diagnosedaten.',
        generic:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Nunmai konnte die sichere Verbindung zu ${provider} nicht verifizieren. Prüfen Sie Ihre Netzwerk- oder Proxy-Einstellungen oder wechseln Sie den Anbieter und senden Sie Ihre Nachricht erneut.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider =>
            `${provider} hat etwas zurückgegeben, das Nunmai nicht lesen konnte. Versuchen Sie es gleich erneut.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Nunmai ist in einer Schleife hängen geblieben',
          body: 'Die Antwort hat dieselben Schritte wiederholt, daher hat Nunmai sie gestoppt. Versuchen Sie es erneut oder starten Sie einen neuen Chat, wenn es wieder passiert.'
        },
        SESSION_NOT_OWNED: {
          title: 'Dieser Chat ist woanders offen',
          body: 'Dieser Chat ist gerade in einem anderen Nunmai-Fenster oder Terminal geöffnet. Schließen Sie ihn dort und senden Sie Ihre Nachricht erneut, oder starten Sie hier einen neuen Chat.'
        },
        disk_full: {
          title: 'Festplatte voll',
          body: 'Ihre Festplatte ist voll, daher konnte Nunmai dieses Gespräch nicht speichern. Geben Sie Speicherplatz frei und versuchen Sie es erneut.'
        },
        free_tier_disabled: {
        ...
        free_tier_model_not_free: {
          ...
          body: 'Nunmai verwendet vorerst das kostenlose Modell. Melden Sie sich mit einem Nous-Konto an, um mehr Modelle zu nutzen – es ist kostenlos.'
        },
        free_tier_route: {
          title: 'Nunmai hat das kostenlose Modell über diese Route nicht erreicht',
        ...
        free_tier_refused: {
          title: 'Nunmai konnte das ohne Anmeldung nicht senden',
      ...
      errorToastTitle: 'Nunmai konnte die Antwort nicht fertigstellen',
      ...
      errorOpenNunmaiFolder: 'Nunmai-Ordner öffnen',
      errorOpenNunmaiFolderFailed: 'Der Nunmai-Ordner konnte nicht geöffnet werden',
    ...
    approval: {
      gatewayDisconnected: 'Nunmai-Gateway ist nicht verbunden',
      sendFailed: 'Genehmigungsantwort konnte nicht gesendet werden',
      reconnect: 'Neu verbinden',
      timedOutSystemLine:
        'Die Freigabe ist abgelaufen — der Befehl wurde nicht ausgeführt. Bitten Sie Nunmai, es erneut zu versuchen, oder erhöhen Sie das Limit unter Einstellungen → Sicherheit → Freigabe-Timeout.',
      ...
      alwaysDescription: pattern =>
        `Dies fügt das Muster „${pattern}“ Ihrer dauerhaften Zulassungsliste hinzu (~/.nunmai/config.yaml). Nunmai fragt bei solchen Befehlen nicht mehr nach – weder in dieser noch in zukünftigen Sessions.`,
  ...
  prompts: {
    gatewayDisconnected: 'Das Nunmai-Gateway ist nicht verbunden',
    reconnect: 'Neu verbinden',
    ...
    sudoDesc:
      'Nunmai benötigt Ihr Sudo-Passwort, um einen privilegierten Befehl auszuführen. Es wird nur an Ihren lokalen Agenten gesendet.',
    ...
    sudoInstallDesc:
      'Nunmai benötigt Ihr sudo-Passwort, um die Bot-Screen-Pakete (TigerVNC + Xfce) auf dem Gateway-Host zu installieren. Es wird nur an diesen Host gesendet.',
    sudoPlaceholder: 'Sudo-Passwort',
    secretTitle: 'Geheimnis erforderlich',
    secretDesc: 'Nunmai benötigt eine Zugangsdaten, um fortzufahren.',
    ...
    vaultSaveDesc: origin =>
      `Nunmai ist auf eine Anmeldeseite unter ${origin} gestoßen und hat dafür keinen Login. Geben Sie ihn einmal hier ein; er wird auf diesem Rechner verschlüsselt und in die Seite eingetragen, ohne dass das Modell das Passwort je sieht.`,
    ...
    vaultCodeDesc: site =>
      `${site} verlangt einen Einmalcode (SMS, E-Mail oder Authenticator-App). Geben Sie ihn hier ein, Nunmai trägt ihn in die Seite ein; das Modell sieht ihn nie.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tipp: Speichern Sie den Authentifizierungsschlüssel zusammen mit diesem Login unter Einstellungen → Passwörter & Logins, dann gibt Nunmai die Codes für Sie ein.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Starten Sie Nunmai Desktop neu, um „Bild speichern“ zu verwenden.',
    restartToSaveImages: 'Starten Sie Nunmai Desktop neu, um Bilder zu speichern',
    ...
    handoff: {
      ...
      timedOut: 'Zeitüberschreitung beim Warten auf das Gateway. Läuft `nunmai gateway`?',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'Skills sind Ordner mit Anweisungen, die Nunmai lädt, wenn die Arbeit danach verlangt.'
      },
      messaging: {
        title: 'Nunmai abseits Ihres Schreibtischs',
        text: 'Verbinden Sie Telegram, Discord, Slack und mehr – derselbe Agent, dasselbe Gedächtnis.'
      },
      artifacts: {
        title: 'Alles, was Nunmai gemacht hat',
      ...
      profiles: {
        ...
        text: 'Jedes ist sein eigenes Nunmai — eigene Schlüssel, eigenes Gedächtnis, eigene Sessions.'
      },
      'composer-mentions': {
