...
export const ru = defineLocale({
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      catalogSource: 'Из каталога, одобренного Nunmai',
  ...
  prompts: {
    ...
    sudoDesc:
      'Nunmai нужен ваш пароль sudo, чтобы выполнить команду с повышенными правами. Он отправляется только вашему локальному агенту.',
