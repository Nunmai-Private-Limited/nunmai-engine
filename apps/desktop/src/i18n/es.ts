...
export const es = defineLocale({
  ...
  connectors: {
    ...
    disclaimer: 'Conectar es opcional. Autoriza solo las apps que quieras que use Nunmai.',
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'En el catálogo de Nunmai',
    ...
    page: {
      ...
      noMatchBody: 'No hay coincidencias. Indica a Nunmai tu propio servidor MCP para añadirlo.',
      ...
      signInLine: 'Inicia sesión en Nunmai para usar las apps administradas.',
      ...
      disconnectNoAccount:
        'Nunmai no tiene ninguna cuenta que desconectar aquí. Actualiza la página e inténtalo de nuevo.',
      disconnectRefused:
        'Nunmai no pudo quitar este inicio de sesión ahora. Desactiva la app con el interruptor o inténtalo más tarde.'
    },
    add: {
    ...
    dialog: {
      ...
      disconnectBody: 'Nunmai deja de actuar con esta cuenta. Puedes volver a conectarla cuando quieras.',
      ...
      appSwitch: (name: string) => `Nunmai puede usar ${name}`,
      ...
      bothOn: (name: string) => `Ambos están activados, así que Nunmai ve cada herramienta de ${name} dos veces.`,
      ...
      nousLine: 'Las apps de Nunmai siguen a tu cuenta, no al perfil.',
      rulesReadOnly: 'Las reglas no se pueden cambiar ahora.',
      rulesAppOff: (name: string) => `Activa ${name} para cambiar sus herramientas.`,
      rulesSignIn: 'Inicia sesión para cambiar lo que Nunmai puede hacer aquí.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Lo que Nunmai puede hacer con ${name}`,
      summaryPreviewTitle: (name: string) => `Lo que Nunmai podría hacer con ${name} cuando lo conectes`,
      ...
      goneBody: 'Nunmai ya no puede llamarlo. La fila se queda hasta que la quites, así que nada desaparece.',
      remove: 'Quitar',
      ...
      signedOutTitle: 'Inicia sesión en Nunmai para leer la lista de herramientas.',
  ...
  sessionImport: {
    ...
    subtitle: 'Trae una conversación a Nunmai y retómala donde la dejaste.',
    ...
    chooseHelp: 'Elige una sesión para leer su historial antes de traerla a Nunmai.',
    ...
    you: 'Tú',
    snapshot: 'Esta conversación ya está en Nunmai. Abre tu copia existente para continuar.',
    copyNotice:
    ...
    open: 'Abrir en Nunmai',
    continue: 'Continuar en Nunmai',
  ...
  boot: {
    ready: 'Nunmai Desktop está listo',
    ...
    steps: {
      ...
      loadingSettings: 'Cargando la configuración de Nunmai',
      loadingSessions: 'Cargando sesiones recientes',
      retryingRemoteBackend: 'Reconectando al backend remoto de Nunmai…',
      startingDesktopConnection: 'Iniciando la conexión de escritorio',
      startingNunmaiDesktop: 'Iniciando Nunmai Desktop…'
    },
    errors: {
      backgroundExited:
      ...
      backgroundExitedDuringStartup: 'Nunmai se detuvo justo después de iniciarse.',
      backendStopped: 'Nunmai dejó de funcionar en segundo plano',
      restartNunmai: 'Reiniciar Nunmai',
      openLogs: 'Abrir registros',
      desktopBootFailed: 'Nunmai no pudo iniciarse',
      gatewayConnectionLost: 'Nunmai perdió la conexión',
      ...
      gatewaySignInRequired: 'Tu Nunmai remoto cerró tu sesión',
      ...
      ipcBridgeUnavailable: 'Nunmai Desktop no pudo comunicarse con su propia capa en segundo plano. Reinicia la app.'
    },
    causes: {
      exitedEarly: 'El servicio en segundo plano de Nunmai se detuvo justo después de iniciarse.',
      timedOut: 'El servicio en segundo plano de Nunmai no respondió a tiempo.',
      permission: 'Nunmai no pudo escribir en su carpeta de datos (problema de permisos).',
      diskFull: 'El disco está lleno, así que Nunmai no pudo iniciarse.',
      portInUse: 'Otro programa está usando el puerto de red que necesita Nunmai.',
      installMissing: 'Falta parte de la instalación de Nunmai. Elige Reparar instalación para restaurarla.'
    },
    failure: {
      title: 'Nunmai no pudo iniciarse',
      description:
        'El servicio en segundo plano de Nunmai no arrancó. Prueba uno de los pasos de recuperación de abajo. Nada de esto elimina tus chats ni tus ajustes.',
      details: 'Detalles',
      ...
      cloudDownTitle: 'El agente de Nunmai Cloud no está disponible',
      cloudDownDescription:
        'El agente en la nube administrado por Nunmai al que se conecta este gateway devuelve un error de servidor. No se puede reiniciar desde aquí: revisa su estado, cambia al gateway local o pide ayuda.',
      cloudDownHint:
        'Los botones de abajo abren el Nunmai Portal (estado y controles de la instancia) y nuestro Discord para obtener ayuda.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Tu backend de Nunmai es más antiguo que esta compilación de escritorio y puede no funcionar correctamente. Actualízalo para alinearlos.',
    installMethodUnsupportedTitle: 'Método de instalación no compatible',
    updateNunmai: 'Actualizar Nunmai',
    ...
    errors: {
      ...
      storageFailure: 'Nunmai no pudo guardar en su carpeta de datos. Abre Mantenimiento para comprobarla y repararla.',
      gatewayAuthFailed:
        'Este Nunmai ya no acepta tu inicio de sesión guardado. Abre Gateways y vuelve a iniciar sesión (o pega un nuevo token de acceso) e inténtalo otra vez.',
      methodNotAllowed:
        'El servicio en segundo plano de Nunmai no está sincronizado con la app, probablemente tras una actualización. Reinícialo para solucionarlo.',
      ...
      codeSkewRestartRequired:
        'Nunmai se actualizó, pero sigue ejecutando la versión anterior. Reinícialo para terminar la actualización.',
      rpcOutOfSync: 'La app y el backend están en versiones distintas. Actualiza ambos.',
      restartNunmaiFailed: 'No se pudo reiniciar Nunmai'
    },
    actions: {
      restartNunmai: 'Reiniciar Nunmai',
    ...
    voice: {
      ...
      liveDelegationFailed: 'No se pudo pasar la solicitud a Nunmai',
    ...
    native: {
      ...
      inputBody: 'Nunmai espera tu respuesta.',
      turnDoneTitle: 'Nunmai terminó',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleNous: 'Sin créditos de Nunmai',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'También puedes ejecutar `nunmai debug share --nous` desde una terminal, o `nunmai debug share --local` para mostrar el informe sin subirlo.',
    handoffLead: 'Continúa la conversación en:',
    links: {
      github: 'Issues de GitHub',
      portal: 'Soporte de Nunmai Portal',
      discord: 'Discord'
    }
  },
  titlebar: {
  ...
  settings: {
    ...
    resetConfirm: '¿Restablecer toda la configuración a los valores predeterminados de Nunmai?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Entrada del catálogo de Nunmai “${name}”: el componente del agente se instala en la versión fijada revisada${sha ? ` ${sha}` : ''}, no en la punta de la rama.`,
    ...
    vault: {
      ...
      otpHint:
        'La “clave de configuración” que muestra el sitio al activar la 2FA. Si la guardas, Nunmai genera los códigos por sí mismo.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `No detectado. Instala la herramienta de línea de comandos de ${name} e inicia sesión en ella; Nunmai la detectará automáticamente.`,
        disabledDesc: 'Detectado, pero desactivado para Nunmai.',
        lockedDesc:
          'Detectado. El agente te pedirá desbloquearlo cuando necesite un inicio de sesión, o puedes desbloquearlo ahora.',
        unlockedDesc:
          'Desbloqueado para esta sesión. Se bloquea automáticamente tras 30 minutos de inactividad o al cerrar Nunmai.',
    ...
    notifications: {
      ...
      focusedHint: 'Los avisos de finalización solo se activan cuando Nunmai está en segundo plano.',
      kinds: {
        approval: {
        ...
        input: {
          ...
          description: 'Nunmai hizo una pregunta o necesita una contraseña o un secreto.'
        },
        turnDone: {
          label: 'Respuesta lista',
          description: 'Terminó un turno mientras Nunmai estaba en segundo plano.'
        },
        turnError: {
        ...
        plugin: {
          ...
          description: 'Un complemento de escritorio envió una notificación mientras Nunmai estaba en segundo plano.'
        }
      },
    ...
    searchPlaceholder: {
      about: 'Acerca de Nunmai Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Elige un modo fijo o deja que Nunmai siga la configuración del sistema.',
      ...
      reactionsDesc:
        'Reacciones emoji estilo iMessage — reacciona a los mensajes, y Nunmai puede reaccionar a los tuyos.',
      tipsTitle: 'Consejos en la app',
      tipsDesc:
        'Sugerencias ocasionales de la app y de Nunmai. Cada consejo aparece una vez. Se desactiva automáticamente tras tus primeros 30 días; puedes volver a activarlo.',
      tipsReset: (count: number) => `Volver a mostrar ${count} ${count === 1 ? 'consejo' : 'consejos'}`,
      toursTitle: 'Recorridos guiados',
      toursDesc:
        'Deja que Nunmai resalte cada paso mientras te guía por la app. Se desactiva automáticamente tras tus primeros 30 días; puedes volver a activarlo.',
      ...
      pet: {
        title: 'Mascota',
        intro:
          'Adopta una mascota animada de petdex que flota sobre la app y reacciona a lo que hace Nunmai: corre mientras se ejecutan herramientas, celebra los éxitos y se entristece con los errores.',
        restartHint:
          'Las mascotas necesitan un reinicio rápido: la aplicación en ejecución se inició antes de que se añadiera esta función. Cierra y vuelve a abrir Nunmai y luego vuelve aquí.',
        scaleTitle: 'Tamaño',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Máximo de caracteres que Nunmai puede leer en una solicitud de archivo.',
      approvals: {
        mode: 'Cómo maneja Nunmai los comandos que necesitan aprobación explícita.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained: voz a texto → Nunmai → texto a voz con los proveedores de abajo. gpt-live: un modelo de voz full-duplex de OpenAI (gpt-live-1) escucha y habla, y pasa cada solicitud real a Nunmai; el modelo que hayas seleccionado responde con todas las herramientas. Requiere una clave API de OpenAI; la capa de voz cuesta 0,05 US$ por minuto.',
        gptLive: {
          voice: 'Voz del modo GPT-Live. Se aceptan ID de voz personalizados.',
          instructions:
            'Frases adicionales para la personalidad de voz en vivo (tono, ritmo, idioma). Nunmai mantiene su propio prompt de sistema.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Cuando Nunmai se actualiza desde la app sin prompt de terminal, conserva los cambios locales de código fuente (stash) o descártalos. Las actualizaciones desde terminal siempre preguntan.'
      }
    }),
    uninstallSection: {
      dangerZone: 'Zona de peligro',
      checkingInstalled: 'Comprobando lo que está instalado…',
      uninstallNunmai: 'Desinstalar Nunmai',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description: 'Quita esta app de escritorio. El agente de Nunmai, tu configuración y tus chats se conservan.',
        ...
        lite: {
          ...
          description:
            'Quita la app y el agente de Nunmai, pero conserva la configuración, los chats y los secretos para una futura reinstalación.',
          consequence:
            'la interfaz de chat y el agente de Nunmai (se conservan la configuración, los chats y los secretos)'
        },
        full: {
          ...
          consequence:
            'TODO: la interfaz de chat, el agente de Nunmai y toda tu configuración, chats, secretos y registros'
        }
      }
    },
    poolLimits: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'El entorno de ejecución de Nunmai se actualizó, pero la app de escritorio sigue siendo una compilación anterior: faltarán funciones nuevas de la interfaz (como el modo Bot) hasta que se actualice. Ejecuta la actualización de abajo para recompilar la app. Si eso no elimina este aviso, reinstala desde el instalador de escritorio más reciente.',
      bundleOutOfSyncAction: 'Obtener el instalador',
      bundleSwapPending: 'Reinicia para terminar la actualización',
      bundleSwapPendingDesc:
        'La app actualizada ya está instalada; Nunmai solo necesita reiniciarse para cargarla. Los chats y los ajustes no se tocan.',
      bundleSwapPendingAction: 'Reiniciar Nunmai',
      ...
      automaticUpdatesDesc:
        'Nunmai busca actualizaciones automáticamente en segundo plano y te avisa cuando hay una actualización lista.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Al minimizar las ventanas o cerrar la ventana principal, se ocultan en la bandeja del sistema (barra de menús en macOS) y Nunmai sigue ejecutándose. Usa Salir de Nunmai en el menú de la bandeja o Cmd+Q para salir. Desactivado por defecto; se aplica solo a este dispositivo.',
      ...
      loading: 'Cargando configuración de Nunmai...',
    ...
    hudModifier: {
      ...
      permission:
        'Permite Nunmai en Ajustes del Sistema → Privacidad y seguridad → Monitorización de entrada y vuelve a intentarlo. Este gesto no registra pulsaciones de teclas ni captura tu pantalla.',
      unavailable:
        'El asistente del gesto del HUD no pudo iniciarse o se detuvo de forma inesperada. Reinténtalo o reinicia Nunmai. El atajo del HUD existente sigue funcionando dentro de Nunmai.',
      missingHelper:
        'A esta instalación de Nunmai le falta el asistente del gesto del HUD. Actualiza o reinstala Nunmai y vuelve a intentarlo.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Pulsa las dos teclas Comando a la vez desde cualquier app para capturar su ventana frontal y adjuntarla a tu borrador actual de Nunmai. Nunca se envía automáticamente. Desactivado por defecto; se aplica solo a este Mac. El contenido de la ventana puede ser confidencial: revisa el adjunto antes de enviarlo.',
      ...
      inputPermission:
        'El permiso de Monitorización de entrada permite a Nunmai detectar las dos teclas Comando mientras otra app está activa. Permite Nunmai en Ajustes del Sistema → Privacidad y seguridad → Monitorización de entrada, vuelve aquí y reinténtalo.',
      screenPermission:
        'El permiso de Grabación de pantalla permite a Nunmai capturar la ventana frontal cuando usas este atajo. Permite Nunmai en Ajustes del Sistema → Privacidad y seguridad → Grabación de pantalla, vuelve aquí y reinténtalo. Reinicia Nunmai si macOS te lo pide.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Invoca un pequeño compositor desde cualquier lugar con un atajo global y envía un prompt sin abrir Nunmai.',
    ...
    connections: {
      ...
      intro:
        'Gestiona este dispositivo y cada gateway de Nunmai al que puede llegar mediante conexiones remotas, SSH o Cloud.',
      stagedNote:
      ...
      updateSkippedCloud: 'Administrado por Nunmai Cloud',
      kindLocal: 'Local',
      kindRemote: 'Gateway remoto',
      kindCloud: 'Nunmai Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'El entorno de ejecución de Nunmai administrado por esta app.',
      kindRemoteDesc: 'Un gateway de Nunmai accesible por HTTP(S): LAN, Tailscale o internet.',
      kindCloudDesc: 'Una instancia alojada detectada a través de tu cuenta de Nunmai Cloud.',
      kindSshDesc: 'Una instalación de Nunmai accesible por SSH.',
      labelTitle: 'Nombre',
      labelDesc:
      ...
      headersDesc:
        'Se envían con cada solicitud HTTP y WebSocket a este gateway, para proxies de acceso como Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Los valores se guardan cifrados. Se ignoran los encabezados que gestiona Nunmai (Authorization, Cookie, Host…).',
      ...
      cloudAddHint:
        'Consejo: al iniciar sesión en Nunmai Cloud arriba, tus agentes se detectan automáticamente; usa este formulario solo para registrar a mano la URL de una instancia conocida.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Los ajustes de conexión solo se pueden cambiar desde la app Nunmai Desktop en el equipo que la ejecuta.',
      title: 'Conexión del gateway',
      envOverride: 'anulación de entorno',
      intro:
        'Local por predeterminado. Usa remoto cuando esta app deba controlar un backend de Nunmai en otro lugar. Anulaciones por perfil a continuación.',
      envOverrideTitle: 'Esta conexión quedó fijada por la forma en que se inició Nunmai.',
      envOverrideDesc:
        'Un ajuste de inicio externo a la app eligió esta conexión, así que las opciones de abajo son de solo lectura. Reinicia Nunmai sin ese ajuste (o pregunta a quien lo configuró) para cambiarla aquí.',
      modeTitle: 'Modo de conexión',
      localTitle: 'Gateway local',
      localDesc:
        'Inicia un backend privado de Nunmai en localhost. Es el valor predeterminado y funciona sin conexión.',
      remoteTitle: 'Gateway remoto',
      remoteDesc: 'Conecta esta shell de escritorio a un backend remoto de Nunmai.',
      remoteAuthHint:
        'Los gateways alojados usan OAuth o usuario y contraseña; los autohospedados pueden usar un token de sesión.',
      cloudTitle: 'Nunmai Cloud',
      cloudDesc:
        'Inicia sesión una vez en Nunmai Cloud y elige uno de los agentes de tu cuenta; no tienes que pegar ninguna URL.',
      cloudSignInTitle: 'Nunmai Cloud',
      cloudSignIn: 'Iniciar sesión en Nunmai Cloud',
      cloudSignedIn: 'Sesión iniciada en Nunmai Cloud',
      cloudNeedsSignIn: 'Inicia sesión en Nunmai Cloud para descubrir los agentes de tu cuenta.',
      ...
      cloudDiscoverFailed: 'No se pudieron cargar tus agentes de Nunmai Cloud',
      cloudConnectFailed: 'No se pudo conectar con ese agente',
      cloudSignInFailed: 'Falló el inicio de sesión en Nunmai Cloud',
      cloudSignedOutTitle: 'Sesión cerrada en Nunmai Cloud',
      cloudSignedOutMessage: 'Se borró la sesión de Nunmai Cloud.',
      ...
      remoteUrlDesc: 'URL base del backend del dashboard remoto. Se admiten prefijos de ruta, por ejemplo /nunmai.',
      probing: 'Comprobando cómo se autentica este gateway…',
      probeError:
        'Nunmai no puede llegar a esa dirección. Comprueba la URL y que el otro equipo esté ejecutando Nunmai; las opciones de inicio de sesión aparecen cuando responde.',
      ...
      restartingMessage: 'Nunmai Desktop se reconectará con los ajustes guardados.',
      savedMessage: 'Guardado para el próximo reinicio.',
      connectedTo: (baseUrl, version) => `Conectado a ${baseUrl}${version ? ` · Nunmai ${version}` : ''}`,
      ...
      sshDesc:
        'Nunmai se inicia en el equipo remoto mediante SSH y se conecta a esta app a través de un túnel; no tienes que iniciar ni exponer nada por tu cuenta. Requiere acceso SSH mediante claves que ya funcione con el host.',
      sshTrustHint:
      ...
      sshNunmaiPathTitle: 'Ruta de Nunmai (opcional)',
      sshNunmaiPathDesc: 'Ruta completa al binario remoto de Nunmai. En blanco = detección automática.',
      sshNunmaiPathPlaceholder: 'detección automática',
      sshTestConnection: 'Probar SSH',
      sshConnect: 'Conectar',
      sshButtonsHint: 'Guardar se aplica en el próximo inicio. Conectar vuelve a conectar ahora.',
      sshReachable: (host, platform) => `Accesible: ${host} (${platform}) — se encontró Nunmai`,
      ...
      sshErrAuth:
        'Falló la autenticación SSH. Carga tu clave en ssh-agent (ssh-add) o configura un IdentityFile en ~/.ssh/config; Nunmai ejecuta SSH de forma no interactiva.',
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        'Nunmai no está instalado en el host remoto. Instálalo allí (curl -fsSL https://nunmai-engine.nunmai.in/install.sh | sh) o indica la ruta de Nunmai.',
      sshErrPlatform:
        'Plataforma remota no compatible. El modo SSH de Nunmai Desktop admite hosts remotos Linux, macOS y Windows.',
      sshErrTimeout: 'La conexión SSH agotó el tiempo de espera. Es posible que el host no responda o esté en reposo.',
      sshErrUpdateRequired: 'Actualiza Nunmai en el host remoto antes de conectarte con Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'Un enlace pidió añadir este servidor MCP a Nunmai. Revisa la configuración exacta de abajo: viene del enlace, no de Nunmai.',
    ...
    model: {
      ...
      moaTitle: 'Nunmai Agent',
      moaPreset: 'Preajuste',
      moaDescription:
        'Configura preajustes con nombre que aparecen como modelos del proveedor Nunmai Agent. El agregador es el modelo que actúa: ejecuta cada paso del bucle de herramientas, y casi todo el coste de la ejecución se factura a su proveedor. Por defecto, las referencias solo asesoran una vez por turno del usuario.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Compilación ${tag}, backend ${backend}. Nunmai inicia y gestiona el servidor por ti.`,
    ...
    billing: {
      ...
      freeTier: {
        signIn: 'Iniciar sesión',
        title: 'Estás en el plan gratuito de Nunmai',
        message: 'Inicia sesión con una cuenta de Nunmai para desbloquear más modelos y herramientas.',
        caption:
      ...
      state: {
        notice: {
          loggedOut: {
            title: 'Conecta tu cuenta de Nunmai',
            message: 'Inicia sesión con tu cuenta de Nunmai para ver aquí tu saldo, plan y uso.',
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'El gasto remoto está desactivado para esta cuenta; un administrador de facturación puede activarlo desde la página de Nunmai Engine del portal.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        'Inicia sesión con una suscripción, sin copiar claves API. Nunmai ejecuta el inicio de sesión del navegador por ti, aquí mismo en la app.',
      connected: 'Conectado',
      collapse: 'Contraer',
      ...
      localEndpoint: {
        ...
        description:
          'Conecta Nunmai con cualquier endpoint compatible con OpenAI (Zyphra, vLLM, llama.cpp, Ollama, etc.).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Incluido con una suscripción de Nunmai: inicia sesión con tu cuenta de Nunmai para activarlo.',
      nousAuthNeededTitle: 'Inicia sesión con tu cuenta de Nunmai',
      ...
      nousAuthDoneTitle: 'Cuenta de Nunmai conectada',
      nousAuthDoneMessage: 'Los backends de tu suscripción ya están activos.',
      nousAuthFailed: 'No se completó el inicio de sesión en Nunmai',
      ...
      terminalBackend: {
        ...
        unavailableMessage: (backend: string) =>
          `Nunmai no puede ejecutar comandos de shell ahora mismo: ${backend} no está listo. Cambia a Local o termina de configurar ${backend} y vuelve a intentarlo.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Deja que Nunmai navegue con una instantánea de tu perfil predeterminado del navegador, para que los sitios se abran con la sesión ya iniciada.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Puedes restaurarlo con nunmai curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Nunmai (predeterminado)',
      kindAgent: 'Agente',
      ...
      legacyBackend:
        'Este backend es anterior a los interruptores de plugins por clave: actualiza Nunmai para gestionarlo aquí.',
      ...
      catalogProvenance: (sha: string) =>
        `Instalado desde el catálogo de Nunmai${sha ? ` en el commit fijado ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D no está en el catálogo de plugins de Nunmai. No se instaló nada.`,
      deepLinkCatalogUnavailable:
        'No se pudo cargar el catálogo de plugins de Nunmai. Comprueba tu conexión y vuelve a abrir el enlace.',
  ...
  starmap: {
    ...
    emptyDesc: 'A medida que Nunmai crea skills y memorias para tu trabajo, aparecerán aquí.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Reinicia Nunmai para usar mascotas; el backend es anterior a esta función.',
    ...
    generatePet: {
      ...
      staleBackend: 'Actualiza Nunmai para generar mascotas.',
      backgroundHint: 'Puedes cerrar esto; Nunmai te avisará cuando termine.',
    ...
    nav: {
      ...
      settings: {
        title: 'Configuración',
        detail: 'Configura Nunmai Desktop'
      },
      capabilities: {
        title: 'Capacidades',
    ...
    nunmaiActiveSessions: (version, count) => `Nunmai ${version} · Sesiones activas ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: 'Nunmai no pudo reiniciarse para aplicar tu configuración de mensajería',
    ...
    telegramQr: {
      ...
      subtitle:
        'Ambas opciones conectan un bot que controlas y guardan sus credenciales solo en esta instalación de Nunmai.',
      quickSetup: 'Configuración rápida',
      recommended: 'Recomendado',
      quickHelp:
        'Escanea un código QR y confirma en Telegram. Nunmai crea el bot y detecta tu ID de usuario de Telegram automáticamente.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: {
        ...
        placeholder: '@nunmai:example.org'
      },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description:
        'Las sesiones de este perfil se ejecutarán en el Nunmai remoto que indiques, en lugar de en este equipo.',
      urlLabel: 'Dirección remota',
      urlPlaceholder: 'https://nunmai.example.com',
    ...
    defaultDescription:
      'Se usa al abrir Nunmai y para los chats nuevos. Las sesiones existentes se quedan en sus perfiles.',
    ...
    deleting: 'Eliminando...',
    createDesc: 'Los perfiles son entornos independientes de Nunmai: configuración, skills y SOUL.md separados.',
    nameLabel: 'Nombre',
  ...
  modelAssignment: {
    saveFailed: 'Nunmai no guardó ese cambio de modelo.',
  ...
  cron: {
    ...
    emptyDescNew:
      'Programa un prompt para ejecutarlo con una expresión cron. Nunmai lo ejecutará y entregará los resultados al destino que elijas.',
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Nunmai no puede leer todo el historial de sesiones de ${profiles}. Los chats que faltan en esta lista no se eliminaron; el archivo donde se guardan está dañado.`,
      action:
        'Sal de Nunmai en este perfil y luego inspecciona el archivo sin modificarlo, o restaura una instantánea:',
    ...
    projects: {
      ...
      staleBackend:
        'Actualiza el backend de Nunmai para crear proyectos: tu backend es más antiguo que esta aplicación de escritorio (Configuración → Actualizaciones → Backend).',
      deleteConfirm:
        'Esto elimina el proyecto guardado de Nunmai. Los archivos, los repositorios de git y los árboles de trabajo permanecen intactos.',
      ...
      worktreeStaleBackend:
        'Actualiza el backend de Nunmai para crear worktrees por esta conexión remota: es anterior a la API de git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'Iniciando Nunmai...',
    placeholderReconnecting: 'Reconectando con Nunmai…',
    placeholderFollowUp: 'Enviar seguimiento',
    newSessionPlaceholders: [
      '¿Qué vamos a construir?',
      'Dale una tarea a Nunmai',
      '¿Qué tienes en mente?',
    ...
    voiceEngineChained: 'Voz a texto + voz de Nunmai',
    voiceEngineLive: 'GPT-Live (full-duplex, delega en Nunmai)',
    ...
    commandDescs: {
      ...
      '/goal': 'Fijar un objetivo permanente en el que Nunmai trabaja durante varios turnos hasta cumplirlo',
      ...
      '/plan': 'Escribir un plan de implementación en markdown en .nunmai/plans/ sin ejecutar nada',
      '/moa': 'Ejecutar un prompt con el preajuste predeterminado de Nunmai Agent y luego restaurar tu modelo',
      ...
      '/profile': 'Cambiar el perfil activo de Nunmai',
      ...
      '/subscription': 'Ver tu plan de Nunmai y cambiarlo en el navegador',
      '/topup': 'Mostrar tu saldo de Nunmai y gestionar la facturación en el portal',
      '/platform': 'Pausar, reanudar o listar una plataforma del gateway que falla',
      '/version': 'Mostrar la versión de Nunmai Engine',
    ...
    attachUrlDesc: 'Nunmai obtendrá la página y la incluirá como contexto para este turno.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Pedir a Nunmai que abra un PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Casi listo…',
      pydeps: 'Terminando…',
      update: 'Actualizando Nunmai…',
      rebuild: 'Reconstruyendo la aplicación de escritorio…',
      restart: 'Reiniciando Nunmai…',
    ...
    unsupportedMessage: 'Esta versión de Nunmai no puede actualizarse desde la app.',
    connectionRetry:
      'Nunmai no pudo llegar al servidor de actualizaciones. Comprueba tu conexión a internet y vuelve a intentarlo. Si usas un Nunmai remoto, asegúrate de que esté en línea.',
    gitUnusable: 'Nunmai no pudo ejecutar Git en este equipo, así que no pudo buscar actualizaciones.',
    connectionSettings: 'Configuración de conexión',
    ...
    availableBody: 'Hay una nueva versión de Nunmai lista para instalar.',
    availableTitleBackend: 'Actualización del backend disponible',
    availableBodyBackend:
      'Hay una versión más reciente del backend de Nunmai al que estás conectado lista para instalar.',
    ...
    manualBody:
      'Instalaste Nunmai desde la línea de comandos, así que las actualizaciones también se ejecutan ahí. Pega esto en tu terminal:',
    manualPickedUp: 'Nunmai usará la nueva versión la próxima vez que lo abras.',
    guiSkewTitle: 'Actualiza la aplicación de escritorio',
    guiSkewBody:
      'El backend se actualizó, pero el paquete de esta aplicación de escritorio no cambió. Actualiza o reinstala la aplicación de escritorio de Nunmai (tu AppImage / .deb / .rpm) para que coincidan.',
    copy: 'Copiar',
    copied: 'Copiado',
    done: 'Listo',
    applyingBody:
      'El actualizador de Nunmai tomará el control en su propia ventana y volverá a abrir Nunmai al terminar.',
    applyingBodyBackend:
      'El backend remoto está aplicando la actualización y se reiniciará. Nunmai se reconectará automáticamente cuando vuelva a estar disponible.',
    applyingClose: 'Nunmai se cerrará para aplicar la actualización.',
    errorTitle: 'La actualización no terminó',
    errorBody: 'No pasa nada: no se perdió nada. Puedes intentarlo de nuevo ahora.',
    blockerTitle: '¿Cerrar las vistas previas locales para actualizar Nunmai?',
    blockerBody:
      'Nunmai necesita detener estas vistas previas locales antes de actualizar. Esto no modifica ni elimina tus archivos.',
    foreignBlockerTitle: 'Cierra otros procesos para actualizar Nunmai',
    foreignBlockerBody:
      'Nunmai no puede cerrar estos procesos automáticamente de forma segura. Cierra la app, el terminal o el servicio al que pertenece cada uno y vuelve a intentar la actualización.',
    mixedBlockerBody:
      'Nunmai puede cerrar las vistas previas locales que se indican abajo. Los demás procesos deben cerrarse manualmente antes de continuar con la actualización.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Nunmai está a un clic',
    stayText: 'Cambia al perfil de configuración y abre Bienvenida a Nunmai siempre que necesites ayuda. Se queda ahí.'
  },
  guidedGreeting: {
    line: 'Hola, pasa. Soy Nunmai. Dame dos minutos para prepararlo todo a tu medida y luego me pondremos a trabajar en algo que de verdad quieras hacer.\n\nPero antes, ¿cómo quieres que te llame?',
  ...
  install: {
    ...
    oneTimeTitle: 'Nunmai necesita una instalación única',
    ...
    setupChoiceTitle: 'Configurar Nunmai Desktop',
    setupChoiceDesc:
      'Conecta esta app con un gateway de Nunmai que ya esté en ejecución o instala Nunmai localmente en este equipo.',
    connectExistingTitle: 'Conectar con un Nunmai existente',
    ...
    installLocalTitle: 'Instalar Nunmai localmente',
    installLocalDesc: 'Descarga Nunmai, crea su entorno de Python y ejecuta el backend en este equipo.',
    localStartUnavailable: 'No se pudo iniciar la instalación local. Reinicia Nunmai Desktop e inténtalo de nuevo.',
    remoteSetupTitle: 'Conectar con un Nunmai existente',
    remoteSetupDesc:
      'Introduce la URL de tu gateway. Nunmai Desktop detectará si necesita un token o iniciar sesión en el navegador.',
    remoteUrlTitle: 'URL del gateway',
    remoteUrlDesc: 'Usa la URL base del gateway de Nunmai e incluye https:// si es remoto.',
    ...
    settingUpTitle: 'Configurando Nunmai Engine',
    finishingTitle: 'Terminando',
    failedDesc:
      'Uno de los pasos de configuración no terminó. Puede ocurrir si hay otra copia de Nunmai en ejecución, se cortó la conexión a internet o un antivirus bloqueó el instalador. Cierra las demás ventanas de Nunmai y elige Recargar y reintentar. Si vuelve a fallar, abre los registros y envíalos al soporte.',
    activeDesc:
      'Esta configuración se realiza una sola vez. El instalador de Nunmai está descargando dependencias y configurando tu máquina. Los siguientes inicios omitirán este paso.',
  ...
  onboarding: {
    headerTitle: 'Vamos a configurar Nunmai Engine',
    headerDesc: 'Conecta un proveedor de modelo para empezar a chatear. La mayoría de opciones requieren un clic.',
    preparingInstall: 'Nunmai está terminando la instalación. En el primer inicio suele tardar menos de un minuto.',
    starting: 'Iniciando Nunmai…',
    ...
    recommended: 'Recomendado',
    connected: 'Conectado',
    featuredPitch: 'Una suscripción, más de 300 modelos frontier: la forma recomendada de usar Nunmai',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'autohospedado',
        description:
          'Apunta Nunmai a un endpoint local o autohospedado compatible con OpenAI (vLLM, llama.cpp, Ollama, etc.).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Abre una página de verificación en tu navegador; Nunmai se conecta automáticamente',
    ...
    authorizeThere: 'Autoriza Nunmai allí.',
    ...
    autoBrowser: provider =>
      `Abrimos ${provider} en tu navegador. Autoriza Nunmai allí y te conectarás automáticamente; no hay nada que copiar o pegar.`,
  ...
  freeTier: {
    providerRowTitle: 'Nunmai · plan gratuito',
    providerRowPitch: 'Inicia sesión con una cuenta de Nunmai para desbloquear más modelos y herramientas.',
    readyTitle: 'Nunmai está listo.',
    readyCaption: 'Gratis · conectores incluidos',
    begin: 'Empezar',
    signInInstead: 'Iniciar sesión con una cuenta de Nunmai',
    otherProviders: 'Otros proveedores',
    ...
    dismiss: 'Descartar',
    providerName: 'Nunmai',
    statusLabel: (model: string) => `Nunmai · ${model}`,
    signIn: 'Iniciar sesión',
    signInHeading: 'Inicia sesión con una cuenta de Nunmai para desbloquear más modelos y herramientas.',
    ...
    rejectedBody: 'No pasa nada, sigues en el servicio gratuito de Nunmai. Inicia sesión cuando quieras.',
    supersededBody:
    ...
    retiredBody:
      'Tu sesión terminó antes de completar el inicio de sesión. Nunmai iniciará una nueva; luego vuelve a iniciar sesión cuando quieras.',
    ...
    busyBody: (wait: string) =>
      `Nunmai no pudo terminar de iniciar tu sesión porque el servicio de Nunmai está ocupado. Vuelve a intentarlo en ${wait}. Mientras tanto, tu sesión sigue aquí.`,
    unreachableBody:
      'Nunmai no pudo llegar al servicio de Nunmai para terminar de iniciar tu sesión. Comprueba tu conexión a internet y vuelve a intentarlo. Tu sesión sigue aquí.',
    alreadySignedInHeading: 'Ya has iniciado sesión.',
    alreadySignedInBody: 'Este Nunmai ya tiene la sesión iniciada en una cuenta de Nous.',
    setupFailed: {
      gateClosed:
        'Esta versión de Nunmai no puede iniciarse sin una cuenta de Nunmai. Inicia sesión o crea una: es gratis y solo lleva un minuto.',
      paused:
        'El uso de Nunmai sin iniciar sesión está en pausa por un momento. Nunmai seguirá comprobándolo. Iniciar sesión es gratis y te permite empezar ahora mismo.',
      rateLimited: (wait: string) =>
        `Mucha gente está empezando ahora mismo, así que Nunmai volverá a intentarlo en ${wait}. Iniciar sesión es gratis y te ahorra la espera.`,
      unreachable:
        'Nunmai no pudo llegar al servicio de Nunmai. Comprueba tu conexión a internet y pulsa Reintentar. O conecta otro proveedor por ahora.',
      serverError:
        'El servicio de Nunmai tuvo un fallo. Pulsa Reintentar en un momento o conecta otro proveedor por ahora.',
      powRequired:
        'El servidor de Nunmai pidió una prueba de trabajo, pero tu agente todavía no la implementa. Inicia sesión o crea una cuenta gratuita de Nunmai para continuar.',
      locked:
        'Esta sesión no puede continuar sin iniciar sesión. Inicia sesión o crea una cuenta gratuita de Nunmai para seguir.',
      generic:
        'Nunmai no pudo configurar el acceso gratuito sin iniciar sesión. Iniciar sesión es gratis; también puedes conectar otro proveedor.',
      signInBelow: 'Iniciar sesión es gratis. Elige Nunmai abajo.',
      tryAgain: 'Reintentar',
      retrying: 'Reintentando…'
    }
  },
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Los modelos Pro necesitan una suscripción de Nunmai de pago.',
    free: 'Gratis',
    freeTier: 'Nivel gratis',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} pesa ${size}. Nunmai solo mostrará los primeros 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Intentar de nuevo',
      restarting: 'Nunmai se está reiniciando...',
      askRestart: 'Pedir a Nunmai que reinicie el servidor',
      lookingRestart: taskId => `Nunmai está buscando un servidor de vista previa para reiniciar (${taskId})`,
      restartingTitle: 'Reiniciando servidor de vista previa',
      restartingMessage:
        'Nunmai está trabajando en segundo plano. Mira la consola de vista previa para ver el progreso.',
      ...
      blankPageBody: 'Escribe una dirección arriba para navegar o pide a Nunmai que abra una página.',
      finishedRestarting: message =>
        `Nunmai terminó de reiniciar el servidor de vista previa${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nunmai no pudo reiniciar el servidor.',
      stillWorking:
        'Nunmai sigue trabajando, pero aún no llegó ningún resultado de reinicio. Puede que el comando del servidor siga en primer plano.',
  ...
  interfaceMode: {
    ...
    hint: 'Cambia lo que se muestra, no lo que Nunmai puede hacer.',
    sessionNote:
      'Definido por el modo Simple. Un cambio aquí dura esta sesión; cambia a Avanzado para que sea permanente.',
    simple: {
      label: 'Simple',
      description: 'Para hablar con Nunmai. Barra lateral y chat; sin paneles de terminal, archivos ni diferencias.'
    },
    advanced: {
      label: 'Avanzado',
      description:
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nunmai está cargando una respuesta',
      ...
      errorLayers: {
        ...
        gateway: 'Nunmai tuvo un problema',
        generic: 'Nunmai no pudo terminar esta respuesta',
        provider: 'El servicio de IA devolvió un error',
        runtime: 'Nunmai tuvo un problema',
      ...
      errorLayerBodies: {
        ...
        disk: 'Tu disco está lleno, así que Nunmai no pudo guardar esta conversación. Libera espacio y reinténtalo.',
        endpoint:
          'Nunmai no puede conectar con tu servidor de modelos personalizado. Comprueba que esté en ejecución y vuelve a enviar el mensaje.',
        gateway:
          'Nunmai tuvo un problema interno al iniciar esta respuesta. Vuelve a enviar el mensaje; si sigue ocurriendo, envía un diagnóstico.',
        generic: 'Algo salió mal mientras Nunmai respondía. Reinténtalo o copia los detalles si sigue ocurriendo.',
        provider:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: (provider: string) =>
            `Nunmai no pudo verificar la conexión segura con ${provider}. Revisa la configuración de red o del proxy, o cambia de proveedor, y vuelve a enviar el mensaje.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: (provider: string) => `${provider} devolvió algo que Nunmai no pudo leer. Reinténtalo en un momento.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Nunmai se quedó atascado en un bucle',
          body: 'La respuesta repetía los mismos pasos, así que Nunmai la detuvo. Reinténtalo o empieza un chat nuevo si vuelve a ocurrir.'
        },
        SESSION_NOT_OWNED: {
          title: 'Este chat está abierto en otro sitio',
          body: 'Este chat está abierto en otra ventana de Nunmai o en un terminal. Ciérralo allí y vuelve a enviar el mensaje, o empieza un chat nuevo aquí.'
        },
        disk_full: {
          title: 'Disco lleno',
          body: 'Tu disco está lleno, así que Nunmai no pudo guardar esta conversación. Libera espacio y reinténtalo.'
        },
        free_tier_disabled: {
          title: 'El uso de Nunmai sin iniciar sesión está desactivado ahora mismo',
          body: 'Inicia sesión con una cuenta de Nunmai para seguir chateando; es gratis.'
        },
        free_tier_rate_limited: {
          title: 'Agotaste el cupo para chatear sin iniciar sesión',
          body: 'Se renueva en breve. Inicia sesión con una cuenta de Nunmai para tener un cupo mayor; es gratis.'
        },
        ...
        free_tier_model_not_free: {
          ...
          body: 'Por ahora Nunmai usa el modelo gratuito. Inicia sesión con una cuenta de Nunmai para tener más modelos; es gratis.'
        },
        free_tier_route: {
          title: 'Nunmai no pudo llegar al modelo gratuito por esta ruta',
          body: 'Inicia sesión con una cuenta de Nunmai (es gratis) o revisa el ajuste NOUS_INFERENCE_BASE_URL.'
        },
        free_tier_outage: {
        ...
        free_tier_refused: {
          title: 'Nunmai no pudo enviarlo sin iniciar sesión',
          body: 'Iniciar sesión con una cuenta de Nunmai es gratis.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: 'Nunmai no pudo terminar la respuesta',
      ...
      errorOpenNunmaiFolder: 'Abrir la carpeta de Nunmai',
      errorOpenNunmaiFolderFailed: 'No se pudo abrir la carpeta de Nunmai',
      errorUpdateApiKey: 'Actualizar clave API',
      errorSignInAgain: (provider: string) => `Volver a iniciar sesión en ${provider}`,
      errorSignInFreeTier: 'Iniciar sesión con una cuenta de Nunmai',
    ...
    approval: {
      gatewayDisconnected:
        'Nunmai está sin conexión ahora mismo. El comando sigue esperando tu respuesta (hasta que se agote el tiempo de aprobación). Reconéctate y vuelve a enviarla.',
      sendFailed: 'No se pudo enviar tu respuesta',
      reconnect: 'Reconectar',
      timedOutSystemLine:
        'Se agotó el tiempo de aprobación: el comando no se ejecutó. Pide a Nunmai que lo intente de nuevo o sube el límite en Configuración → Seguridad → Tiempo de aprobación.',
      ...
      alwaysDescription: pattern =>
        `Esto añade el patrón “${pattern}” a tu allowlist permanente (~/.nunmai/config.yaml). Nunmai no volverá a preguntar por comandos como este, ni en esta sesión ni en futuras.`,
      alwaysAllow: 'Permitir siempre'
    },
    clarify: {
      notReady: 'La solicitud de aclaración aún no está lista',
      gatewayDisconnected: 'Nunmai está sin conexión ahora mismo. Reconéctate y vuelve a enviarlo.',
  ...
  prompts: {
    ...
    sudoInstallDesc:
      'Nunmai necesita tu contraseña de sudo para instalar los paquetes de Bot Screen (TigerVNC + Xfce) en el host del gateway. Solo se envía a ese host.',
    sudoPlaceholder: 'contraseña sudo',
    secretTitle: 'Se requiere un secreto',
    secretDesc: 'Nunmai necesita una credencial para continuar.',
    ...
    vaultSaveDesc: (origin: string) =>
      `Nunmai llegó a una página de inicio de sesión en ${origin} y no tiene un acceso para ella. Introdúcelo una vez aquí; se cifra en este equipo y se rellena en la página sin que el modelo vea nunca la contraseña.`,
    ...
    vaultCodeDesc: (site: string) =>
      `${site} pide un código de un solo uso (SMS, correo o app de autenticación). Introdúcelo aquí y Nunmai lo escribe en la página; el modelo nunca lo ve.`,
    vaultCodeLabel: 'Código',
    vaultCodeFootnote:
      'Consejo: guarda la clave del autenticador con este acceso en Configuración → Contraseñas e inicios de sesión y Nunmai introducirá los códigos por ti.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Reinicia Nunmai Desktop para usar Guardar imagen.',
    restartToSaveImages: 'Reinicia Nunmai Desktop para guardar imágenes',
    ...
    handoff: {
      ...
      timedOut:
        'Nunmai no pudo llegar a tu conexión de mensajería. Iníciala desde Configuración → Mensajería y vuelve a intentar el traspaso.',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'Las skills son carpetas de instrucciones que Nunmai carga cuando el trabajo las necesita.'
      },
      messaging: {
        title: 'Nunmai lejos de tu escritorio',
        text: 'Conecta Telegram, Discord, Slack y más: el mismo agente, la misma memoria.'
      },
      artifacts: {
        title: 'Todo lo que ha creado Nunmai',
      ...
      profiles: {
        ...
        text: 'Cada uno es su propio Nunmai: sus propias claves, su propia memoria, sus propias sesiones.'
      },
      'composer-mentions': {
