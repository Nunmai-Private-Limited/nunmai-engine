...
import { McpSetupButton } from '@/plugins/nunmai-bots/mcp-setup'
import { AdvancedProfileConfig, applyAdvancedConfig, emptyAdvancedState } from '@/plugins/nunmai-bots/profile-config'
