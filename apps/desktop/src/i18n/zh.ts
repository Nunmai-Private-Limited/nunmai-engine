...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsTitle: '应用内提示',
      tipsDesc: '指向应用某处的小气泡：空闲时偶尔出现，需要时 Nunmai 也会给你一条。每条提示只出现一次。',
      tipsReset: (count: number) => `再次显示 ${count} 条提示`,
      toursTitle: '引导导览',
      toursDesc: '让 Nunmai 带你熟悉应用：调暗界面并逐步高亮每个位置。',
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `正在运行 llama.cpp ${tag}（${backend}）——Nunmai 提供的最新构建。`,
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: 'Nunmai 需要你的 sudo 密码来运行特权命令。它只会发送给你的本地 agent。',
