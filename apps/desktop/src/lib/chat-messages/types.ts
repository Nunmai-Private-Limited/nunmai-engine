...
import { type BillingBlock, type PersistedTurn, type ToolLabel } from '@nunmai/shared'

import type { ErrorSurface } from '@/lib/error-surface'
import type { ToolResultMetadata } from '@/lib/tool-result-metadata'
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/nunmai'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @nunmai/shared BillingBlock).
