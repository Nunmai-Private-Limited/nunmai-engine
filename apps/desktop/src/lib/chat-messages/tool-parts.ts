import type { ToolLabel } from '@nunmai/shared'
...
import type { SessionMessage, StoredToolCallLabels } from '@/types/nunmai'
 ...
 * emits one constant id for every call and Nunmai' own deterministic ids
...
export function applyStoredToolResultToParts(
  ...
  // Tool-call ids are not unique across turns (llama.cpp/Nunmai reuse them),
