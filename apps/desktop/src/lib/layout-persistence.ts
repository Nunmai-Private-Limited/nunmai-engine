...
export const LAYOUT_KEYS = {
  floating: 'nunmai.desktop.floatingPanes.v1',
  tree: 'nunmai.desktop.layoutTree.v2',
  preset: 'nunmai.desktop.layoutPreset.active',
  panes: 'nunmai.desktop.paneStates.v1',
  dismissed: 'nunmai.desktop.dismissedPanes.v1',
  shares: 'nunmai.desktop.paneShare.v1',
  hiddenTabs: 'nunmai.desktop.hiddenStripTabs.v1',
  placed: 'nunmai.desktop.userPlacedPanes.v1',
  flipped: 'nunmai.desktop.panesFlipped',
  collapsed: 'nunmai.desktop.collapsedTreeSides.v1'
} as const

function migrateLayoutScopes(initialMode: InterfaceMode) {
  const marker = 'nunmai.desktop.layoutModeScopes.v1'
