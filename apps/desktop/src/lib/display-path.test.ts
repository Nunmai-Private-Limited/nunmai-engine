...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/nunmai-engine')).toBe('~/www/nunmai-engine')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/nunmai-engine')).toBe('nunmai-engine')
    expect(pathLeaf('~/www/nunmai-engine')).toBe('nunmai-engine')
