...
import type { ModelOptionsResponse, SessionInfo } from '@/types/nunmai'
 ...
 *
 * Only the leading status prefix (e.g. "Nunmai is thinking...") and the
 ...
 *  resolved comment as JSON (NunmaiPrComment shape); a malformed payload falls
