/**
 * The curated Nunmai plugin catalog as the Desktop sees it.
 *
 ...
 * `plugin-catalog/` directory at site build). A `nunmai://plugin/install?catalog=<name>`
...
export const CATALOG_ORIGIN = 'https://nunmai.in'
