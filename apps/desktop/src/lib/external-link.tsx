...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|nunmai):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.nunmaiDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.nunmaiDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Nunmai, and it is the surface the agent
