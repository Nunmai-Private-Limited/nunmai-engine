import { DEFAULT_REASONING_EFFORT, isReasoningEffort, type ReasoningEffort } from '@nunmai/shared'
...
/**
 * A pick the route does not send verbatim: `ultra` is a Nunmai-internal step
 ...
 *  never presents a Nunmai step as a wire level the route does not have. */
