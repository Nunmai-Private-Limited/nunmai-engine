...
const originalNunmaiDesktop = desktopWindow.nunmaiDesktop
...
afterEach(() => {
  ...
  if (originalNunmaiDesktop) {
    desktopWindow.nunmaiDesktop = originalNunmaiDesktop
  } else {
...
describe('WslgWindowControls', () => {
  it('routes minimize, maximize and close through the desktop bridge', () => {
    desktopWindow.nunmaiDesktop = { windowControls } as unknown as Window['nunmaiDesktop']
