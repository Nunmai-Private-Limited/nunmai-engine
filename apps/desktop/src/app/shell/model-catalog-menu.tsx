import type { ModelOptionProvider, ModelOptionsResult } from '@nunmai/shared'
import { DEFAULT_REASONING_EFFORT } from '@nunmai/shared'
 ...
 * Returning `{}` is fine — the row then shows Nunmai' defaults.
 */
