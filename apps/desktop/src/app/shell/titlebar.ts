...
export interface TitlebarChromeContext {
  ...
  windowButtonPosition?: NunmaiConnection['windowButtonPosition']
}
...
export function titlebarControlsPosition(
  windowButtonPosition: NunmaiConnection['windowButtonPosition'] | undefined,
  isFullscreen = false
) {
...
export const TITLEBAR_CHROME_CHANGED_EVENT = 'nunmai:titlebar-chrome-changed'
