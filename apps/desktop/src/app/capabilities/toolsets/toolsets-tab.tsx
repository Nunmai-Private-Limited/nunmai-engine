...
import { type ProfileScope, setToolsetEnabled } from '@/nunmai'
...
import type { ToolsetInfo } from '@/types/nunmai'
...
const $toolsetsSortDesc = persistentAtom('nunmai.desktop.capabilities.toolsetsSortDesc', true, Codecs.bool)
