...
import type { OfficialSkillInfo, SkillInfo } from '@/types/nunmai'
...
const $skillsSortDesc = persistentAtom('nunmai.desktop.capabilities.skillsSortDesc', true, Codecs.bool)
