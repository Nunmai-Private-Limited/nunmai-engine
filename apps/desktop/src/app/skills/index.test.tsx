...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'nunmai-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://nunmai.in'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { nunmaiDesktop?: unknown }).nunmaiDesktop = { connections, getAgentRoster }
