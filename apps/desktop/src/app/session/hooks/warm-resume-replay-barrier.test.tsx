import { type GatewayEvent, JsonRpcGatewayClient } from '@nunmai/shared'
...
import type { SessionMessage, SessionResumeResult } from '@/types/nunmai'

import { useMessageStream } from './use-message-stream'
import { useSessionActions } from './use-session-actions'
import { useSessionStateCache } from './use-session-state-cache'

vi.mock('@/nunmai', async original => ({
