import type { GatewayEvent, PersistedTurn } from '@nunmai/shared'
...
export interface GatewayEventDeps {
  ...
  refreshNunmaiConfig: () => Promise<void>
...
export interface GatewayEventContext {
  ...
  /** Coalesced trailing refreshNunmaiConfig (one per session.info burst). */
