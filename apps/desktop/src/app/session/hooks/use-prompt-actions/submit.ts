import type { PromptSubmitResult } from '@nunmai/shared'
import { type MutableRefObject, useCallback } from 'react'

import { PROMPT_SUBMIT_REQUEST_TIMEOUT_MS } from '@/nunmai'
    ...
    async (rawText: string, options?: SubmitTextOptions) => {
      ...
      try {
        ...
        const submitParams = (targetId: string) => ({
          ...
          // rather than at Nunmai. The gateway turns this into a per-turn hint
