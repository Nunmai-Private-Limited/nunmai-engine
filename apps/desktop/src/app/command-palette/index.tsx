...
import { getNunmaiConfigRecord, listAllProfileSessions } from '@/nunmai'
...
// Nunmai session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-nunmai',
            keywords: ['update', 'upgrade', 'nunmai', 'version', 'system', 'restart'],
            label: cc.updateNunmai,
