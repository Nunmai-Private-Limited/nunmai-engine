...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/nunmai'
...
const VERSION = 3
const PREFIX = 'HML' // "Nunmai Memory Loadout" — namespaces our codes like WoW's leading bytes.
