...
import { getLatestSessionMessages, type ProfileScope } from '@/nunmai'
...
interface BackgroundSyncParams {
  ...
  refreshNunmaiConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshNunmaiConfig])
}
