...
const desktopWindow = window as unknown as { nunmaiDesktop: unknown }
const originalBridge = desktopWindow.nunmaiDesktop
...
afterEach(() => {
  ...
  desktopWindow.nunmaiDesktop = originalBridge
})
