...
import { setNunmaiConfigCache, useNunmaiConfigRecord } from '../hooks/use-config-record'
...
function fontFamilyFromConfig(config: NunmaiConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useNunmaiConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<NunmaiConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setNunmaiConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="nunmai-terminal-font-families"
          ...
          <datalist id="nunmai-terminal-font-families">
