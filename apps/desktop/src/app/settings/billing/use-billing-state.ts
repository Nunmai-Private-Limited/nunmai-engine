  ...
  if (!billing.logged_in || subscription?.logged_in === false) {
    return {
      notice: {
        ...
        message: 'Run /portal in the TUI or open the Nunmai portal to connect your account.',
        title: 'Connect your Nunmai account'
      },
      status: 'logged_out',
      summary: emptySummary(),
      tiers: [],
...
function freeTierView(billing: BillingStateResponse): BillingView {
  return {
    notice: {
      ...
      message: 'Sign in with a Nunmai account to unlock more models and tools.',
      title: "You're on the Nunmai free tier",
      tone: 'info'
    },
    plan: {
      caption:
      ...
      tierName: 'Nunmai · free tier'
    },
    planFootnote:
      'The free tier has no balance and nothing to pay. Payment and usage appear when you sign in with a Nunmai account.',
    status: 'free_tier',
    summary: [
