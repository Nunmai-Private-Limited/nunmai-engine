...
it.each(['gui', 'lite', 'full'] as const)(
  ...
  async mode => {
    ...
    vi.stubGlobal('nunmaiDesktop', {
      uninstall: { summary: async () => ({ agent_installed: true, running_app_path: '/fixture/Nunmai.app' }), run }
    })
    render(
    ...
    await screen.findByText(zh.uninstallNunmai)
