...
export const SETTINGS_MANIFEST = {
  appearance: {
    ...
    minimizeToTray: {
      ...
      available: () => Boolean(window.nunmaiDesktop?.minimizeToTray),
  ...
  keybinds: {
    hudModifier: {
      ...
      available: () => Boolean(window.nunmaiDesktop?.hudModifier),
    ...
    screenshot: {
      ...
      available: () => Boolean(window.nunmaiDesktop?.screenshot),
