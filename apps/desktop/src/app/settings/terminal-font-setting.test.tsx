...
vi.mock('@/nunmai', () => ({
  saveNunmaiConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setNunmaiConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useNunmaiConfigRecord: () => ({ data: mocks.loadedConfig, dataUpdatedAt: mocks.configUpdatedAt })
}))
