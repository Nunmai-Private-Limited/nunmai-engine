...
import { type DroppedFile, extractDroppedFiles, NUNMAI_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, NUNMAI_PATHS_MIME) ? 'files' : null
