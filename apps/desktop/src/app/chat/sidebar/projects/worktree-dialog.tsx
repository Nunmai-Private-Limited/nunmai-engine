...
import type { NunmaiGitBranch } from '@/global'
...
const branchActionLabel = (branch: NunmaiGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<NunmaiGitBranch[]>([])
  ...
  const convert = async (branch: NunmaiGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
