...
import type { ProjectInfo, SessionInfo } from '@/nunmai'
 ...
 * repo shows its branches/worktrees even when they have no Nunmai sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: NunmaiGitWorktree[]
): SidebarSessionGroup[] {
