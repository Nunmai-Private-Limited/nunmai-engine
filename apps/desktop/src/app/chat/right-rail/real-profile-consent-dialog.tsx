...
import { saveNunmaiConfigRecord } from '@/nunmai'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config, writeScope } = useNunmaiConfigRecord()
  const setConfig = nunmaiConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveNunmaiConfigRecord({ browser: { use_real_profile: true } }, writeScope)
