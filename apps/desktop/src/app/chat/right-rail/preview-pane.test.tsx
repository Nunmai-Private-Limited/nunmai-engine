...
describe('PreviewPane console state', () => {
  ...
  it('continues comment numbering in one conversation and resets it when the conversation changes', async () => {
    ...
    const previousDesktop = window.nunmaiDesktop
    let captureCount = 0
    ...
    window.nunmaiDesktop = previousDesktop
  })
...
describe('PreviewPane guest external handoff', () => {
  ...
  // reaches the OS browser only through the audited `nunmai:openExternal` IPC.
  ...
  async function renderWebview() {
    ...
    desktopWindow.nunmaiDesktop = { openExternal } as unknown as Window['nunmaiDesktop']
