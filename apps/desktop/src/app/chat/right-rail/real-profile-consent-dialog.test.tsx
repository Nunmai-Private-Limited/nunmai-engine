...
vi.mock('@/nunmai', () => ({
  saveNunmaiConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let Nunmai browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  nunmaiConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useNunmaiConfigRecord: () => ({ data: mocks.loadedConfig })
}))
