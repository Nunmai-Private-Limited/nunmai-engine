...
const FOCUS_EVENT = 'nunmai:composer-focus'
const INSERT_EVENT = 'nunmai:composer-insert'
const INSERT_REPLY_EVENT = 'nunmai:composer-insert-reply'
const ATTACH_IMAGES_EVENT = 'nunmai:composer-attach-images'
const INSERT_REFS_EVENT = 'nunmai:composer-insert-refs'
const SUBMIT_EVENT = 'nunmai:composer-submit'
const VOICE_TOGGLE_EVENT = 'nunmai:composer-voice-toggle'
const DICTATION_EVENT = 'nunmai:composer-dictation'
const MODEL_MENU_EVENT = 'nunmai:composer-model-menu'
...
const GET_DRAFT_EVENT = 'nunmai:composer-get-draft'
const SET_DRAFT_EVENT = 'nunmai:composer-set-draft'
const DRAFT_REPLY_EVENT = 'nunmai:composer-draft-reply'
