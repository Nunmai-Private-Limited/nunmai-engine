import type { NunmaiReviewFile } from '@/global'
...
export function buildReviewFlatList(files: NunmaiReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: NunmaiReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
