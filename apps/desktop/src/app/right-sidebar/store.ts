...
const TAKEOVER_KEY = 'nunmai.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Nunmai can't clear via the API — the user
 *  sees exactly what runs instead of Nunmai silently deleting their creds. */
