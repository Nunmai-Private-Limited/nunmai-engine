...
import { capabilityScoped, nunmaiApi, type OwnerScope, ownerScoped, type ProfileScope, profileScoped } from './client'
...
export function runDoctor(): Promise<ActionResponse> {
  return nunmaiApi<ActionResponse>({ ...profileScoped(), path: '/api/ops/doctor', method: 'POST', body: {} })
}
