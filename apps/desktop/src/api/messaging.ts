...
export function getMessagingPlatforms(profile?: null | string): Promise<MessagingPlatformsResponse> {
  return nunmaiApi<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return nunmaiApi<MessagingPlatformUpdateResponse>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return nunmaiApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function startTelegramOnboarding(
  ...
  return nunmaiApi<TelegramOnboardingStartResponse>({
    ...profileScoped(profile),
...
export function getTelegramOnboardingStatus(
  ...
  return nunmaiApi<TelegramOnboardingStatusResponse>({
    ...profileScoped(profile),
...
export function applyTelegramOnboarding(
  ...
  return nunmaiApi<TelegramOnboardingApplyResponse>({
    ...scope,
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return nunmaiApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return nunmaiApi<{ ok: boolean; user: PairingUser }>({
    ...scope,
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return nunmaiApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return nunmaiApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return nunmaiApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return nunmaiApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
