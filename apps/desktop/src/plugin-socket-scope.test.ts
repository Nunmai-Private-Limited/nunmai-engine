...
// (#73044). Exercises the REAL nunmai + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/nunmai')
...
const conn = (over: Partial<NunmaiConnection> = {}): NunmaiConnection =>
  ({
    authMode: 'oauth',
