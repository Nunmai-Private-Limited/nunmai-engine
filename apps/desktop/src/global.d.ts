...
declare global {
  interface Window {
    nunmaiDesktop: {
      ...
      getConnection: (profile?: string | null) => Promise<NunmaiConnection>
      ...
      // Local AGENT-plugin root (<NUNMAI_HOME>/plugins), same Electron-local
...
export interface NunmaiNotification {
  title?: string
  body?: string
  silent?: boolean
  kind?: string
