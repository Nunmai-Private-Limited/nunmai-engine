 ...
 *    the primary profile surfaced as @default instead of @nunmai;
 ...
 *    kanban/tool workers count too (nunmai-engine#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @nunmai, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('nunmai')
