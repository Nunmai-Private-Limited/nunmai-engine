...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/nunmai-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'nunmai_cli/config_defaults.py'), 'utf8')
