...
import { atom, host, useValue } from '@nunmai/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @nunmai, never @default (#89484).
 ...
 *  (nunmai-engine#90268). Older gateways omit worker_session — always false. */
