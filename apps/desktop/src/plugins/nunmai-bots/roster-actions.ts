...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@nunmai/plugin-sdk'
 ...
 *  (nunmai-engine#90102) and are discarded. Without `canonical_session` (older
