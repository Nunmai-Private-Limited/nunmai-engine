...
import { type PluginLocaleBundles, type PluginTranslate, usePluginI18n } from '@nunmai/plugin-sdk'
...
const en: BotsMessages = {
  editor: {
    fullConfigHint: 'Full configuration needs a newer gateway (restart it after updating Nunmai).',
    ...
    newerDesktop: 'Skills need a newer Nunmai Desktop.',
    newerGateway: 'Capability catalog needs a newer gateway (restart it after updating Nunmai).',
    ...
    noImageModel:
      'No image model available. If you just enabled one (or updated Nunmai), restart the gateway: Ctrl+K → "Restart gateway".',
  ...
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update Nunmai and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    attentionMissingConfig: 'Provider not configured — run nunmai model',
    ...
    openAnotherChatUnsupported: 'Update Nunmai Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update Nunmai Desktop to chat with bots on other connections.',
    openNeedsUpdateTitle: 'This bot lives on an older Nunmai',
    openNeedsUpdateMessage: connectionLabel => `Update ${connectionLabel}, then try again.`,
    openUnreachableTitle: 'Nunmai couldn’t reach the computer this bot runs on',
  ...
  screen: {
    ...
    installHint: 'Runs on the gateway host as the user Nunmai runs as; sudo is asked for once, through Nunmai.',
    ...
    portalUnavailable: 'Update the bot\u2019s Nunmai to use Screen',
    unavailableTitle: 'Screen needs a newer Nunmai',
    ...
    openNeedsUpdate: 'Update Nunmai Desktop to open bot screens.',
...
const ja: BotsMessages = {
  editor: {
    fullConfigHint: 'すべての設定を使うには新しいゲートウェイが必要です（Nunmai 更新後に再起動してください）。',
    ...
    newerDesktop: 'スキルには新しい Nunmai Desktop が必要です。',
    newerGateway: '機能カタログには新しいゲートウェイが必要です（Nunmai 更新後に再起動してください）。',
    ...
    noImageModel:
      '画像モデルがありません。有効にした直後や Nunmai 更新後の場合は、Ctrl+K →「ゲートウェイを再起動」で再起動してください。',
  ...
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、Nunmai を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    attentionMissingConfig: 'プロバイダーが未設定です — nunmai model を実行してください',
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには Nunmai Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには Nunmai Desktop を更新してください。',
    openNeedsUpdateTitle: 'このボットは古い Nunmai 上で動いています',
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} を更新してから、もう一度お試しください。`,
    openUnreachableTitle: 'このボットが動いているコンピューターに Nunmai が接続できませんでした',
  ...
  screen: {
    ...
    installHint:
      'Nunmai を実行しているユーザーとしてゲートウェイホスト上で実行されます。sudo は Nunmai 経由で一度だけ求められます。',
    install: 'ホストにインストール',
    installing: 'インストール中…',
    ...
    portalUnavailable: 'Screen を使うにはボットの Nunmai を更新してください',
    unavailableTitle: 'Screen には新しい Nunmai が必要です',
    ...
    openNeedsUpdate: 'ボットの画面を開くには Nunmai Desktop を更新してください。',
    youControl: 'あなたが操作中',
...
const zh: BotsMessages = {
  editor: {
    fullConfigHint: '完整配置需要更新网关（更新 Nunmai 后请重启网关）。',
    ...
    newerDesktop: '技能功能需要更新的 Nunmai Desktop。',
    newerGateway: '能力目录需要更新的网关（更新 Nunmai 后请重启网关）。',
    ...
    noImageModel: '没有可用的图像模型。如果刚启用模型或更新了 Nunmai，请重启网关：Ctrl+K →“重启网关”。',
  ...
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 Nunmai 并重启网关。`,
  ...
  bot: {
    ...
    attentionMissingConfig: '未配置提供商 — 请运行 nunmai model',
    ...
    openAnotherChatUnsupported: '请更新 Nunmai Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 Nunmai Desktop 以与其他连接上的机器人聊天。',
    openNeedsUpdateTitle: '这个机器人运行在较旧的 Nunmai 上',
    openNeedsUpdateMessage: connectionLabel => `请更新 ${connectionLabel}，然后重试。`,
    openUnreachableTitle: 'Nunmai 无法连接到运行这个机器人的电脑',
  ...
  screen: {
    ...
    installHint: '在网关主机上以运行 Nunmai 的用户身份执行；sudo 只会通过 Nunmai 询问一次。',
    install: '安装到主机',
    installing: '正在安装…',
    ...
    portalUnavailable: '更新机器人的 Nunmai 以使用屏幕',
    unavailableTitle: '屏幕需要更新版的 Nunmai',
    ...
    openNeedsUpdate: '更新 Nunmai Desktop 以打开机器人屏幕。',
    youControl: '你正在控制',
...
const zhHant: BotsMessages = {
  editor: {
    fullConfigHint: '完整設定需要更新閘道（更新 Nunmai 後請重新啟動閘道）。',
    liveCapabilities: '功能（立即生效 — 技能、工具、MCP）',
    ...
    newerDesktop: '技能功能需要更新的 Nunmai Desktop。',
    newerGateway: '功能目錄需要更新的閘道（更新 Nunmai 後請重新啟動閘道）。',
    ...
    noImageModel: '沒有可用的影像模型。如果剛啟用模型或更新了 Nunmai，請重新啟動閘道：Ctrl+K →「重新啟動閘道」。',
  ...
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 Nunmai 並重新啟動閘道。`,
  ...
  bot: {
    ...
    attentionMissingConfig: '未設定供應商 — 請執行 nunmai model',
    ...
    openAnotherChatUnsupported: '請更新 Nunmai Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 Nunmai Desktop 以與其他連線上的機器人聊天。',
    openNeedsUpdateTitle: '這個機器人運行在較舊的 Nunmai 上',
    openNeedsUpdateMessage: connectionLabel => `請更新 ${connectionLabel}，然後再試一次。`,
    openUnreachableTitle: 'Nunmai 無法連線到運行這個機器人的電腦',
  ...
  screen: {
    ...
    installHint: '在閘道主機上以執行 Nunmai 的使用者身分執行；sudo 只會透過 Nunmai 詢問一次。',
    install: '安裝到主機',
    installing: '安裝中…',
    ...
    portalUnavailable: '更新機器人的 Nunmai 以使用螢幕',
    unavailableTitle: '螢幕需要較新版的 Nunmai',
    ...
    openNeedsUpdate: '更新 Nunmai Desktop 以開啟機器人螢幕。',
    youControl: '你正在控制',
...
export function useBots(): BotsText {
  const t = usePluginI18n('nunmai-bots')
