...
import type { NunmaiPlugin, PaletteContribution } from '@nunmai/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@nunmai/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: NunmaiPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
