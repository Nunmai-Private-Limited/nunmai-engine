...
// v1 (`nunmai.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'nunmai.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'nunmai.desktop.statusbarHidden'
// v1 (`nunmai.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'nunmai.desktop.statusbarVisible.v2'
