...
export const RECOVERY_ACTIONS = {
  ...
  restartNunmai: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartNunmai'),
 ...
 *  (`nunmai_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartNunmai()
  },
  {
