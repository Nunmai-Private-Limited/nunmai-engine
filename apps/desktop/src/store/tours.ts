 ...
 * unlike tips there is no ambient half to separate out — every tour is Nunmai
...
export const $toursEnabled = persistentAtom('nunmai.desktop.tours.v1', true, Codecs.bool)
