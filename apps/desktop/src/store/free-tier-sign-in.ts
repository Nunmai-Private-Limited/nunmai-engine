...
import { cancelOAuthSession, listOAuthProviders, pollOAuthSession, startOAuthLogin } from '@/nunmai'
...
// unreachable or refused mid sign-in (`nunmai_cli/anon_sign_in.py`). Anything
...
/**
 * Drive one sign-in attempt end to end: resolve what identity this Nunmai is
...
export async function beginFreeTierSignIn(requestGateway: FreeTierRequester) {
  ...
  // No free-tier identity AND a real Nunmai account already connected: there is
