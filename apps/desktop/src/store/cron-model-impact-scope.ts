...
function identityForConnection(connection: NunmaiConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: NunmaiConnection | null): void {
