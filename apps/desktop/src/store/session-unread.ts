...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('nunmai.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('nunmai.desktop.unreadFinishedSessions')
