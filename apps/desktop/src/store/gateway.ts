import { type ConnectionState, type GatewayEvent, registryBackendScopeKey, resolveGatewayWsUrl } from '@nunmai/shared'
...
export function setPrimaryGatewayConnection(connection: Pick<NunmaiConnection, 'connectionId'> | null): void {
...
export async function ensureActiveGatewayOpen(): Promise<NunmaiGateway | null> {
  if (g.activeKey === g.primaryProfile) {
    return g.primaryGateway
  }
