 ...
 * - It covers Nunmai too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('nunmai.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('nunmai.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('nunmai.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'nunmai.desktop.tips.next.v1',
  null,
