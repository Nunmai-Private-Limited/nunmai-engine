...
export interface ComposerAttachment {
  ...
  thumbnailUrl?: string
  path?: string
  /** Bounded source text from a Nunmai-generated large paste, sent only to the title path. */
  titlePreview?: string
...
export const SESSION_DRAFTS_STORAGE_KEY = 'nunmai:composer-drafts:v3'
 ...
 */
const DRAFT_SYNC_EVENT = 'nunmai:composer-draft-sync'
