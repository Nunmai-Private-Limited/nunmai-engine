...
import { getNunmaiConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/nunmai'
...
const SNOOZE_KEY_PREFIX = 'nunmai:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getNunmaiConfigRecord()
  } catch {
