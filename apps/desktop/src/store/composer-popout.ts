...
const POPOUT_STORAGE_KEY = 'nunmai.desktop.composerPopout.window.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'nunmai.desktop.composerPopout.gesturesEnabled'
const ZONES_STORAGE_KEY = 'nunmai.desktop.composerPopout.zones.v1'
const LEGACY_ENABLED_KEY = 'nunmai.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'nunmai.desktop.composerPopout.position'
