...
function installBridge(
  openSessionWindow?: Window['nunmaiDesktop']['openSessionWindow'],
  openWindow?: Window['nunmaiDesktop']['openWindow'],
  openBrowserWindow?: Window['nunmaiDesktop']['openBrowserWindow']
) {
