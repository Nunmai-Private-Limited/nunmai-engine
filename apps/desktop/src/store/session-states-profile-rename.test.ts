...
describe('migrateTilesForProfile', () => {
  ...
  it('moves tabs, bot tiles, cached tails, remembered ids and owner hints to the new profile name', async () => {
    ...
    storage.writeJson('nunmai.desktop.sessionTiles.v2', {
      webdesign_bhp: [
    ...
    storage.writeJson('nunmai.desktop.sessionOwnerHints.v1', [
    ...
    const tiles = storage.readJson<Record<string, Tile[]>>('nunmai.desktop.sessionTiles.v2')
