...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://nunmai.example.com:8443/x')).toBe('nunmai.example.com:8443')
    expect(remoteHostLabel('https://nunmai.example.com:443')).toBe('nunmai.example.com')
    expect(remoteHostLabel('http://nunmai.example.com:80')).toBe('nunmai.example.com')
  })
