...
const TOOL_VIEW_TECHNICAL_STORAGE_KEY = 'nunmai.desktop.toolView.technical'
const HIDE_CODE_DIFFS_STORAGE_KEY = 'nunmai.desktop.toolView.hideCodeDiffs'
const TOOL_DISCLOSURE_STORAGE_KEY = 'nunmai.desktop.toolDisclosure.v1'
