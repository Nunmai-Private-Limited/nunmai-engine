...
export interface PetInfo {
  ...
  // the Nunmai "run" activity state uses the in-place running row).
 ...
 * NUNMAI_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'nunmai.desktop.pet-roam.v1'
