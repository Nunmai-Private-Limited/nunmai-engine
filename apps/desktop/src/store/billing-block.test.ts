import type { BillingBlock } from '@nunmai/shared'
...
test('runBillingRecovery routes Nunmai to in-app Settings, never an external link', () => {
  runBillingRecovery(makeBlock({ is_nous: true, provider: 'nous', provider_label: 'Nunmai Portal' }))
