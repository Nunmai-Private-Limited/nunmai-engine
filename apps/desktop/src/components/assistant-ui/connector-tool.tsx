...
import type { ConnectionTargetState, ConnectorsConnectResult } from '@nunmai/shared'
...
/** The browser leg of a connection came back through `nunmai://connections/done`. Show the session
          ...
          const action =
            phase.verb === 'none'
              ...
              : {
                  ...
                  onClick: () => {
                    if (phase.verb === 'open' && target.connectUrl && window.nunmaiDesktop?.openExternal) {
                      void window.nunmaiDesktop.openExternal(target.connectUrl)
