...
const STORAGE_KEY = 'nunmai.desktop.layoutTree.v2'

writeKey('nunmai.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('nunmai.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('nunmai.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'nunmai.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'nunmai.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'nunmai.desktop.hiddenStripTabs.v1'
...
writeKey('nunmai.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__NUNMAI_LAYOUT_TREE__ = {
    close: closeTreePane,
