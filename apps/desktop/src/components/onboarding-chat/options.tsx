...
// Connectors are the apps Nunmai reads and acts on for the user. Chat channels
// (Discord, Telegram, WhatsApp) are how a user talks to Nunmai; those live on
...
// the active skin as soon as the swatch is clicked. Nunmai blue is the default
...
export const accentsFor = (dark: boolean): Array<{ hex: string; name: string }> => [
  ...
  { hex: NOUS_ACCENT, name: 'Nunmai blue' },
...
// place a single question can answer both: someone here to talk to Nunmai
...
export const LAYOUTS: Array<{ description: string; id: string; mode: InterfaceMode; name: string; tree: MiniNode }> = [
  {
    description: 'For talking to Nunmai.',
    id: 'sidebar-left',
    mode: 'simple',
    name: 'Basic',
