...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelPricing } from '@/types/nunmai'
...
export function ModelPickerDialog({
  ...
  // the `nunmai model` CLI picker, which shows the curated list verbatim.
