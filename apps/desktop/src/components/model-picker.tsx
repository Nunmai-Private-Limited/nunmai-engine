import type { ModelOptionProvider, ModelPricing } from '@nunmai/shared'
import { fuzzyRank, modelSearchText } from '@nunmai/shared'
import { useStore } from '@nanostores/react'
import { useQuery } from '@tanstack/react-query'
import { useEffect, useMemo, useRef, useState } from 'react'

import { getLocalModelsStatus } from '@/nunmai'
...
import type { LocalModelLoadProgress } from '@/types/nunmai'
...
export function ModelPickerDialog({
  ...
  // it: an empty query shows the curated list verbatim (like the `nunmai
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // Two different facts wear the same badge: `free_tier` is a signed-in Nunmai
