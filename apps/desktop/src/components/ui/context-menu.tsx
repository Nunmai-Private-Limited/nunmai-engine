...
export const NUNMAI_CONTEXT_MENU_TRIGGER_ATTR = 'data-nunmai-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-nunmai-context-menu-trigger="" />
  )
}
