  ...
  it('preserves the stores existing persistence schema', () => {
    ...
    expect(writes).toEqual(
      expect.arrayContaining([
        ['nunmai.desktop.sessionListDensity', 'detailed'],
        ['nunmai.desktop.tabStripDefault', 'never'],
        ['nunmai.desktop.backdrop.v1', 'true'],
        ['nunmai.desktop.intro-splash.v1', 'false'],
        ['nunmai.desktop.reasoning.collapsedByDefault', 'true'],
        ['nunmai.desktop.composerPopout.gesturesEnabled', 'false']
      ])
    )
  })
