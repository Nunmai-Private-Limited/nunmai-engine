...
export const host = {
   ...
   *  components that take a `NunmaiGateway` prop directly (e.g. `McpTab`),
...
/** Nunmai' reasoning levels + their compact labels, so a plugin surfacing a
...
export type { RpcEvent, StatusResponse } from '@/types/nunmai'
