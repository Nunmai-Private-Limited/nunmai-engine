...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @nunmai/plugin-sdk (+ react), never `@/…`
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@nunmai/shared'],
              message: 'Plugins import only @nunmai/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
