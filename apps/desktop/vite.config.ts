...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\nunmai\nunmai-engine\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@nunmai/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@nunmai/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@nunmai/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@nunmai/shared': path.resolve(__dirname, '../shared/src'),
