...
cd apps/desktop
XCURSOR_SIZE=24 NUNMAI_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=$HOME/.nunmai/cache/scratch/nunmai-typing
# → ~/.nunmai/cache/scratch/nunmai-typing.cpuprofile  (open in Chrome DevTools Performance)
# → ~/.nunmai/cache/scratch/nunmai-typing.before.heapsnapshot
# → ~/.nunmai/cache/scratch/nunmai-typing.after.heapsnapshot
```
