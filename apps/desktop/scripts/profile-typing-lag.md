...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/nunmai-typing
# → /tmp/nunmai-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/nunmai-typing.before.heapsnapshot
# → /tmp/nunmai-typing.after.heapsnapshot
```
