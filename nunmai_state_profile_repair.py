...
``nunmai sessions repair-profiles`` (#88715 PR-6).
...
(``nunmai_cli/sessions_repair_profiles.py``).
...
from nunmai_state_common import _id_chunks, _placeholders as _session_ids_placeholders
