...
Data file: $NUNMAI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NUNMAI_HOME = Path(os.environ.get("NUNMAI_HOME", Path.home() / ".nunmai"))
DATA_DIR = _NUNMAI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
