...
Example:
    python generate_meme.py drake ~/.nunmai/cache/scratch/meme.png "Writing tests" "Shipping to prod and hoping"
    python generate_meme.py "Disaster Girl" ~/.nunmai/cache/scratch/meme.png "Top text" "Bottom text"
