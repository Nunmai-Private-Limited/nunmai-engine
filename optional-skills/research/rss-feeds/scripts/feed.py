...
Standard library only, so it runs in any Nunmai environment without an install
...
USER_AGENT = "nunmai-engine/1.0 (rss-feeds skill; +https://github.com/Nunmai-Private-Limited/nunmai-engine)"
TIMEOUT = 20
NS = {
