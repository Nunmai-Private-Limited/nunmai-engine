...
DEFAULT_UA = (
    "nunmai-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/hermes-agent; "
    "set NUNMAI_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("NUNMAI_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
