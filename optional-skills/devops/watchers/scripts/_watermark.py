...
def _state_dir() -> Path:
    ...
    # Default: $NUNMAI_HOME/watcher-state/, falling back to ~/.nunmai/watcher-state/.
    nunmai_home = os.environ.get("NUNMAI_HOME") or str(Path.home() / ".nunmai")
    return Path(nunmai_home) / "watcher-state"
