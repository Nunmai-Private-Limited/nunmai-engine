...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("NUNMAI_HOME", os.path.expanduser("~/.nunmai")), "skills/security/godmode/scripts/auto_jailbreak.py")
    )).read())
...
try:
    ...
    _SKILL_DIR = Path(os.getenv("NUNMAI_HOME", Path.home() / ".nunmai")) / "skills" / "security" / "godmode"
