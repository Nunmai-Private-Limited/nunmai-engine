...
def get_process_nunmai_home() -> Path:
    ...
    return Path(val) if val else _get_platform_default_nunmai_home()


# get_default_nunmai_root() memo keyed on (native home, NUNMAI_HOME) so it stays
# fresh when a test or plugin mutates NUNMAI_HOME; saves ~80us/call at 31+ sites.
