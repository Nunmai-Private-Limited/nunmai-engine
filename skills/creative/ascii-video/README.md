...
Built for [Nunmai Engine](https://github.com/Nunmai-Private-Limited/nunmai-engine). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes-agent/skills/creative/ascii-video`](https://github.com/Nunmai-Private-Limited/nunmai-engine/blob/main/skills/creative/ascii-video) via PR.
