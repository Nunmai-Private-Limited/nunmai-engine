...
Registry of record: `nunmai_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Nunmai config+state snapshots (CLI)
...
/update                  Update Nunmai to latest
