/**
 * Nunmai desktop plugin template. Save as:
 *   <nunmai home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <nunmai home> is ~/.nunmai by default, or ~/.nunmai/profiles/<name>
 * when running a named profile (`nunmai -p <name>`). Run `nunmai doctor` (or
 ...
 * Only these imports resolve: @nunmai/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@nunmai/plugin-sdk'
