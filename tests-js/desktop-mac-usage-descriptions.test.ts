 ...
 *
 * Each entry is a key/value pair that lands in the packaged Nunmai.app's
 ...
 * "Nunmai wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Nunmai wants to access Music" when Nunmai never touches the Music
