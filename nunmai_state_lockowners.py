...
open-descriptor scan (``nunmai_state_holders``) cannot tell a reader from the one writer: every
Nunmai process has the DB open. SQLite's unix VFS takes ``fcntl`` byte-range locks whose offsets
