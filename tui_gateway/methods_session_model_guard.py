...
permissive wherever Nunmai cannot know better — see ``models_validate.static_model_provider_conflict``.
"""
...
def model_override_conflict(params: dict, build_scope) -> dict | None:
    ...
    if not model:
        return None
    from nunmai_cli.models_validate import static_model_provider_conflict
