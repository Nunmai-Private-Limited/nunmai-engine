...
def _default_registry_path() -> Path:
    return get_nunmai_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_nunmai_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_nunmai_home = expected_nunmai_home if expected_nunmai_home is not None else str(get_nunmai_home())
    ...
    def _validate_hello(self) -> None:
        ...
        if got_home and got_home != self.expected_nunmai_home:
            raise RuntimeError(f"compute host NUNMAI_HOME mismatch: {got_home} != {self.expected_nunmai_home}")
