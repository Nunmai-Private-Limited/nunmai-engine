...
Data-building lives in agent/billing_view.py + nunmai_cli/nous_billing.py.
...
def _serialize_billing_state(state, *, free_tier: bool = False) -> dict:
    ...
    Nunmai free tier: no account, no balance, nothing to pay; the renderer branches on it before
    ``logged_in``."""
    from agent.billing_view import format_money
    from nunmai_cli.anon_auth import GUEST_MODEL
