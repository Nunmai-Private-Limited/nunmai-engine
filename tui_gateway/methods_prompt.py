...
def _(rid, params: dict) -> dict:
    ...
    # over another app when they are back in Nunmai.
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # NUNMAI_HOME override (the ContextVar set on the session-create
            ...
            home_token = (
                set_nunmai_home_override(_profile_home_str)
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # the session's NUNMAI_HOME override (the ContextVar set on the
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Nunmai
