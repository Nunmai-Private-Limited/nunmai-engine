...
class SkinPayload(OpenPayload):
    """``tui_gateway/change_watcher.py::resolve_skin`` — the resolved active skin (``NunmaiSkin``).
...
class SetupReadyPayload(OpenPayload):
    """``nunmai_cli/free_tier_bootstrap.py::SetupRecord.as_payload``."""
