...
class CatalogAppState(WireEnum):
    """The desktop app a catalog plugin drives, from its ``nunmai_platform`` declaration."""
...
method("connectors.operation.wake", params=ConnectionOperationParams, result=ConnectionWakeResult,
       doc="The browser leg came back (nunmai://connections/done): read the accounts now, not at the next tick.")
