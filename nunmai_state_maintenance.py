...
# caplog tests pin the "nunmai_state" logger name.
...
def _cwd_prefix_filter(value: str) -> Tuple[List[str], list]:
    from nunmai_state_sessions import _cwd_prefix_clause
...
class SessionMaintenanceMixin:
    ...
    def vacuum(self) -> int:
        ...
        with self._lock:
            ...
            # PASSIVE, not TRUNCATE: a manual `nunmai sessions vacuum` runs in a transient CLI
    ...
    def maybe_auto_prune_and_vacuum(
        ...
        """
        from nunmai_state_repair import _release_auto_maintenance_lock, _try_acquire_auto_maintenance_lock
        ...
        try:
            ...
            if vacuum and pruned > 0 and vacuum_due:
                ...
                # Same admission `nunmai sessions optimize` runs: VACUUM plus the TRUNCATE checkpoint
                ...
                from nunmai_state_holders import (
