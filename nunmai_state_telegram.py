"""Telegram DM topic-mode mixin for :class:`nunmai_state.SessionDB`."""
...
from nunmai_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active
from nunmai_state_errors import StateDbReplacedError
...
class SessionTelegramTopicsMixin:
    ...
    def bind_telegram_topic(
        ...
        """Bind one Telegram DM topic thread to one Nunmai session. A session may be linked to
