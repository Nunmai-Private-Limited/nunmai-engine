...
def fire_overdue_jobs(
    ...
    from cron.jobs import (
        ONESHOT_GRACE_SECONDS, _ensure_aware, _nunmai_now, is_job_runnable, load_jobs,
    )
...
class InProcessCronScheduler(CronScheduler):
    ...
    def start(
        ...
        # Heartbeat before the first sleep so `nunmai cron status` sees a live ticker immediately.
