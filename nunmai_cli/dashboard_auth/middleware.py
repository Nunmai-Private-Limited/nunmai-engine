...
from nunmai_cli.dashboard_auth.base import ProviderError
...
from nunmai_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from nunmai_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["nunmai.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('nunmai_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
