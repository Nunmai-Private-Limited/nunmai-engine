...
from nunmai_cli.dashboard_auth import prefix as _prefix_mod
...
from nunmai_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from nunmai_cli.dashboard_auth.login_page import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("nunmai_session_pkce", "")
