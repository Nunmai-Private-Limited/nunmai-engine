...
``tests/nunmai_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Nunmai Engine</title>
<style>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Nunmai Engine</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://nunmai.in/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
