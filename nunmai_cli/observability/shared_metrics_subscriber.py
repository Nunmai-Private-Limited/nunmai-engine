"""Relay subscriber for the persisted Nunmai shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Nunmai counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Nunmai shared metric: %s", metric_name, exc_info=True
                )
