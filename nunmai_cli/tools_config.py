...
TOOL_CATEGORIES = {
    ...
    "image_gen": {
        ...
        # _plugin_image_gen_providers(). Only the managed "Nunmai Subscription" row lives here — fal backend, distinct UX.
        "providers": [
            _row("Nunmai Subscription", "subscription", "Managed FAL image generation billed to your subscription", **_NOUS,
