"""Shared curses-based UI components for Nunmai CLI.

Used by `nunmai tools` and `nunmai skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "nunmai_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "nunmai_numbered_back_enabled", default=False
)
