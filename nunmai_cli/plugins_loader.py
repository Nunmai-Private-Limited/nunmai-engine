...
from nunmai_cli.plugins_manifest import PluginManifest, manifest_key, validate_config_schema
...
class PluginLoaderMixin:
    ...
    def _warn_python_dependencies(self, manifest: PluginManifest) -> None:
        ...
        See #64165.
        python_dependencies is a declaration seam ONLY: Nunmai validates and prints the requirements with an
