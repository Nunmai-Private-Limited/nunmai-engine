...
def _requires_nunmai_spec_valid(spec: str) -> bool:
    ...
    Unlike :func:`nunmai_cli.plugins._version_satisfies` (permissive at load
    ...
    """
    from nunmai_cli.plugins import _VERSION_COMPARATOR_RE, _version_tuple
...
# from nunmai so a hostile plugin only sees a bare interpreter.
_PROBE_SCRIPT = r"""
