...
TIPS = [
    ...
    # --- MCP ---
    "nunmai mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "nunmai mcp catalog lists Nous-approved MCP servers shipped with the repo.",
