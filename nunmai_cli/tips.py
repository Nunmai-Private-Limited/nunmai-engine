...
TIPS = [
    ...
    "/moa routes one hard prompt through your configured Nunmai Agent model set.",
    ...
    "/plan writes a markdown implementation plan to .nunmai/plans/ without executing anything.",
    # --- Cron & Scheduling ---
    ...
    "External memory providers: Honcho, OpenViking, Mem0 bundled; Hindsight and more via nunmai plugins install.",
    ...
    "execute_code helpers require explicit imports: from nunmai_tools import json_parse, shell_quote, retry.",
    ...
    'nunmai auth reset <provider> [target] clears cooldowns and exhaustion flags on a whole credential pool, or on one credential by index, id, or label.',
...
# Task-oriented example prompts for the empty composer. Kept generic — Nunmai is
