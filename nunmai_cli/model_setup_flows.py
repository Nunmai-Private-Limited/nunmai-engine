...
def _model_flow_copilot(config, current_model=""):
    ...
    from nunmai_cli.main_provider_setup import _prompt_reasoning_effort_selection
    from nunmai_cli.setup import _current_reasoning_effort, _set_reasoning_effort
    from nunmai_cli.auth import PROVIDER_REGISTRY, resolve_api_key_provider_credentials
    from nunmai_cli.config import load_config
    from nunmai_cli.models import fetch_api_models, github_model_reasoning_efforts, copilot_model_api_mode
    provider_id = "copilot"
