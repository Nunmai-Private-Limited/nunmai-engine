"""Nunmai skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces NUNMAI_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces NUNMAI_CADUCEUS)
...
# Branding shared by every Nunmai-named built-in (mono/daylight override help_header).
_NUNMAI_BRANDING: Dict[str, str] = _branding(
    "Nunmai", "☤", "Goodbye! ☤", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Nunmai — mint on deep green",
        # Dark-authored; values match the TUI's DARK_THEME so both render the same gold.
        "colors": {
            "banner_border": "#0B6B4F", "banner_title": "#6BE7C8", "banner_accent": "#3FCFA9",
            "banner_dim": "#2E9C7C", "banner_text": "#EFE9D7", "ui_accent": "#3FCFA9",
            "ui_label": "#D6B36C", "ui_ok": "#4caf50", "ui_error": "#ef5350", "ui_warn": "#ffa726",
            "prompt": "#EFE9D7", "input_rule": "#0B6B4F", "response_border": "#6BE7C8",
            "status_bar_bg": "#052819", "status_bar_text": "#C0C0C0",
            "status_bar_strong": "#6BE7C8", "status_bar_dim": "#5B8A7C",
            "status_bar_good": "#8FBC8F", "status_bar_warn": "#6BE7C8", "status_bar_bad": "#FF8C00",
            "status_bar_critical": "#FF6B6B", "session_label": "#D6B36C",
            "session_border": "#8B8682", "completion_menu_bg": "#052819",
            "completion_menu_current_bg": "#1F4A3D", "selection_bg": "#1B3A32",
            "shell_dollar": "#4dabf7", "voice_status_bg": "#052819"},
        # Light overlay (merged onto `colors`). Goldenrod ladder: on white the vivid
        # #6BE7C8/#3FCFA9 read as glare and WCAG-darkened mustard (#867000) as mud; the
        # statusbar's goldenrod family (#2E9C7C/#D6B36C) keeps the hue, tames saturation.
        ...
        "light_colors": {
            "banner_title": "#C8961E", "banner_accent": "#D89B04", "banner_dim": "#2E9C7C",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_NUNMAI_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _NUNMAI_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_nunmai_home_override() is None else nunmai_home_key()
...
_STYLE_PALETTE = (
    ("prompt", "prompt", ""), ("input_rule", "input_rule", "#0B6B4F"),
    ("title", "banner_title", "#6BE7C8"), ("text", "banner_text", "#EFE9D7"),
    ("dim", "banner_dim", "#555555"), ("label", "ui_label", "@title"), ("warn", "ui_warn", "#FF8C00"),
    ("error", "ui_error", "#FF6B6B"), ("status_bg", "status_bar_bg", "#052819"),
    ...
    ("menu_bg", "completion_menu_bg", "#052819"), ("menu_current_bg", "completion_menu_current_bg", "#1F4A3D"),
...
def get_prompt_toolkit_style_overrides() -> Dict[str, str]:
    ...
    palette["badge_bg"] = skin.colors.get(
        "status_bar_strong", skin.colors.get("banner_title", "#6BE7C8"))
    palette["badge_fg"] = skin.colors.get("status_bar_bg", "#052819")
