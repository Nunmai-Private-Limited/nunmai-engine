"""Non-interactive HTTPS credentials for Nunmai's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``nunmai plugins install`` with
