...
from nunmai_constants import get_default_nunmai_root, venv_python_path
...
from nunmai_cli.update_cmd_maint import (  # noqa: F401
    ...
    _print_verified_update_completion, _purge_stale_nunmai_modules, _read_project_version,
...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    if is_shallow:
        ...
        from nunmai_cli.gitlock import prune_stale_shallow_grafts
...
def _reconcile_diverged_checkout(git_cmd, branch: str, pre_pull_sha) -> None:
    ...
    if not has_common_ancestor and pre_pull_sha:
        ...
        rescue_ref = (
            f"refs/nunmai-update-backups/orphan-{branch}-"
