"""Plugin-owned durable state and namespaced settings helpers (split out of nunmai_cli.plugins)."""
...
from nunmai_cli.plugins_manifest import _portable_skill_namespace
