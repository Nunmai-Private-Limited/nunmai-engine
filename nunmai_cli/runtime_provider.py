...
from nunmai_cli.providers import determine_api_mode, is_actual_route, is_official_openai_host, nous_api_mode
...
def _resolve_nous_creds() -> Dict[str, Any]:
    return resolve_nous_runtime_credentials(timeout_seconds=float(_getenv("NUNMAI_NOUS_TIMEOUT_SECONDS", "15")))
...
def resolve_requested_provider(requested: Optional[str] = None) -> str:
    ...
    return _getenv("NUNMAI_INFERENCE_PROVIDER", "").strip().lower() or "auto"
