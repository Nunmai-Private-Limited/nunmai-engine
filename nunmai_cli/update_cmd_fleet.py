...
def _live_fleet_covers_receipt(expected_sha: str | None) -> bool:
    ...
    if not expected_sha:
        return False
    from nunmai_cli.update_receipt import collect_fleet_versions, read_latest_receipt
...
def _restart_gateway_fleet_after_update(_pre_update_plan, gateway_mode: bool):
    ...
    # Purge stale cached Nunmai modules FIRST: the import below loads new gateway
