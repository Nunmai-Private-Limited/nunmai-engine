...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Nunmai Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any nunmai CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--nunmai-root",
        help="Override the Nunmai source root used by Desktop (sets NUNMAI_DESKTOP_NUNMAI_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets NUNMAI_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Nunmai Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Nunmai Local Signing)",
    )
