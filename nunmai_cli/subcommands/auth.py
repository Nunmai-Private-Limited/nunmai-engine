...
def build_auth_parser(subparsers, *, cmd_auth: Callable) -> None:
    ...
    auth_add.add_argument("--portal-url", help="Nunmai portal base URL")
    auth_add.add_argument("--inference-url", help="Nunmai inference base URL")
    ...
    auth_upgrade = auth_subparsers.add_parser(
        "upgrade", help="Sign in with a Nunmai account, keeping your connectors")
    ...
    auth_spotify = auth_subparsers.add_parser(
        "spotify", help="Authenticate Nunmai with Spotify via PKCE")
    auth_spotify.add_argument(
        "spotify_action", nargs="?", choices=["login", "status", "logout"], default="login")
    auth_spotify.add_argument(
        "--client-id", help="Spotify app client_id (or set NUNMAI_SPOTIFY_CLIENT_ID)")
    auth_spotify.add_argument(
