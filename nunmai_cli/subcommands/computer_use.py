"""``nunmai computer-use`` subcommand parser."""

from __future__ import annotations

import sys

from nunmai_cli.subcommands._shared import add_json_flag


def _cu_install(args) -> int:
    from nunmai_cli.tools_config import _cua_driver_contract_status, install_cua_driver
...
def _cu_status(args) -> int:
    ...
    # install that `nunmai computer-use install` will (correctly) refuse to touch,
...
def build_computer_use_parser(subparsers) -> None:
    ...
    from nunmai_cli.subcommands.computer_use_screen import build_screen_parser
