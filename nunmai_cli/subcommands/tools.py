"""``nunmai tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'nunmai tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # nunmai tools list [--platform cli]
    ...
    # nunmai tools disable <name...> [--platform cli]
    ...
    # nunmai tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `nunmai tools` runs after you pick a provider that\n"
