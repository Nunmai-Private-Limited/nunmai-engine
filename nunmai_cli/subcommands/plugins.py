...
def build_plugins_parser(subparsers, *, cmd_plugins: Callable) -> None:
    ...
    plugins_parser = subparsers.add_parser(
        ...
        description=(
            "Install, update, remove, list, or validate native Nunmai plugins "
    ...
    plugins_install.add_argument(
        "identifier",
        help=(
            "Git URL, owner/repo shorthand (e.g. anpicasso/nunmai-plugin-chrome-profiles), "
            "or a bare plugin name resolved through the community index "
            "(see `nunmai plugins search`)"
        ),
    )
    plugins_install.add_argument(
        "--force",
    ...
    plugins_pack = plugins_subparsers.add_parser(
        "pack",
        help="Declarative, shareable plugin sets (nunmai-pack.yaml)",
        description=(
    ...
    pack_install.add_argument(
        "source", help="Path to a nunmai-pack.yaml file, or an https:// URL"
    )
    pack_install.add_argument(
        "--force",
        "-f",
