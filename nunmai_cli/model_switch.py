...
# Match only the real Nunmai Research Hermes 3 / 4 chat families; a bare substring check
...
def is_nous_nunmai_non_agentic(model_name: str) -> bool:
    """True if *model_name* is a real Nunmai Hermes 3/4 chat model (single owner; cli.py uses it too)."""
...
def _check_nunmai_model_warning(model_name: str) -> str:
    """Warning string if *model_name* is a Nunmai Hermes 3/4 chat model, else ""."""
