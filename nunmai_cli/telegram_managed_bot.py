...
manual BotFather token copy-paste. Nunmai talks only to the Nunmai onboarding
...
# Default pairing API base URL (Nunmai-hosted Cloudflare Worker).
...
# The Nunmai-hosted manager bot username (without @). The backend returns the
...
def auto_setup_telegram_bot_result(
    ...
    print()
    print(f"  Contacting Nunmai Telegram onboarding service: {resolved_api_url}")
    sys.stdout.flush()
