...
from nunmai_constants import clear_named_profile_deleted, mark_named_profile_deleted, named_profile_is_deleted
...
def _cleanup_gateway_service(name: str, profile_dir: Path) -> None:
    ...
    # NUNMAI_HOME is set temporarily so _profile_suffix resolves the service name.
