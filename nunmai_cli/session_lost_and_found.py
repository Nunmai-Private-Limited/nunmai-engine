...
``nunmai sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema Nunmai session database.
...
# Nunmai session ids are timestamps: 20260812_135332_ab12cd. This is the
