...
from nunmai_cli import cli_process_dock as procs
from nunmai_cli import cli_session_dock as session_rows
...
class SubagentMonitor:
    ...
    def invalidate(self):
        from nunmai_cli.cli_terminal_mixin import _run_on_app_loop
