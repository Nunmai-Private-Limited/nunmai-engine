...
class CLIModalMixin:
    ...
    def _ring_bell(self, prompt: bool = False, context: str = "", detail: str = "") -> None:
        ...
        if not getattr(self, flag, False) or getattr(self, "_terminal_io_broken", False):
            return
        from nunmai_cli.cli_terminal_mixin import _run_on_app_loop, _write_terminal_sequence
        from nunmai_cli.terminal_notify import notification_sequence, write_tty
