...
DEFAULT_CONFIG = {
    ...
    "curator": {
        ...
        "archive_ttl_days": 0,
        # Before every real (non-dry-run) pass, snapshot ~/.nunmai/skills/ to
        # ~/.nunmai/skills/.curator_backups/<utc-iso>/skills.tar.gz (`nunmai curator rollback`).
        "backup": {
            "enabled": True,
    ...
    # by tool_search / tool_describe / tool_call bridges and surfaced on demand. Core Nunmai tools
    ...
    # defaults (200K context, tools on, vision/reasoning off) and get patched. Provider keys: Nunmai
