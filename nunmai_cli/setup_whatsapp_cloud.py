...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Nunmai to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Nunmai needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Nunmai gateway in another terminal:",
        "         nunmai gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://nunmai.in/docs/user-guide/",
