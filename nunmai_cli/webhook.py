...
def _subscriptions_path() -> Path:
    ...
    return get_nunmai_home() / _SUBSCRIPTIONS_FILENAME
...
def _cmd_subscribe(args):
    ...
    if profile_arg is None:
        ...
        from nunmai_cli.profiles import normalize_profile_name, profile_exists, validate_profile_name
        try:
    ...
    if cron_job:
        ...
        try:
            ...
            return
        if job is None:
            print(f"Error: no cron job matches '{cron_job}'. List jobs with: nunmai cron list")
            return
