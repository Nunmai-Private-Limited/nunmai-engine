...
def load_cli_config() -> Dict[str, Any]:
    ...
    """
    from cli import _cli_config_defaults, _nunmai_home, _merge_file_config, _mirror_config_to_env
...
def _init_logging_and_display_from_config() -> None:
    ...
    for step in (
        ...
        lambda: _im("nunmai_cli.skin_engine").init_skin_from_config(_cli().CLI_CONFIG),
