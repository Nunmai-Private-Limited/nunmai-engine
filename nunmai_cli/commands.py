"""Slash command registry for the Nunmai CLI and gateway.
...
class CommandDef:
    ...
    # Key in ``nunmai_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("busy", "Control how messages behave while Nunmai is working", "Configuration",
    ...
    CommandDef("login", "Sign in with a Nunmai account (keeps your connectors)", "Info",
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('nunmai_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('nunmai_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('nunmai_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('nunmai_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('nunmai_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('nunmai_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('nunmai_cli.commands_platforms', 'telegram_menu_max_commands'),
}
