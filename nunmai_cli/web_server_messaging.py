...
from nunmai_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Nunmai from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Nunmai to Discord DMs, channels, and threads.",
    ...
    "matrix": {
        "name": "Matrix", "description": "Use Nunmai in Matrix rooms and direct messages.",
    ...
    "email": {
        "name": "Email", "description": "Talk to Nunmai through an IMAP/SMTP mailbox.",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Nunmai to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Nunmai inside Feishu / Lark.",
    ...
    "google_chat": {
        "name": "Google Chat", "description": "Connect Nunmai to Google Chat via Cloud Pub/Sub.",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Nunmai to a QQ Bot from the QQ Open Platform.",
    ...
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Nunmai to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
...
def _platform_env_prefixes(platform_id: str) -> tuple[str, ...]:
    ...
    from nunmai_cli.profile_channels import platform_env_prefixes
...
def _restart_gateway_after_whatsapp_onboarding(profile: Optional[str] = None) -> dict[str, Any]:
    from nunmai_cli.web_server_gateway import _restart_gateway_after
