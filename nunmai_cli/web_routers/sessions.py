...
async def search_sessions(
    ...
    try:
        ...
        try:
            ...
            # logs, or another Nunmai surface. FTS can't find those unless the
...
async def import_sessions_endpoint(request: Request):
    ...
    restores a whole Nunmai backup archive, while this endpoint is scoped to
...
async def get_session_stats(profile: Optional[str] = None):
    """Session-store statistics for the Sessions page (mirrors `nunmai sessions stats`).
