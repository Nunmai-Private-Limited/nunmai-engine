...
``nunmai --tui`` child cannot be spawned. The exception text alone is either
...
CHAT_NEEDS_NODE = (
    "Chat could not start: Nunmai needs Node.js to run the terminal chat. "
...
CHAT_START_FAILED = "Chat could not start: {detail} Check the server log (`nunmai dashboard` terminal) and click Start new session."
