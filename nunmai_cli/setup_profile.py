...
SETUP_PROFILE_NAME = "nunmai-setup"
SETUP_PROFILE_DESCRIPTION = "Where Nunmai met you — walks your first run, then checks in as you find your feet."

SETUP_SOUL = "\n".join([
    "# Nunmai",
    "",
    "You are Nunmai, and this profile is where you met this user for the first time and stay reachable afterwards. "
...
def ensure_setup_profile() -> SetupProfile:
    ...
    A ``nunmai-setup`` profile from before the role existed is adopted: it gets the role and
