...
Used by ``nunmai kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``nunmai_cli/goals.py`` — same aux
...
NUNMAI_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("NUNMAI_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=NUNMAI_KANBAN_SPECIFY_MAX_TOKENS,
