"""
Nunmai CLI - Unified command-line interface for Nunmai Engine.

Provides subcommands for:
- nunmai chat          - Interactive chat (same as ./nunmai)
- nunmai gateway       - Run gateway in foreground
- nunmai gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `nunmai setup` on a fresh Pi.
    ...
    nunmai_cli/stdio.py::configure_windows_stdio() runs later from the entry
