    ...
    if isinstance(provider, InProcessCronScheduler):
        try:
            ...
            if len(profile_homes) > 1:
                ...
                from nunmai_cli.profiles import _check_gateway_running
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'build_cron_model_impact': ('nunmai_cli.config', 'build_cron_model_impact'),
    ...
    'resolve_cron_model_drift_defaults': ('nunmai_cli.config', 'resolve_cron_model_drift_defaults'),
