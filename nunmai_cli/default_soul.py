"""Default SOUL.md template seeded into NUNMAI_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Nunmai Engine, built by Nunmai Research. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    ...
    "The agent will embody whatever you write here.\nEdit this to customize how Nunmai communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Nunmai Engine, an intelligent AI assistant created by Nunmai Research. You are helpful, "
