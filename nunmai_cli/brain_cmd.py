...
def _secret(prompt: str) -> str:
    try:
        # 0.21.x moved this out of auth_commands into its own module; the getpass fallback below
        # still covers a build where it is missing.
        from nunmai_cli.secret_prompt import masked_secret_prompt  # type: ignore
