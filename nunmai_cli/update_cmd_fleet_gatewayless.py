...
def runtime_outside_gateway_evidence(runtime: dict) -> bool:
    ...
    """
    from nunmai_cli.update_cmd_fleet import _SUPERVISOR_OWNED_SERVE_BACKENDS
...
def host_owes_no_gateway_restart() -> bool:
    ...
    from nunmai_cli.update_inventory import collect_runtime_inventory
    from nunmai_cli.update_receipt import _NOT_EXPECTED_STATES, _profile_homes
