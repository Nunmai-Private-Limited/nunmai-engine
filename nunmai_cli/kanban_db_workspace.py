...
from nunmai_cli.worktree_ops import release_lsp_clients
...
def _is_managed_scratch_path(p: Path) -> bool:
    ...
    root (``NUNMAI_KANBAN_WORKSPACES_ROOT``, ``<kanban_home>/kanban/workspaces``,
    ...
    Nunmai' own DB and metadata. :func:`_cleanup_workspace` refuses
...
def _cleanup_worktree_workspace(
    ...
    try:
        from nunmai_cli.worktree_ops import _worktree_has_unpushed_commits, _worktree_is_dirty
    except Exception:
