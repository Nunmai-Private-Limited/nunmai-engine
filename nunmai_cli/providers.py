...
NUNMAI_OVERLAYS: Dict[str, NunmaiOverlay] = {
    ...
    "opencode-free": NunmaiOverlay(is_aggregator=True, base_url_override="https://opencode.ai/zen/v1", keyless=True),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    "moa": "Mixture of Agents", "nous": "Nunmai Portal", "openai-codex": "ChatGPT or Codex Subscription",
