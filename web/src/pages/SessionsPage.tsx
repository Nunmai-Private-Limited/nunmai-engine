...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    nunmai_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__nunmai_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Nunmai-Session-Token":
              (window as unknown as { __NUNMAI_SESSION_TOKEN__?: string })
                .__NUNMAI_SESSION_TOKEN__ ?? "",
          },
        });
