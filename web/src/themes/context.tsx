...
const STORAGE_KEY = "nunmai-dashboard-theme";
...
const FONT_STORAGE_KEY = "nunmai-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `nunmai_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "nunmai-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-nunmai-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-nunmai-theme-font", "true");
