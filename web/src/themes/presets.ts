import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@nunmai/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `nunmai_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@nunmai/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Nunmai Teal",
  description: "Classic dark teal — the canonical Nunmai look",
  palette: {
...
/** Light mode — vivid Nunmai-blue accents on a cream canvas. */
export const nousBlueTheme: DashboardTheme = {
  name: "nous-blue",
  label: "Nunmai Blue",
  description: "Light mode — vivid Nunmai-blue accents on cream canvas",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Nunmai Teal (Large)",
  description: "Nunmai Teal with bigger fonts and roomier spacing",
