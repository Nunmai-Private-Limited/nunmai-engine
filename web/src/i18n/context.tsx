import { applyDocumentLocale, LOCALE_ENDONYMS } from "@nunmai/shared/i18n";
...
// Display metadata for the language picker — endonyms from @nunmai/shared so the
...
const STORAGE_KEY = "nunmai-locale";
