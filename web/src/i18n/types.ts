...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateNunmai: string;
    updateNunmaiConfirmMessage?: string;
    updateNunmaiConfirmNow?: string;
    updateNunmaiConfirmTitle?: string;
    updatingNunmai: string;
  ...
  // ── Achievements plugin (plugins/nunmai-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
