...
export const en: Translations = {
  ...
  status: {
    ...
    updateNunmaiConfirmMessage:
      "This runs nunmai update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateNunmaiConfirmNow: "Update now",
    updateNunmaiConfirmTitle: "Update Nunmai?",
    updatingNunmai: "Updating Nunmai…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Nunmai plugins (`nunmai plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.nunmai/plugins/?",
    removeHint: "Only user-installed plugins under ~/.nunmai/plugins can be removed.",
    ...
    catalogHint:
      "Curated, Nunmai-reviewed plugins pinned to exact commits. Install from here for supply-chain-safe versions.",
    catalogSearchPlaceholder: "Search catalog...",
    catalogEmpty: "No catalog entries match.",
    catalogEmptyDocsLink: "Learn about Nunmai plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `nunmai skills search <topic>`.",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Nunmai doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Nunmai Achievements",
      subtitle:
        "Collectible Nunmai badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Nunmai session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Nunmai more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Nunmai sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Nunmai is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Nunmai Engine ☤",
    },
  },
