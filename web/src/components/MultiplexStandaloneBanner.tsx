 ...
 * profile's bot is silent until `nunmai gateway migrate --multiplex` runs. The backend only
...
export function MultiplexStandaloneBanner({
  ...
  const template =
    ...
    "Your gateway serves only one profile. Not served: {profiles}. Why: {reason}. Fix: nunmai gateway migrate --multiplex";
