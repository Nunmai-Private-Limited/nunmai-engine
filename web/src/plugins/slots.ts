 ...
 * `window.__NUNMAI_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Nunmai brand in the top bar
 ...
 *  `window.__NUNMAI_PLUGINS__.registerSlot(...)`.
 *
