...
/** Mirrors nunmai_cli/cron.py `_OVERDUE_GRACE_SECONDS`: a busy tick can run a few minutes late. */
...
/** Mirrors nunmai_cli/cron.py `STALE_AFTER`: ~3 missed ticker iterations (60s) plus slack. */
