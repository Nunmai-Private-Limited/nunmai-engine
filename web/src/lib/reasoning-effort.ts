 ...
 *
 * Values come from @nunmai/shared (nunmai_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the Nunmai
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (Nunmai' default when unset). */
