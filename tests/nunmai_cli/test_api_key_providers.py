...
class TestResolveProvider:
    ...
    def test_auto_does_not_select_copilot_from_github_token(self, monkeypatch):
        ...
        with pytest.raises(AuthError, match="No AI connected yet"):
...
class TestResolveApiKeyProviderCredentials:
    ...
    def test_try_gh_cli_token_uses_homebrew_path_when_not_on_path(self, monkeypatch):
        ...
        monkeypatch.setattr("nunmai_cli.copilot_auth.shutil.which", lambda command: None)
        monkeypatch.setattr(
            "nunmai_cli.copilot_auth.os.path.isfile",
            lambda path: path == "/opt/homebrew/bin/gh",
        )
        monkeypatch.setattr(
            "nunmai_cli.copilot_auth.os.access",
...
class TestKimiMoonshotModelListIsolation:
    ...
    def test_moonshot_list_excludes_coding_plan_only_models(self):
        from nunmai_cli.main import _PROVIDER_MODELS
...
class TestHuggingFaceModels:
    ...
    def test_model_lists_match(self):
        ...
        from nunmai_cli.main import _PROVIDER_MODELS as main_models
        from nunmai_cli.models import _PROVIDER_MODELS as models_models
...
class TestDeepInfraProviderProfile:
    ...
    def test_profile_registered_with_alias_and_aux(self):
        ...
        from nunmai_cli.auth import PROVIDER_REGISTRY, resolve_provider
