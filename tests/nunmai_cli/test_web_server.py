...
import nunmai_cli.web_routers.status as _rt_status
...
class TestWebServerEndpoints:
    ...
    def test_declared_surface_put_writes_config_and_secret(self):
        ...
        config_path = get_nunmai_home() / "hindsight" / "config.json"
    ...
    def test_update_nunmai_returns_apt_guidance_without_spawning(self, monkeypatch):
        ...
        assert data["update_command"] == "pkg upgrade nunmai-engine"
        assert spawned is False
        ...
        assert check_data["update_command"] == "pkg upgrade nunmai-engine"
    ...
    def test_platform_scoped_messaging_env_vars_are_channel_managed(self):
        ...
        tests/nunmai_cli/test_setup_hidden_env.py.
        """
        from nunmai_cli.web_server_messaging import _MESSAGING_KEYS_PAGE_KEYS, _build_catalog_entry, _channel_managed_env_keys
...
class TestBuildSchemaFromConfig:
    ...
    def test_overrides_applied(self):
        from nunmai_cli.web_server_config import CONFIG_SCHEMA
...
class TestConfigRoundTrip:
    ...
    def test_round_trip_preserves_schema_invisible_nested_keys(self):
        ...
        from nunmai_cli.config import load_config, read_raw_config, save_config
...
class TestNewEndpoints:
    ...
    def test_toolsets_resolve_subscription_features_once(self, monkeypatch):
        ...
        from nunmai_cli.nous_subscription import NousSubscriptionFeatures
...
class TestThemeBootstrapCSS:
    ...
    def test_user_theme_renders_bundle_vars(self, tmp_path, monkeypatch):
        ...
        assert css.startswith('<style id="nunmai-theme-bootstrap">')
...
class TestBulkDeleteSessionsEndpoint:
    ...
    def test_route_order_not_shadowed_by_session_id(self):
        ...
        assert "deleted" in body, (
            ...
            "registration order in nunmai_cli/web_server.py."
        )
...
class TestDesktopCronTicker:
    ...
    def test_ticker_runs_when_desktop(self, monkeypatch, _isolate_nunmai_home):
        ...
        with self._client():
            assert called.wait(3.0), "expected cron tick under NUNMAI_DESKTOP=1"
