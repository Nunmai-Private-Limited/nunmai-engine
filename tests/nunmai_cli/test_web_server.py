...
class TestWebServerEndpoints:
    ...
    def test_update_nunmai_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        monkeypatch.setattr(web_server, "_spawn_nunmai_action", fail_spawn)
        web_server._ACTION_PROCS.pop("nunmai-update", None)
        web_server._ACTION_RESULTS.pop("nunmai-update", None)
    ...
    def test_update_nunmai_spawns_with_action_id(self, monkeypatch):
        ...
        monkeypatch.setattr(web_server, "_spawn_nunmai_action", fake_spawn)
        web_server._ACTION_PROCS.pop("nunmai-update", None)
        web_server._ACTION_RESULTS.pop("nunmai-update", None)
    ...
    def test_update_nunmai_reuses_running_action(self, monkeypatch):
        ...
        web_server._ACTION_PROCS["nunmai-update"] = Proc()
        web_server._ACTION_IDS["nunmai-update"] = "b" * 32

        try:
            resp = self.client.post("/api/nunmai/update")
        finally:
            web_server._ACTION_PROCS.pop("nunmai-update", None)
            web_server._ACTION_IDS.pop("nunmai-update", None)
    ...
    def test_platform_scoped_messaging_env_vars_are_channel_managed(self):
        ...
        """
        from nunmai_cli.web_server import (
    ...
    def test_telegram_onboarding_apply_reports_restart_failure_after_save(
        ...
        monkeypatch.setattr(ws, "_spawn_nunmai_action", fail_spawn_action)
    ...
    def test_parse_model_ids_handles_openai_and_bare_shapes(self):
        ...
        from nunmai_cli.web_server import _parse_model_ids
...
class TestBuildSchemaFromConfig:
    ...
    def test_overrides_applied(self):
        from nunmai_cli.web_server import CONFIG_SCHEMA
    ...
    def test_timezone_field_is_searchable_select(self):
        ...
        """
        from nunmai_cli.web_server import CONFIG_SCHEMA, _timezone_options
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from nunmai_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from nunmai_cli.web_server import _denormalize_config_from_web
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_non_dict(self):
        from nunmai_cli.web_server import _normalise_theme_definition
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        ...
        import nunmai_cli.web_server as ws_mod
