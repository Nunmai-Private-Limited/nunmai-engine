...
from nunmai_cli.dashboard_auth import ws_tickets
from nunmai_cli.web_routers import display
...
def test_display_ticket_must_be_a_bot_desktop_ticket_pinned_to_a_profile_home(monkeypatch):
    ...
    assert info and info["nunmai_home"] == "/srv/nunmai/bot-a" and info["viewer_id"] == "v"
