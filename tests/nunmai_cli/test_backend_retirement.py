...
def test_retirement_reserves_admission_until_cancel_or_permanent_commit(monkeypatch):
    ...
    from nunmai_cli import backend_retirement
    ...
    headers = {"X-Nunmai-Session-Token": "retirement-test-token"}
...
def test_only_uncommitted_permits_expire_and_unreadable_work_never_grants(monkeypatch):
    from nunmai_cli.backend_retirement import RetirementFence
    from nunmai_cli import web_server_idle_proof
