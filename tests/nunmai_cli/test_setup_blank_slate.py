"""Tests for Blank Slate setup mode (nunmai_cli/setup.py).
...
from nunmai_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
