...
def test_purge_preserves_active_update_receipt(tmp_path, monkeypatch):
    ...
    import nunmai_cli.update_receipt as receipt
    ...
    try:
        ...
        cli_main._purge_stale_nunmai_modules()
        post_purge_receipt = importlib.import_module("nunmai_cli.update_receipt")
...
def test_purge_keeps_plan_record_class_identity():
    ...
    from nunmai_cli.update_inventory import RuntimeRecord as before

    cli_main._purge_stale_nunmai_modules()
    from nunmai_cli.update_inventory import RuntimeRecord as after
