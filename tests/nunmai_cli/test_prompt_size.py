"""Tests for the ``nunmai prompt-size`` diagnostic (issue #34667)."""
...
from nunmai_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(nunmai_home, memory_text="", user_text=""):
...
def _seed_skill(nunmai_home, name, description):
    skill_dir = nunmai_home / "skills" / "demo" / name
