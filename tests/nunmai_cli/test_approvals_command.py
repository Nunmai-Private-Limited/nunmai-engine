...
from nunmai_cli.commands import GATEWAY_KNOWN_COMMANDS, SUBCOMMANDS, gateway_help_lines, resolve_command
from nunmai_cli.commands_completion import SlashCommandCompleter
from nunmai_cli.commands_platforms import telegram_bot_commands
...
def _isolate_config(monkeypatch, home):
    ...
    monkeypatch.setenv("NUNMAI_MANAGED_DIR", str(home / "missing-managed"))
    from nunmai_cli import managed_scope
    from nunmai_cli.config import _LOAD_CONFIG_CACHE, _RAW_CONFIG_CACHE
