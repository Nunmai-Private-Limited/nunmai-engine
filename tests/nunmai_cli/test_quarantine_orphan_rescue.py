...
def test_quarantine_stamp_ms_parses_and_rejects():
    assert cli_main._quarantine_stamp_ms(Path("nunmai.exe.old.1787020473885")) == 1787020473885
    assert cli_main._quarantine_stamp_ms(Path("nunmai.exe.old.backup")) is None
    assert cli_main._quarantine_stamp_ms(Path("nunmai.exe")) is None
