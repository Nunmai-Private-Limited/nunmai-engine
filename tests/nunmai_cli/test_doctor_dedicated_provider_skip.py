"""Regression: nunmai doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at nunmai_cli/doctor.py already covers
...
from nunmai_cli import doctor_connectivity


def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from nunmai_cli import doctor
