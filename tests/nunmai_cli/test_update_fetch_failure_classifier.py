"""Fetch-failure classification for `nunmai update` / `nunmai update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/Nunmai-Private-Limited/nunmai-engine.git/':"
...
class TestClassifyFetchFailure:
    ...
    def test_ssh_publickey_denial_reports_ssh_auth_not_generic(self):
        ...
        assert "https://github.com/Nunmai-Private-Limited/nunmai-engine.git" in msg
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `nunmai update` sit on
