"""Tests for `nunmai chat --safe-mode` isolation."""
...
_VARS = ("NUNMAI_SAFE_MODE", "NUNMAI_IGNORE_USER_CONFIG", "NUNMAI_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["NUNMAI_SAFE_MODE"] == "1"
        assert os.environ["NUNMAI_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["NUNMAI_IGNORE_RULES"] == "1"
        return True
