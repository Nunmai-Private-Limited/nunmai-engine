...
The main() function in nunmai_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nunmai -c model`
...
def _build_parser():
    """Build a minimal replica of the nunmai top-level parser."""
