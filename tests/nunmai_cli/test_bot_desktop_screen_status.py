"""``nunmai computer-use screen status`` shows the lease the way every RPC surface does: the holder's viewer
...
from nunmai_cli.subcommands import computer_use_screen
