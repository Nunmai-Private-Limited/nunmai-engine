...
only when every damaged object is a Nunmai FTS shadow.
"""
...
from nunmai_cli.doctor_state import _state_db_health
from nunmai_state import SessionDB
from nunmai_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `nunmai sessions recover` for THIS
