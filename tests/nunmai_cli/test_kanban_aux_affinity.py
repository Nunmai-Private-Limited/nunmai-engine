...
from nunmai_cli import kanban_decompose as decompose
from nunmai_cli import kanban_specify as specify
...
def _dashboard_plugin_api():
    mod_name = "nunmai_dashboard_plugin_kanban_aux_affinity_test"
