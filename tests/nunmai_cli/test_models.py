...
class TestCodexSoftAcceptPlausibilityGate:
    ...
    def test_unrelated_name_rejected_on_openai_codex(self):
        from nunmai_cli.models import validate_requested_model
...
class TestFormatPricePerMtok:
    ...
    def test_standard_prices_keep_two_decimals(self):
        from nunmai_cli.models import _format_price_per_mtok
...
class TestLocalOllamaModelDiscovery:
    ...
    def test_native_tags_cache_expires(self, monkeypatch):
        from nunmai_cli.models import fetch_ollama_local_models
    ...
    def test_runtime_error_from_config_load_does_not_escape_ollama_helpers(self):
        ...
        from nunmai_cli.models import _get_ollama_base_url, should_use_ollama_native_catalog

        with patch("nunmai_cli.config.load_config", side_effect=RuntimeError("bad home")), patch(
            "nunmai_cli.models.probe_ollama_local_models",
            return_value=None,
        ):
    ...
    def test_probe_ollama_models_malformed_base_url_returns_none(self):
        ...
        from nunmai_cli.models import probe_ollama_local_models
    ...
    def test_fetch_ollama_models_preserves_probe_failure(self):
        ...
        with patch("nunmai_cli.models.probe_ollama_local_models", return_value=None):
    ...
    def test_ollama_port_detection_requires_working_api_tags(self):
        ...
        with patch("nunmai_cli.models.probe_ollama_local_models", return_value=["qwen3:1.7b"]):
    ...
    def test_provider_model_ids_ollama_cloud_config_uses_generic_catalog(self):
        ...
        ), patch("nunmai_cli.models.fetch_ollama_local_models") as fetch_local, patch(
    ...
    def test_native_ollama_catalog_uses_configured_key_env(self, monkeypatch):
        from nunmai_cli.models import _get_ollama_request_headers
    ...
    def test_provider_model_ids_ignores_active_non_ollama_custom_endpoint(self):
        ...
        with patch(
            ...
            "nunmai_cli.models.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
        ) as fetch_local:
            assert provider_model_ids("ollama", force_refresh=True) == ["qwen3:1.7b"]
    ...
    def test_ollama_cache_fingerprint_does_not_probe_custom_endpoint(self):
        ...
        ), patch("nunmai_cli.models.probe_ollama_local_models") as probe_ollama:
    ...
    def test_picker_user_provider_verifies_ambiguous_ollama_port(self):
        ...
        with patch("nunmai_cli.config.load_config", return_value={"providers": {}}), patch(
            "nunmai_cli.models.should_use_ollama_native_catalog",
            return_value=True,
        ), patch(
            "nunmai_cli.models.fetch_ollama_local_models",
            return_value=["qwen3:1.7b"],
    ...
    def test_named_custom_model_flow_discovers_ollama_api_tags(self):
        ...
        from nunmai_cli.main import _model_flow_named_custom
        ...
        try:
            ...
            ), patch("nunmai_cli.main._save_custom_provider"), patch(
    ...
    def test_model_validation_ollama_cloud_config_does_not_use_local_tags(self):
        ...
        ), patch("nunmai_cli.models.probe_ollama_local_models") as probe_ollama, patch(
    ...
    def test_switch_model_on_non_ollama_custom_endpoint_still_resolves_runtime(self):
        ...
        with patch(
            ...
            "nunmai_cli.models.validate_requested_model",
            return_value={
                "accepted": True,
                "persist": True,
                "recognized": True,
    ...
    def test_ollama_root_matching_is_case_insensitive_for_hostnames(self):
        from nunmai_cli.models import _same_ollama_native_root
