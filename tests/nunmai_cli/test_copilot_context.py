...
class TestGetCopilotModelContext:
    ...
    @patch("nunmai_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("nunmai_cli.models._urlopen_model_catalog_request")
    ...
    @patch("nunmai_cli.models.fetch_github_model_catalog", return_value=[])
