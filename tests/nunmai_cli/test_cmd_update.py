...
class TestRepairCurrentCheckoutRuntimeRepair:
    ...
    def _run(monkeypatch, *, repaired: bool, lazy_refresh_ok: bool = True):
        ...
        monkeypatch.setattr("nunmai_cli.managed_uv.update_managed_uv", ensure)
        monkeypatch.setattr("nunmai_cli.managed_uv.ensure_uv", ensure)
    ...
    def test_restores_optional_dependencies_after_runtime_repair(self, monkeypatch):
        ...
        built from uv.lock alone: the captured lazy backends and Nunmai Tools deps must be
    ...
    def test_failed_lazy_restore_keeps_incomplete_marker(self, monkeypatch, capsys):
        ...
        restore into the swapped-in venv is picked up by the next `nunmai` run instead of
...
class TestCmdUpdateBranchFallback:
    ...
    def test_update_on_fork_checks_upstream_when_origin_up_to_date(
        ...
        origin but behind Nunmai-Private-Limited/nunmai-engine silently misses updates.
        """
        from nunmai_cli import main as hm
