...
from nunmai_cli.dashboard_auth import refresh_singleflight as replay
from nunmai_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from nunmai_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"nunmai_session_at": "expired-at", "nunmai_session_rt": "stale-rt",
               "nunmai_session_provider": "stub"}
