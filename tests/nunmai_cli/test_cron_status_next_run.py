...
from nunmai_cli.cron import _print_active_jobs_summary
...
def _frozen_clock(monkeypatch):
    ...
    monkeypatch.setattr(job_store, "_nunmai_now", lambda: now)
    monkeypatch.setattr("nunmai_time.now", lambda: now)
