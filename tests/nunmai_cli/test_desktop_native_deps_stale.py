...
Regression for #62462: ``nunmai desktop`` reported "content stamp matches" and
...
def packaged(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(main_desktop, "_desktop_packaged_executable", lambda _: dist / "Nunmai")
