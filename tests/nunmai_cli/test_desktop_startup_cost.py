...
from nunmai_cli import main_desktop as desktop
...
def test_current_packaged_launch_does_not_require_npm(tmp_path, monkeypatch):
    ...
    with patch.object(desktop, "_desktop_launch_env", return_value=({}, [])), \
         ...
         patch("nunmai_cli.main_install_repair._resolve_node_runtime_npm", return_value=None) as npm, \
