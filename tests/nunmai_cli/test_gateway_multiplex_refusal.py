...
def standalone_home(tmp_path, monkeypatch):
    ...
    # The probe seams live on the nunmai_cli.gateway facade, like the other refusal tests.
...
def test_dashboard_standalone_refusal_resolves_once_and_preserves_invalid_profile(standalone_home, monkeypatch):
    ...
    from nunmai_cli import web_server_gateway as web
    from nunmai_cli import web_server_profiles
