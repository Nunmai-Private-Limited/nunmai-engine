...
mirroring tests/nunmai_cli/test_cli_steer_busy_path.py.
"""
...
def _make_cli():
    """Bare NunmaiCLI (no __init__): the detector only reads _agent_running."""
    from cli import NunmaiCLI

    return NunmaiCLI.__new__(NunmaiCLI)
