...
def _patch_update_deps(monkeypatch, tmp_path, run_side_effect):
    ...
    monkeypatch.setattr(nunmai_main, "_is_fork", lambda *a, **k: False)
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        nunmai_main, "_finish_dashboard_update_cleanup", lambda *a, **k: None
    )
    ...
    monkeypatch.setattr(
        nunmai_gateway, "find_gateway_pids", lambda all_profiles=False: []
    )
