"""Invariants for ``nunmai_cli.config_effective.load_user_config_effective`` — the one loader every
defaults-free config reader (gateway runtime, TUI gateway, cron, ``nunmai send`` bridge, doctor,
...
def _reset_caches():
    ...
    from nunmai_cli import config_effective, managed_scope
