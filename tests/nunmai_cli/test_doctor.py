...
from nunmai_cli.doctor import _has_provider_env_config
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_nunmai_home(self, tmp_path, provider=""):
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_nunmai_home(tmp_path, provider)
...
class TestDoctorDeprecatedConfigAndEnv:
    ...
    def test_nunmai_tool_progress_warning_says_unsupported_since_floor(self):
        ...
        findings = dict(
            doctor_mod.collect_deprecated_env_vars({"NUNMAI_TOOL_PROGRESS": "true"})
        )
        ...
        mode = dict(
            doctor_mod.collect_deprecated_env_vars({"NUNMAI_TOOL_PROGRESS_MODE": "all"})
        )
