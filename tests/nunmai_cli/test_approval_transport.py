...
"""
    ...
    token = approval.set_nunmai_interactive_context(True)
    ...
    try:
        ...
        gateway_token = approval.set_nunmai_interactive_context(False)
        ...
        try:
            ...
            approval.reset_nunmai_interactive_context(gateway_token)
        hardline = approval.check_all_command_guards("rm -rf /", "local")
    finally:
        approval.reset_nunmai_interactive_context(token)
