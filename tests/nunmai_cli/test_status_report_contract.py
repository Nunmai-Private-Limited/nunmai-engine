...
Every surface renders through ``nunmai_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("nunmai_constants.display_nunmai_home", return_value=HOME), \
