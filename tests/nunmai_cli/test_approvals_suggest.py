"""Tests for ``nunmai approvals suggest`` (nunmai_cli/approvals_suggest.py).

Approval history in Nunmai is implied, not ledgered: the session DB
...
from nunmai_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
