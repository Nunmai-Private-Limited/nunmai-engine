...
Run before any catalog commit:
    ...
    NUNMAI_TEST_NETWORK=1 scripts/run_tests.sh tests/nunmai_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("NUNMAI_TEST_NETWORK"),
    reason="network test; set NUNMAI_TEST_NETWORK=1 to run",
)
