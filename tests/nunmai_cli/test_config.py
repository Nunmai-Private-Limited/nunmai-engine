...
class TestOptionalEnvVarsRegistry:
    ...
    def test_tavily_in_env_vars_by_version(self):
        ...
        from nunmai_cli.config import ENV_VARS_BY_VERSION
        all_vars = []
...
class TestMemoryProviderEnvVarsRegistry:
    ...
    and `nunmai setup` surface it (previously only Honcho was listed, leaving
...
"""
    ...
    def test_persist_migration_writes_full_read_raw_config(self, tmp_path):
        from nunmai_cli.config import _persist_migration, read_raw_config
