...
def test_dock_paints_goal_on_top_and_queue_last_and_follows_their_lifecycle(nunmai_home):
    from cli import _VoiceInputMessage
    from nunmai_cli.cli_subagent_monitor import SubagentMonitor
...
def test_dock_ignores_a_goal_manager_left_over_from_another_session(nunmai_home):
    ...
    from nunmai_cli.cli_session_dock import goal_line
    from nunmai_cli.goals import GoalManager
