"""Tests for nunmai_cli.model_normalize — provider-aware model name normalization.
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (Nunmai portal, OpenRouter via DeepInfra) routes to V3 —
...
class TestColonProviderPrefixIsStrippedLikeSlash:
    """Issue #64787: ``-m openai-codex:gpt-5.6-sol`` (Nunmai's own ``provider:model`` switch syntax)
