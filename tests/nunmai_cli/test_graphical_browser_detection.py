"""Tests for `_can_open_graphical_browser()` in nunmai_cli.auth.

Guards the fix for the May 2026 report where `nunmai auth add xai-oauth`
...
from nunmai_cli.auth import _can_open_graphical_browser
