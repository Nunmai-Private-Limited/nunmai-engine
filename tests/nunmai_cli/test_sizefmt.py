"""Tests for the shared byte formatter (nunmai_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from nunmai_cli.backup import _format_size as backup
    from nunmai_cli.checkpoints import _fmt_bytes as checkpoints
    from nunmai_cli.sizefmt import format_bytes as doctor
