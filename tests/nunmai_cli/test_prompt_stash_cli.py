"""Tests for the Ctrl+S prompt stash wiring inside NunmaiCLI.

The state machine itself is covered by tests/nunmai_cli/test_prompt_stash.py. These
tests verify the cli.py side:
  - NunmaiCLI.__init__ creates a PromptStash
...
tests/nunmai_cli/test_cli_extension_hooks.py.
"""
...
def _make_cli(**kwargs):
    """Create a NunmaiCLI with prompt_toolkit stubbed out."""
    _clean_config = {
        "model": {
