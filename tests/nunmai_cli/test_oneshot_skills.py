...
The oneshot path builds its AIAgent directly (bypassing NunmaiCLI), so the
...
from nunmai_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
