...
local profile homes was invisible to ``nunmai doctor`` / ``nunmai gateway status``; the only signal
...
from nunmai_cli import doctor_state, gateway, gateway_migrate as gm
