...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (nunmai_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_nunmai_overlays():
    """nunmai_cli.providers.get_provider("vertex") backs
