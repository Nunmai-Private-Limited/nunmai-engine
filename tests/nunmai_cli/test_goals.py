...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from nunmai_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, nunmai_home):
        ...
        from nunmai_cli import goals
        from nunmai_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
...
class TestStatusLineSubgoalCount:
    ...
    def test_status_line_with_subgoals(self, nunmai_home):
        from nunmai_cli.goals import GoalManager
