"""Regression: ``nunmai update`` should take a managed checkout off autocrlf=true.
...
``nunmai update`` has to repair them.
...
from nunmai_cli.update_cmd import _normalize_managed_eol
