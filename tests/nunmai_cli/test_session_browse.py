"""Tests for the interactive session browser (`nunmai sessions browse`).
...
from nunmai_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nunmai sessions browse should be parseable."""
