"""Tests for `nunmai secrets bitwarden token` / `nunmai secrets onepassword token`.
...
from nunmai_cli import onepassword_secrets_cli as op_cli
from nunmai_cli import secrets_cli as bw_cli
