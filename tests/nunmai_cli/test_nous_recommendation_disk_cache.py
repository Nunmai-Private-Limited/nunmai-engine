...
def fetch_in_new_process(home, base, *, force=False):
    result = subprocess.run(
        [sys.executable, "-c", "from nunmai_cli.models import fetch_nous_recommended_models; "
...
def test_disk_cache_is_scoped_to_home_and_portal(tmp_path, portal):
    ...
    from nunmai_cli.models import fetch_nous_recommended_models, _nous_recommended_cache
