...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr(
        "nunmai_cli.models.fetch_ollama_local_models", lambda *_a, **_kw: None
    )


def test_picker_native_probe_failure_falls_back_to_openai_catalog(monkeypatch):
    monkeypatch.setattr(
        "nunmai_cli.models.should_use_ollama_native_catalog", lambda *a, **k: True
    )
    monkeypatch.setattr(
        "nunmai_cli.models._get_ollama_native_headers", lambda *a, **k: {}
    )
    monkeypatch.setattr(
        "nunmai_cli.models.fetch_ollama_local_models", lambda *a, **k: None
    )
    monkeypatch.setattr(
...
def test_picker_generic_discovery_preserves_api_mode(monkeypatch):
    ...
    monkeypatch.setattr(
        "nunmai_cli.models.should_use_ollama_native_catalog", lambda *a, **k: False
    )
...
def test_switch_model_accepts_explicit_bare_custom_current_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
...
def test_switch_model_does_not_send_ollama_headers_to_unrelated_custom_endpoint(monkeypatch):
    ...
    monkeypatch.setattr(
        "nunmai_cli.models._get_ollama_request_headers",
    ...
    monkeypatch.setattr("nunmai_cli.models.validate_requested_model", fake_validation)
    monkeypatch.setattr("nunmai_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("nunmai_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_picker_endpoint_authorization_overrides_inferred_bearer(monkeypatch):
    from nunmai_cli.model_switch import _fetch_picker_live_models
    ...
    monkeypatch.setattr("nunmai_cli.models.should_use_ollama_native_catalog", lambda *a, **k: True)
    monkeypatch.setattr("nunmai_cli.models.fetch_ollama_local_models", fake_native)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.models.fetch_lmstudio_models", _fake_fetch)
...
def test_discovered_models_auto_saved_to_cache(monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.models.fetch_api_models", fake_fetch_api_models)
    monkeypatch.setattr(
        "nunmai_cli.model_switch._save_discovered_models_to_config",
...
def test_save_discovered_models_preserves_dict_form(monkeypatch):
    ...
    from nunmai_cli.model_switch import _save_discovered_models_to_config
...
def test_model_flow_named_custom_persists_discovered_models(monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.main._save_custom_provider", lambda *a, **k: None)
