...
import nunmai_cli.model_switch_providers as nunmai_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(nunmai_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("nunmai_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import nunmai_cli.models as hm
    import nunmai_cli.models_catalog_static as nunmai_cli_models_catalog_static
    from nunmai_cli import models_catalog_static
    ...
    monkeypatch.setattr(nunmai_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
