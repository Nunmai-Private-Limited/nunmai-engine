...
import nunmai_cli.web_server_profiles as _web_server_profiles
...
class TestProfileScopedModel:
    ...
    def test_model_options_uses_config_only_scope_for_selected_profile(
        ...
        monkeypatch.setattr(
            "nunmai_cli.inventory.load_picker_context", lambda: object()
        )
        monkeypatch.setattr(
            "nunmai_cli.inventory.build_model_options_payload",
