...
def _patch_named_profile(monkeypatch, profiles_root, profile_dir):
    monkeypatch.setattr("nunmai_cli.profiles._get_profiles_root", lambda: profiles_root)
    monkeypatch.setattr("nunmai_cli.profiles.get_profile_dir", lambda n: profile_dir)
    monkeypatch.setattr("nunmai_cli.profiles.validate_profile_name", lambda n: None)
...
def test_default_profile_export_survives_unix_socket(tmp_path, monkeypatch):
    ...
    profile_dir = tmp_path / "nunmai_home"
