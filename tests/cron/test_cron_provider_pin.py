...
resolve_runtime_provider against a temp NUNMAI_HOME) and the create_job snapshot capture.
"""
...
def _run(job, tmp_path, *, current_provider="openrouter", current_model=None, cron_model=None,
    ...
    with patch("cron.scheduler._nunmai_home", tmp_path), \
         ...
         patch("nunmai_cli.runtime_provider.resolve_runtime_provider", side_effect=_resolve), \
