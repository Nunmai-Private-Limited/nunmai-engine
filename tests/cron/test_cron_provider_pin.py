...
resolve_runtime_provider against a temp NUNMAI_HOME) and the job-store pin helpers.
"""
...
class TestPinnedLocksTheMainModel:
    ...
    def _store(monkeypatch, tmp_path, main_model="main-model", main_provider="openrouter"):
        ...
        monkeypatch.setattr(jobs, "get_nunmai_home", lambda: tmp_path, raising=True)
        state = {"jobs": []}
        ...
        monkeypatch.setattr("nunmai_cli.runtime_provider.resolve_runtime_provider", resolver)
