...
These drive the real store (``jobs.json`` under a temp NUNMAI_HOME) so the assertion is the
...
def temp_home(tmp_path, monkeypatch):
    """Isolated NUNMAI_HOME so jobs.json/executions don't touch the real store."""
