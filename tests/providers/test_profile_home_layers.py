"""``$NUNMAI_HOME`` model-provider plugins resolve for the profile home bound at lookup time (#88143).
...
profile was ``Unknown provider`` from Desktop while ``nunmai -p <profile>`` in a terminal worked.
"""
