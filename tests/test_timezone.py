...
def _reset_nunmai_time_cache():
    """Reset the nunmai_time module cache (replacement for removed reset_cache)."""
    nunmai_time._cached_tz = None
    nunmai_time._cached_tz_name = None
    nunmai_time._cache_resolved = False
