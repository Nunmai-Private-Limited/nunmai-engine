...
through the real Nunmai MCP client (discovery, transport, liveness checks, result
...
shutdown tests can prove Nunmai reaps the whole process tree, not just its direct
