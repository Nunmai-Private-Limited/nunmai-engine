...
def write_home(nunmai_home: Path, base_url: str, extra_config: str) -> None:
    ...
    (nunmai_home / ".env").write_text("OPENAI_API_KEY=sk-fake-e2e\n", encoding="utf-8")
...
@dataclass
class Scenario:
    """One session: its own NUNMAI_HOME, state.db and agent against the shared provider."""
