...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and nunmai-engine
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # nunmai-engine (tests/skills/)
]
