"""The `nunmai-engine` skill is what a running Nunmai knows about itself.

`website/` is never packaged, so an installed Nunmai has no local copy of the
user guide; skills ARE synced into `$NUNMAI_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Nunmai can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "nunmai-engine"
