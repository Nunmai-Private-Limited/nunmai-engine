...
def test_model_flow_nous_does_not_restore_stale_custom_api_key(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.models.get_pricing_for_provider", lambda provider: {})
...
def test_model_flow_custom_saves_verified_v1_base_url(monkeypatch, capsys):
    ...
    monkeypatch.setattr("nunmai_cli.main._save_custom_provider", lambda *args, **kwargs: None)
    monkeypatch.setattr(
...
def test_model_flow_custom_persists_selected_api_mode(monkeypatch):
    ...
    monkeypatch.setattr(
        "nunmai_cli.main._save_custom_provider",
...
def test_auto_provider_name_localhost():
    from nunmai_cli.main import _auto_provider_name
...
def test_save_custom_provider_uses_provided_name(monkeypatch, tmp_path):
    ...
    import yaml
    from nunmai_cli.main import _save_custom_provider
