...
from nunmai_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/nunmai_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("nunmai_cli.lifecycle.invoke_hook")
@patch("nunmai_cli.lifecycle.finalize_session")
