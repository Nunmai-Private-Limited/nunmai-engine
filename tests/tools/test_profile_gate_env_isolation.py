...
``nunmai -p B`` child built from profile A's process enforced A's channel list as its own.
"""
...
def homes(tmp_path, monkeypatch):
    """Launch home A (the process's NUNMAI_HOME) and routed home B; gates in the process env only."""
    a = tmp_path / ".nunmai"
    b = a / "profiles" / "b"
