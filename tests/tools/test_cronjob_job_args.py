...
hardcoded "~/.nunmai/scripts/" in its messages even though resolution goes
through get_nunmai_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_nunmai_home() is not the global ~/.nunmai.
        scripts_dir = get_nunmai_home() / "scripts"
