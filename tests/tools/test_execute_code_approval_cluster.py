...
Covers the canonical fix for issues #4146, #27303, #30882, #33057:
  ...
  4. tools.code_execution_env._scrub_child_env — broad NUNMAI_ prefix dropped,
...
def test_env_scrub_nunmai_allowlist_and_secret_blocks():
    ...
    for dropped in (
        "NUNMAI_BASE_URL", "NUNMAI_INTERACTIVE", "NUNMAI_KANBAN_TASK",
