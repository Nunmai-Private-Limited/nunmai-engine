...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/nunmai config files without modify intent.
        ...
        assert _scan_memory_content("Read .nunmai/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .nunmai/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .nunmai/config.yaml to change settings", "nunmai_config_mod")
        _blocked("update .nunmai/SOUL.md with new personality", "nunmai_config_mod")
