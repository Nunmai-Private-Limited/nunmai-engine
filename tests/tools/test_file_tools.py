...
class TestSensitivePathCheck:
    ...
    def test_nunmai_config_blocked_for_write_file(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("tools.file_tools._nunmai_config_resolved", str(fake_config))
        monkeypatch.setattr("tools.file_tools._nunmai_config_resolved_loaded", True)
    ...
    def test_system_path_still_blocked(self, monkeypatch):
        monkeypatch.setattr("tools.file_tools._nunmai_config_resolved", "/some/other/path")
        monkeypatch.setattr("tools.file_tools._nunmai_config_resolved_loaded", True)
    ...
    def test_normal_file_not_blocked(self, mock_get, monkeypatch):
        monkeypatch.setattr("tools.file_tools._nunmai_config_resolved", "/home/user/.nunmai/config.yaml")
        monkeypatch.setattr("tools.file_tools._nunmai_config_resolved_loaded", True)
        mock_ops = MagicMock()
        result_obj = MagicMock()
