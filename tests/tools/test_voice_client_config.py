...
Real config files in a temp NUNMAI_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated NUNMAI_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "NUNMAI_LOCAL_STT_LANGUAGE",
    ):
