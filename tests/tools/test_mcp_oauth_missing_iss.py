...
from tools.mcp_oauth_provider import NunmaiProviderMixin  # noqa: E402


class _Provider(NunmaiProviderMixin, OAuthClientProvider):
    pass
...
def _provider_for(issuer: str, *, iss_in_redirect: str | None) -> _Provider:
    ...
    provider._nunmai_oauth_flow = "browser"
    return provider
