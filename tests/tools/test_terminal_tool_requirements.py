...
class TestCheckFnTransientFailureSuppression:
    ...
    def test_core_tool_drop_after_success_warns_once_never_configured_stays_info(self, monkeypatch, caplog):
        """A check_fn that drops a ``_NUNMAI_CORE_TOOLS`` member it had previously admitted logs at
        ...
        monkeypatch.setattr(toolsets, "_NUNMAI_CORE_TOOLS",
                            [*toolsets._NUNMAI_CORE_TOOLS, "core_probe_tool", "never_probe_tool"])
    ...
    def test_profile_scoped_availability_does_not_cross_multiplex_profiles(
        ...
        try:
            home_a = set_nunmai_home_override(str(profile_a))
            ...
            try:
                ...
                reset_nunmai_home_override(home_a)

            home_b = set_nunmai_home_override(str(profile_b))
            ...
            try:
                ...
                reset_nunmai_home_override(home_b)
