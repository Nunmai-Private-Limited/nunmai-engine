...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host NUNMAI_REDACT_SECRETS."""
...
class TestBrowserSecretExfil:
    ...
    def test_cloud_browser_allows_credential_named_query_param(self):
        ...
        session's cookies and typed passwords. Only Nunmai-secret-shaped values stay blocked."""
        from tools.browser_tool import browser_navigate
...
class TestWebExtractSecretExfil:
    ...
    async def test_allows_credential_named_query_param(self):
        ...
        Only Nunmai-secret-shaped VALUES are blocked (see test_blocks_api_key_in_url)."""
        from tools.web_tools import web_extract_tool
