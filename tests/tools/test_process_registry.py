...
class TestSpawnEnvSanitization:
    ...
    def test_env_poller_quotes_temp_paths_with_spaces(self, registry):
        ...
        assert env.commands[1][0] == "kill -0 \"$(cat '/path with spaces/nunmai_bg.pid' 2>/dev/null)\" 2>/dev/null; echo $?"
        assert env.commands[2][0] == "cat '/path with spaces/nunmai_bg.exit' 2>/dev/null"
