...
* ``nunmai_constants.get_nunmai_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_nunmai_dir so cache writes land under tmp_path."""
    ...
    with patch("nunmai_constants.get_nunmai_dir", _fake_get):
        yield cache_dir
