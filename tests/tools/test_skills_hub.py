...
def _make_index_source(skills):
    ...
    from tools.skills_hub import NunmaiIndexSource
...
class TestLoadNunmaiIndex:
    ...
    def _isolate_cache(monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(hub, "_nunmai_index_cache_file", lambda: cache_file)
        return cache_file
    ...
    def test_persistent_decoding_error_falls_back_to_stale_cache(
        ...
        old = time.time() - (hub.NUNMAI_INDEX_TTL + 100)
        import os
