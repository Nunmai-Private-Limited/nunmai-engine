...
A gateway sets NUNMAI_EXEC_ASK=1 at startup and hands its environ to every external cron
worker; interactive launches export NUNMAI_INTERACTIVE=1. Inside cron nobody can answer the
