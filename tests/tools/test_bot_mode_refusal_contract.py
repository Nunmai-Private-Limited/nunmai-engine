...
def test_one_shot_cli_preserves_refusal_reason(monkeypatch, capsys):
    ...
    assert not NunmaiCLI._claim_active_session(cli, stderr=True)
    assert "nunmai-refusal-reason: SESSION_NOT_OWNED\n" in capsys.readouterr().err
