...
class TestWriteDenyExactPaths:
    ...
    def test_nunmai_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.nunmai/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: NUNMAI_HOME does point to the profile dir, not the root.
...
class TestWriteAllowed:
    ...
    def test_nunmai_control_files_requested_writable(self):
