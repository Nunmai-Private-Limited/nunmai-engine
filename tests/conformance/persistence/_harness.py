...
def make_nunmai_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated NUNMAI_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"nunmai-home-{journal_mode}"
