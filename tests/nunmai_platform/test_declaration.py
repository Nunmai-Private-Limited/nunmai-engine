...
from nunmai_platform.declaration import DeclarationError, parse_declaration
from nunmai_platform.resolver.app import AppDef, AppResolver
from nunmai_platform.resolver.availability import Availability, availability, version_at_least
...
def test_unexpanded_locations_are_missing_even_when_cwd_contains_them(tmp_path, monkeypatch):
    ...
    for location in ("%NUNMAI_TEST_UNSET_VAR%/x.exe", "$NUNMAI_TEST_UNSET_VAR/x"):
