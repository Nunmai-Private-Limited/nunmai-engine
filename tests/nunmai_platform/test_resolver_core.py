...
from nunmai_platform.resolver import ABSENT, LookupContext, locate_command
...
def test_known_dir_tables_match_the_host_os():
    from nunmai_platform.resolver import known_dirs as kd

    every = (*kd.homebrew_dirs(), *kd.user_local_bin(), *kd.rust_tool_dirs(),
             *kd.node_tool_dirs(), *kd.nunmai_vendored_dirs(), *kd.windows_user_program_dirs())
