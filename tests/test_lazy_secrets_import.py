"""Regression test: nunmai update must not load cryptography eagerly."""
...
assert 'nunmai_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running nunmai update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so nunmai_cli is importable,
