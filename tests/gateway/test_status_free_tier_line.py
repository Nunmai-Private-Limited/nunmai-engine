"""The in-chat /status line identifies an active Nunmai free-tier route."""
...
def _account_state() -> dict:
    return {
        ...
        "access_token": _jwt(client_id="nunmai-cli", account_tier="standard"),
...
def test_the_line_comes_from_the_catalog_in_every_language():
    ...
    for lang in ("ja", "de"):
        ...
        assert line.startswith("Nunmai · ") and " · nous/welcome · " in line and "/login" in line
