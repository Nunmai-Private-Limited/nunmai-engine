...
async def test_recursive_three_turn_chain_then_human(profiles, monkeypatch, diagnostic_first, setting):
    ...
    root, _ = profiles
    monkeypatch.setattr(gateway_run, "_nunmai_home", root)
