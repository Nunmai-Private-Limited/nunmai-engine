...
def test_unserved_profile_is_not_claimed_by_the_host_gateway(host_gateway, monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.gateway.named_profile_served_by_running_multiplexer", lambda *a: False)
...
def test_unprovable_record_is_a_candidate_not_the_host_gateway(host_gateway, monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.gateway_multiplex_served.live_default_gateway_pid", lambda: None)
