...
class TestHandleUpdateCommand:
    ...
    @pytest.mark.asyncio
    async def test_resolve_nunmai_bin_fallback(self):
        """_resolve_nunmai_bin falls back to sys.executable argv when which fails."""
        import sys
    ...
    async def test_fallback_when_no_setsid(self, tmp_path):
        ...
        assert "Starting Nunmai update" in result
