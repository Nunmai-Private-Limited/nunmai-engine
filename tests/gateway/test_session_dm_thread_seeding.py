...
def store(tmp_path, monkeypatch):
    ...
    ~/.nunmai/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at nunmai_state import time, before pytest's NUNMAI_HOME monkeypatch
    fires — the autouse fixture's NUNMAI_HOME override doesn't help here.)
    """
    import nunmai_state
