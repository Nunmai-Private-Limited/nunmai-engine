"""Tests for _setup_feishu() in nunmai_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("nunmai_cli.config.save_env_value", side_effect=mock_save), \
         patch("nunmai_cli.config.get_env_value", side_effect=mock_get), \
         patch("nunmai_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("nunmai_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("nunmai_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("nunmai_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("nunmai_cli.cli_output.print_header"), \
         patch("nunmai_cli.cli_output.print_info"), \
         patch("nunmai_cli.cli_output.print_success"), \
         patch("nunmai_cli.cli_output.print_warning"), \
         patch("nunmai_cli.cli_output.print_error"), \
