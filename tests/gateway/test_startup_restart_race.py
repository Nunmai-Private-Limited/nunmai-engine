...
def _patch_aborted_startup(monkeypatch, runner_cls):
    ...
    monkeypatch.setattr("nunmai_logging.setup_logging", lambda nunmai_home, mode: None)
...
async def test_failure_exit_still_stops_cron_housekeeping_and_mcp(monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.nous_auth_keepalive.stop_nous_auth_keepalive", lambda: None)
