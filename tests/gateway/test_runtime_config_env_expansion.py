...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("NUNMAI_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("NUNMAI_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("NUNMAI_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
