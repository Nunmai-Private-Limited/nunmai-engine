...
class TestTeamsInteractiveSetup:
    def test_interactive_setup_persists_credentials(self, tmp_path, monkeypatch):
        ...
        from nunmai_cli.cli_output (not nunmai_cli.config) and persist
        ...
        env_text = (nunmai_home / ".env").read_text(encoding="utf-8")
...
class TestTeamsRequireMention:
    ...
    @pytest.mark.parametrize("conversation_type, kwargs, dispatched", [
        ...
        ("channel", {"text": "<at>Nunmai</at> hi", "mentioned_id": "28:bot-id"}, True),  # wire form of the bot id
        ("groupChat", {"text": "<at>Nunmai</at> hi", "mentioned_id": "bot-id"}, True),
