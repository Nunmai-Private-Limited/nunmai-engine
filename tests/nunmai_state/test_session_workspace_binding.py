"""Session <-> workspace grouping key (nunmai_state_sessions.workspace_key).

The key is what `nunmai sessions list --workspace` groups/filters on. It is a
...
import nunmai_state_sessions
from nunmai_state_sessions import workspace_key
