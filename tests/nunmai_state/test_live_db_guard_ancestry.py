...
class TestPytestProcessRecognition:
    ...
    def test_recognises_pytest_invocations(self, cmdline):
        assert nunmai_state._process_looks_like_pytest(self._FakeProc(cmdline))
    ...
    def test_ignores_non_pytest_invocations(self, cmdline):
        assert not nunmai_state._process_looks_like_pytest(self._FakeProc(cmdline))
    ...
    def test_unreadable_process_is_not_pytest(self):
        ...
        assert not nunmai_state._process_looks_like_pytest(_Denied())
