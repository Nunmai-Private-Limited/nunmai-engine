...
sibling Nunmai processes (VACUUM after auto-prune, TRUNCATE checkpoint at
...
class TestTranscriptWritePatience:
    ...
    def test_exhausted_patience_names_the_real_cause(self, db, monkeypatch):
        ...
        assert "another Nunmai process" in text
...
def test_lock_lost_inside_fts_constructor_classifies_as_busy(tmp_path):
    ...
    from nunmai_state_errors import classify_persistence_error, is_transient_sqlite_error
