...
def test_disable_flush_env_var_actually_wires_to_module_constant(monkeypatch):
    """End-to-end: setting `NUNMAI_TUI_GATEWAY_NO_FLUSH=1` and importing
    ...
    monkeypatch.setenv("NUNMAI_TUI_GATEWAY_NO_FLUSH", "1")
    ...
    try:
        ...
        monkeypatch.delenv("NUNMAI_TUI_GATEWAY_NO_FLUSH", raising=False)
