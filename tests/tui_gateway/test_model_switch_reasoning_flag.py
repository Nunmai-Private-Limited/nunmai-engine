...
def _quiet_switch(monkeypatch):
    ...
    monkeypatch.setattr("nunmai_cli.model_switch.switch_model", lambda **_kw: result)
    monkeypatch.setattr("nunmai_cli.model_switch.persist_model_selection", lambda _r: None)
    monkeypatch.setattr("nunmai_cli.model_cost_guard.expensive_model_warning", lambda *a, **k: None)
