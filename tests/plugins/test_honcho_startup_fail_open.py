...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "nunmai honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "nunmai honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "nunmai honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "nunmai honcho peer --user"),
])
