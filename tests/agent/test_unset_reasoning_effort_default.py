...
The Nunmai, OpenRouter and AI Gateway profiles already fill medium when no effort is configured; the
...
def test_unset_effort_default_keeps_the_field_off_where_it_would_be_wrong():
    ...
    with patch("agent.models_dev.get_model_capabilities", return_value=None):
        ...
        # Profiles that decide inside build_api_kwargs_extras (Nunmai fills medium itself) get None as before.
