...
def test_deepseek_v4_pro_pricing_entry_exists():
    ...
    in nunmai insights because the _OFFICIAL_DOCS_PRICING table had no
...
def test_curated_google_flash_models_resolve_official_snapshot_pricing(monkeypatch):
    """Every ``google/gemini-*-flash`` model curated for the OpenRouter and Nunmai
    ...
    """
    from nunmai_cli.models_catalog_static import OPENROUTER_MODELS, _PROVIDER_MODELS
