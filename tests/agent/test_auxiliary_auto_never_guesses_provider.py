...
Regression for the Grok/Nunmai incident: main provider ``xai-oauth`` with an expired token, Nunmai
...
def nous_is_the_only_working_provider():
    """Main provider unusable; Nunmai would win the discovery chain; no configured fallback policy."""
