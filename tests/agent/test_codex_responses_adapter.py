...
# MCP-routed tools, e.g. codex_mcp__nunmai-tools__web_search_exec-<uuid> (#73492).
_OVERSIZED_CALL_ID = "codex_mcp__nunmai-tools__web_search_exec-" + "0" * 43
...
def test_codex_preflight_passes_text_verbosity_through():
    ...
    Before it was allowed, ``text.verbosity`` died inside Nunmai with
