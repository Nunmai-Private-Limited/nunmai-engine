...
def clear_kanban_env(monkeypatch):
    for var in ("NUNMAI_KANBAN_TASK", "NUNMAI_KANBAN_STOP_NUDGE"):
        monkeypatch.delenv(var, raising=False)
    return monkeypatch


def test_env_can_disable(clear_kanban_env):
    clear_kanban_env.setenv("NUNMAI_KANBAN_TASK", "t_abc")
    clear_kanban_env.setenv("NUNMAI_KANBAN_STOP_NUDGE", "0")
...
def test_nudge_disabled_inside_delegated_child(clear_kanban_env):
    ...
    clear_kanban_env.setenv("NUNMAI_KANBAN_TASK", "t_parent")
...
def test_nudge_when_no_terminal_tool(clear_kanban_env):
    clear_kanban_env.setenv("NUNMAI_KANBAN_TASK", "t_46be8aa5")
    messages = [
...
# handles it.  See also tests/nunmai_cli/test_kanban_core_functionality.py
...
def test_no_nudge_after_handoff_tool(clear_kanban_env, tool_name, who):
    ...
    """
    clear_kanban_env.setenv("NUNMAI_KANBAN_TASK", "t_handoff")
    messages = [
        {
            "role": "assistant",
            "content": "",
