"""Concurrent Nunmai 401 recovery must not stampede the shared OAuth grant.

Sep 2 2026 incident: ~120 subagent processes shared one Nunmai OAuth pool entry
...
2. A lock-timeout during a pool-level Nunmai refresh leaves the entry
...
from tests.nunmai_cli.test_auth_nous_provider import _invoke_jwt, _setup_nous_auth
