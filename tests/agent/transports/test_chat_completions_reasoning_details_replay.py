"""``reasoning_details`` replay is route-scoped: OpenRouter/Nunmai read it, every other
chat-completions route gets a wire copy without it (strict schemas 400/422 on the field,
wedging the session after an in-session model switch — nunmai-engine#70233)."""
