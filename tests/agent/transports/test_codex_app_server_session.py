...
class TestLifecycle:
    ...
    def test_thread_start_carries_nunmai_prompt_and_disables_codex_personality(self):
        """thread/start carries cwd, Nunmai' composed prompt as developerInstructions and
