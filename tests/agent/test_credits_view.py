...
from nunmai_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def _logged_in_account(monkeypatch):
    ...
    def _install(account):
        monkeypatch.setattr(
            "nunmai_cli.nous_account.get_nous_portal_account_info",
            lambda *a, **kw: account,
        )
...
def test_credits_command_fully_removed():
    ...
    from nunmai_cli.commands import resolve_command, COMMAND_REGISTRY
