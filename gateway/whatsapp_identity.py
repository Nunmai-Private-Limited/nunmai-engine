...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$NUNMAI_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_nunmai_dir("platforms/whatsapp/session", "whatsapp/session")
