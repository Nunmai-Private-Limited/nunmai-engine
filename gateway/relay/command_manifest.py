...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Nunmai session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Nunmai session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Nunmai agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Nunmai Engine to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Nunmai gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Nunmai session in it",
