...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Nunmai session"),
        ...
        _cmd("status", "Show Nunmai session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Nunmai agent"),
        ...
        _cmd("update", "Update Nunmai Engine to the latest version"),
        _cmd("restart", "Gracefully restart the Nunmai gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Nunmai session in it",
