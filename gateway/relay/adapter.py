...
class RelayAdapter(BasePlatformAdapter):
    ...
    def __init__(
        ...
        # chat_id -> Nunmai profile the connector routed the inbound to (multiplex mode). Echoed
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        source = SessionSource(
            ...
            # The NUNMAI profile this interaction is routed to (multiplex mode) — mirrors _event_from_wire's
        ...
        if itype == 3:
            # A component press whose custom_id is a Nunmai prompt token
