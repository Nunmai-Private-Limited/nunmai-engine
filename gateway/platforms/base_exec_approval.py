...
the same three things: what Nunmai wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "Nunmai wants to run a command that needs your OK"
