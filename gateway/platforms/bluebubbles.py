...
# `require_mention: true` without custom aliases uses Nunmai wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?nunmai\s+agent\b[,:\-]?", r"(?<![\w@])@?nunmai\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Nunmai defaults)."""
