...
class OpenAICompatRoutesMixin:
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        outcome, err = await self._run_idempotent(
            ...
            fingerprint_keys=["model", "provider", "model_options", "require_model_lock",
    ...
    async def _handle_responses(self, request: "web.Request") -> "web.Response":
        ...
        outcome, err = await self._run_idempotent(
            ...
            fingerprint_keys=["input", "instructions", "previous_response_id", "conversation",
                              "model", "provider", "model_options", "require_model_lock", "tools"],
        )
        if err is not None:
            return err
        result, usage = outcome
