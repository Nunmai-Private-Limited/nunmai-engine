...
def _served_profile_scope(target_profile: str):
    ...
    from nunmai_cli.profiles import get_profile_dir, normalize_profile_name, profile_exists, profile_matches_home
    # "default" is the launch home (a `-p x` multiplexer hosts it too), never a switch to ~/.nunmai.
...
def execution_policy_mapping(*, target_profile: str, config: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    from nunmai_cli.config import resolve_turn_limit
