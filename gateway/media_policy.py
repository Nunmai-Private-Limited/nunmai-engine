...
from environment variables:
  ...
  - ``NUNMAI_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``NUNMAI_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``NUNMAI_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``nunmai cron run`` in the CLI, ``nunmai send``, a
...
_STRICT_ENV = "NUNMAI_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "NUNMAI_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "NUNMAI_MEDIA_TRUST_RECENT_FILES"
