...
~/.nunmai/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_nunmai_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_nunmai_home() / "channel_aliases.json"
...
def format_directory_for_display(platforms: Optional[Dict[str, Any]] = None) -> str:
    ...
    ``nunmai send --list`` to merge in configured-but-undiscovered
